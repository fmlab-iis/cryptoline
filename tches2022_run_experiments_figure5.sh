...
BENCHMARKS=(
  "kyber768-avx2-cuts/PQCLEAN_KYBER768_AVX2_polyvec_ntt_00_cuts.cl|-v -isafety -jobs 24 -slicing -no_carry_constraint"
  "kyber768-avx2-cuts/PQCLEAN_KYBER768_AVX2_polyvec_ntt_01_cuts.cl|-v -isafety -jobs 24 -slicing -no_carry_constraint"
  "kyber768-avx2-cuts/PQCLEAN_KYBER768_AVX2_polyvec_ntt_03_cuts.cl|-v -isafety -jobs 24 -slicing -no_carry_constraint"
  "kyber768-avx2-cuts/PQCLEAN_KYBER768_AVX2_polyvec_ntt_04_cuts.cl|-v -isafety -jobs 24 -slicing -no_carry_constraint"
  "kyber768-avx2-cuts/PQCLEAN_KYBER768_AVX2_polyvec_ntt_06_cuts.cl|-v -isafety -jobs 24 -slicing -no_carry_constraint"
  "kyber768-avx2-cuts/PQCLEAN_KYBER768_AVX2_polyvec_ntt_08_cuts.cl|-v -isafety -jobs 24 -slicing -no_carry_constraint"
  "kyber768-avx2-cuts/PQCLEAN_KYBER768_AVX2_polyvec_ntt_10_cuts.cl|-v -isafety -jobs 24 -slicing -no_carry_constraint"
  "kyber768-avx2-cuts/PQCLEAN_KYBER768_AVX2_polyvec_ntt_14_cuts.cl|-v -isafety -jobs 24 -slicing -no_carry_constraint"
)
OUT=results
