...
val specs_from_file : string -> ((var list * var list) * Typecheck.Std.tagged_spec) SM.t
...
val spec_from_file : string -> var list * Typecheck.Std.tagged_spec
...
val spec_from_string : string -> var list * Typecheck.Std.tagged_spec
(** Parse the specification of the main procedure in a string and return
    [(ivs, s)] where [ivs] is the list of input variables and [s] is the
    specification of the main procedure. *)

val program_from_file : string -> Ast.MultiTrack.lined_tagged_program
(** Parse the instructions of the main procedure in a file *)

val program_from_string : string -> Ast.MultiTrack.lined_tagged_program
