 ...
 *)
  ...
  type kind = Scalar | Vector of int
  ...
  let add_atomic_index lno suffix_len a i elt_size cm vm ym gm =
    if atomic_is_var a then
      ...
      if atomic_is_signed a then
        mkatomic_const (int_t elt_size)
                       (Z.signed_extract n (i * elt_size) elt_size)
      else
...
(*   type atomic_token_t = Z.t SM.t -> var SM.t -> var SM.t -> var SM.t -> atomic *)
  ...
  let parse_imov_at lno kind (lv_token : lv_token_t) a_token =
    fun _fm cm vm ym gm ->
  ...
  let parse_imovs_at lno kind (lv_token : lv_token_t) a_tokens =
    fun _fm cm vm ym gm ->
      let atoms = a_tokens cm vm ym gm in
      let len = List.length atoms in
      let _ = check_at lno [check_same_typ atoms] in
      let elt_size =
        match kind with Vector wi -> wi | _ -> assert false in
      let ty =
        let a_typ = typ_of_atomic (List.hd atoms) in
        let a_typ_size = size_of_typ a_typ in
        let _ =
          check_at lno [if elt_size = a_typ_size then None else Some ("The size (" ^ string_of_int a_typ_size ^ ") of each element must be equal to " ^ string_of_int elt_size)] in
  ...
  let parse_sub_at lno kind (lv_token : lv_token_t) a1_token a2_token =
    fun _fm cm vm ym gm ->
      let a1 = a1_token cm vm ym gm in
      let a2 = a2_token cm vm ym gm in
      let ty = typ_of_atomic a1 in
  ...
  let parse_mul_at lno kind (lv_token : lv_token_t) a1_token a2_token =
    fun _fm cm vm ym gm ->
      let a1 = a1_token cm vm ym gm in
      let a2 = a2_token cm vm ym gm in
      let ty = typ_of_atomic a1 in
  ...
  let parse_mull_at lno kind (vh_token : lv_token_t) (vl_token : lv_token_t) a1_token a2_token =
    fun _fm cm vm ym gm ->
      let a1 = a1_token cm vm ym gm in
      let a2 = a2_token cm vm ym gm in
      let ty = typ_of_atomic a1 in
  ...
  let parse_split_at lno kind (vh_token : lv_token_t) (vl_token : lv_token_t) a_token n_token =
    fun _fm cm vm ym gm ->
      let a = a_token cm vm ym gm in
      let n = n_token cm in
      let ty = typ_of_atomic a in
  ...
  let parse_usub_at lno kind (lv_token : lv_token_t) a1_token a2_token =
    fun _fm cm vm ym gm ->
      let a1 = a1_token cm vm ym gm in
      let a2 = a2_token cm vm ym gm in
      let ty = typ_of_atomic a1 in
  ...
  let parse_umul_at lno kind (lv_token : lv_token_t) a1_token a2_token =
    fun _fm cm vm ym gm ->
      let a1 = a1_token cm vm ym gm in
      let a2 = a2_token cm vm ym gm in
      let ty = typ_of_atomic a1 in
  ...
  let parse_umull_at lno kind (vh_token : lv_token_t) (vl_token : lv_token_t) a1_token a2_token =
    fun _fm cm vm ym gm ->
      let a1 = a1_token cm vm ym gm in
      let a2 = a2_token cm vm ym gm in
      let ty = typ_of_atomic a1 in
  ...
  let parse_usplit_at lno kind (vh_token : lv_token_t) (vl_token : lv_token_t) a_token n_token =
    fun _fm cm vm ym gm ->
      let a = a_token cm vm ym gm in
      let n = n_token cm in
      let ty = typ_of_atomic a in
  ...
  let parse_ssub_at lno kind (lv_token : lv_token_t) a1_token a2_token =
    fun _fm cm vm ym gm ->
      let a1 = a1_token cm vm ym gm in
      let a2 = a2_token cm vm ym gm in
      let ty = typ_of_atomic a1 in
  ...
  let parse_smul_at lno kind (lv_token : lv_token_t) a1_token a2_token =
    fun _fm cm vm ym gm ->
      let a1 = a1_token cm vm ym gm in
      let a2 = a2_token cm vm ym gm in
      let ty = typ_of_atomic a1 in
  ...
  let parse_smull_at lno kind (vh_token : lv_token_t) (vl_token : lv_token_t) a1_token a2_token =
    fun _fm cm vm ym gm ->
      let a1 = a1_token cm vm ym gm in
      let a2 = a2_token cm vm ym gm in
      let ty = typ_of_atomic a1 in
  ...
  let parse_ssplit_at lno kind (vh_token : lv_token_t) (vl_token : lv_token_t) a_token n_token =
    fun _fm cm vm ym gm ->
      let a = a_token cm vm ym gm in
      let n = n_token cm in
      let ty = typ_of_atomic a in
...
instr:
    MOV lval atomic                               { let lno = !lnum in
                                                    parse_imov_at lno Scalar $2 $3 }
  | MOV BYTE lval atomic                          { let lno = !lnum in
                                                    parse_imov_at lno (Vector byte_size) $3 $4 }
  | MOV WORD lval atomic                          { let lno = !lnum in
                                                    parse_imov_at lno (Vector word_size) $3 $4 }
  | MOV DWORD lval atomic                         { let lno = !lnum in
                                                    parse_imov_at lno (Vector dword_size) $3 $4 }
  | MOV QWORD lval atomic                         { let lno = !lnum in
                                                    parse_imov_at lno (Vector qword_size) $3 $4 }
  | lhs EQOP atomic                               { let lno = !lnum in
                                                    parse_imov_at lno Scalar $1 $3 }
  | lhs EQOP BYTE atomic                          { let lno = !lnum in
                                                    parse_imov_at lno (Vector byte_size) $1 $4 }
  | lhs EQOP WORD atomic                          { let lno = !lnum in
                                                    parse_imov_at lno (Vector word_size) $1 $4 }
  | lhs EQOP DWORD atomic                         { let lno = !lnum in
                                                    parse_imov_at lno (Vector dword_size) $1 $4 }
  | lhs EQOP QWORD atomic                         { let lno = !lnum in
                                                    parse_imov_at lno (Vector qword_size) $1 $4 }
  | MOV BYTE lval LSQUARE atomics RSQUARE         { let lno = !lnum in
                                                    parse_imovs_at lno (Vector byte_size) $3 $5 }
  | MOV WORD lval LSQUARE atomics RSQUARE         { let lno = !lnum in
                                                    parse_imovs_at lno (Vector word_size) $3 $5 }
  | MOV DWORD lval LSQUARE atomics RSQUARE        { let lno = !lnum in
                                                    parse_imovs_at lno (Vector dword_size) $3 $5 }
  | MOV QWORD lval LSQUARE atomics RSQUARE        { let lno = !lnum in
                                                    parse_imovs_at lno (Vector qword_size) $3 $5 }
  | lhs EQOP BYTE LSQUARE atomics RSQUARE         { let lno = !lnum in
                                                    parse_imovs_at lno (Vector byte_size) $1 $5 }
  | lhs EQOP WORD LSQUARE atomics RSQUARE         { let lno = !lnum in
                                                    parse_imovs_at lno (Vector word_size) $1 $5 }
  | lhs EQOP DWORD LSQUARE atomics RSQUARE        { let lno = !lnum in
                                                    parse_imovs_at lno (Vector dword_size) $1 $5 }
  | lhs EQOP QWORD LSQUARE atomics RSQUARE        { let lno = !lnum in
                                                    parse_imovs_at lno (Vector qword_size) $1 $5 }
  | SHL lval atomic const                         { let lno = !lnum in
                                                    parse_ishl_at lno Scalar $2 $3 $4 }
  | SHL BYTE lval atomic const                    { let lno = !lnum in
                                                    parse_ishl_at lno (Vector byte_size) $3 $4 $5 }
  | SHL WORD lval atomic const                    { let lno = !lnum in
                                                    parse_ishl_at lno (Vector word_size) $3 $4 $5 }
  | SHL DWORD lval atomic const                   { let lno = !lnum in
                                                    parse_ishl_at lno (Vector dword_size) $3 $4 $5 }
  | SHL QWORD lval atomic const                   { let lno = !lnum in
                                                    parse_ishl_at lno (Vector qword_size) $3 $4 $5 }
  | lhs EQOP SHL atomic const                     { let lno = !lnum in
                                                    parse_ishl_at lno Scalar $1 $4 $5 }
  | lhs EQOP BYTE SHL atomic const                { let lno = !lnum in
                                                    parse_ishl_at lno (Vector byte_size) $1 $5 $6 }
  | lhs EQOP WORD SHL atomic const                { let lno = !lnum in
                                                    parse_ishl_at lno (Vector word_size) $1 $5 $6 }
  | lhs EQOP DWORD SHL atomic const               { let lno = !lnum in
                                                    parse_ishl_at lno (Vector dword_size) $1 $5 $6 }
  | lhs EQOP QWORD SHL atomic const               { let lno = !lnum in
                                                    parse_ishl_at lno (Vector qword_size) $1 $5 $6 }
  | CSHL lval lval atomic atomic const            { let lno = !lnum in
                                                    parse_cshl_at lno Scalar $2 $3 $4 $5 $6 }
  | CSHL BYTE lval lval atomic atomic const       { let lno = !lnum in
                                                    parse_cshl_at lno (Vector byte_size) $3 $4 $5 $6 $7 }
  | CSHL WORD lval lval atomic atomic const       { let lno = !lnum in
                                                    parse_cshl_at lno (Vector word_size) $3 $4 $5 $6 $7 }
  | CSHL DWORD lval lval atomic atomic const      { let lno = !lnum in
                                                    parse_cshl_at lno (Vector dword_size) $3 $4 $5 $6 $7 }
  | CSHL QWORD lval lval atomic atomic const      { let lno = !lnum in
                                                    parse_cshl_at lno (Vector qword_size) $3 $4 $5 $6 $7 }
  | lhs DOT lhs EQOP CSHL atomic atomic const     { let lno = !lnum in
                                                    parse_cshl_at lno Scalar $1 $3 $6 $7 $8 }
  | lhs DOT lhs EQOP BYTE CSHL atomic atomic const
                                                  { let lno = !lnum in
                                                    parse_cshl_at lno (Vector byte_size) $1 $3 $7 $8 $9 }
  | lhs DOT lhs EQOP WORD CSHL atomic atomic const
                                                  { let lno = !lnum in
                                                    parse_cshl_at lno (Vector word_size) $1 $3 $7 $8 $9 }
  | lhs DOT lhs EQOP DWORD CSHL atomic atomic const
                                                  { let lno = !lnum in
                                                    parse_cshl_at lno (Vector dword_size) $1 $3 $7 $8 $9 }
  | lhs DOT lhs EQOP QWORD CSHL atomic atomic const
                                                  { let lno = !lnum in
                                                    parse_cshl_at lno (Vector qword_size) $1 $3 $7 $8 $9 }
  | SET lcarry                                    { let lno = !lnum in
                                                    parse_set_at lno $2 }
  | CLEAR lcarry                                  { let lno = !lnum in
                                                    parse_clear_at lno $2 }
  | NONDET lval                                   { let lno = !lnum in
                                                    parse_nondet_at lno Scalar $2 }
  | NONDET BYTE lval                              { let lno = !lnum in
                                                    parse_nondet_at lno (Vector byte_size) $3 }
  | NONDET WORD lval                              { let lno = !lnum in
                                                    parse_nondet_at lno (Vector word_size) $3 }
  | NONDET DWORD lval                             { let lno = !lnum in
                                                    parse_nondet_at lno (Vector dword_size) $3 }
  | NONDET QWORD lval                             { let lno = !lnum in
                                                    parse_nondet_at lno (Vector qword_size) $3 }
  | CMOV lval carry atomic atomic                 { let lno = !lnum in
                                                    parse_cmov_at lno Scalar $2 $3 $4 $5 }
  | CMOV BYTE lval carry atomic atomic            { let lno = !lnum in
                                                    parse_cmov_at lno (Vector byte_size) $3 $4 $5 $6 }
  | CMOV WORD lval carry atomic atomic           { let lno = !lnum in
                                                    parse_cmov_at lno (Vector word_size) $3 $4 $5 $6 }
  | CMOV DWORD lval carry atomic atomic           { let lno = !lnum in
                                                    parse_cmov_at lno (Vector dword_size) $3 $4 $5 $6 }
  | CMOV QWORD lval carry atomic atomic           { let lno = !lnum in
                                                    parse_cmov_at lno (Vector qword_size) $3 $4 $5 $6 }
  | lhs EQOP CMOV carry atomic atomic             { let lno = !lnum in
                                                    parse_cmov_at lno Scalar $1 $4 $5 $6 }
  | lhs EQOP BYTE CMOV carry atomic atomic        { let lno = !lnum in
                                                    parse_cmov_at lno (Vector byte_size) $1 $5 $6 $7 }
  | lhs EQOP WORD CMOV carry atomic atomic        { let lno = !lnum in
                                                    parse_cmov_at lno (Vector word_size) $1 $5 $6 $7 }
  | lhs EQOP DWORD CMOV carry atomic atomic       { let lno = !lnum in
                                                    parse_cmov_at lno (Vector dword_size) $1 $5 $6 $7 }
  | lhs EQOP QWORD CMOV carry atomic atomic       { let lno = !lnum in
                                                    parse_cmov_at lno (Vector qword_size) $1 $5 $6 $7 }
  | ADD lval atomic atomic                        { let lno = !lnum in
                                                    parse_add_at lno Scalar $2 $3 $4 }
  | ADD BYTE lval atomic atomic                   { let lno = !lnum in
                                                    parse_add_at lno (Vector byte_size) $3 $4 $5 }
  | ADD WORD lval atomic atomic                   { let lno = !lnum in
                                                    parse_add_at lno (Vector word_size) $3 $4 $5 }
  | ADD DWORD lval atomic atomic                  { let lno = !lnum in
                                                    parse_add_at lno (Vector dword_size) $3 $4 $5 }
  | ADD QWORD lval atomic atomic                  { let lno = !lnum in
                                                    parse_add_at lno (Vector qword_size) $3 $4 $5 }
  | lhs EQOP ADD atomic atomic                    { let lno = !lnum in
                                                    parse_add_at lno Scalar $1 $4 $5 }
  | lhs EQOP BYTE ADD atomic atomic               { let lno = !lnum in
                                                    parse_add_at lno (Vector byte_size) $1 $5 $6 }
  | lhs EQOP WORD ADD atomic atomic               { let lno = !lnum in
                                                    parse_add_at lno (Vector word_size) $1 $5 $6 }
  | lhs EQOP DWORD ADD atomic atomic              { let lno = !lnum in
                                                    parse_add_at lno (Vector dword_size) $1 $5 $6 }
  | lhs EQOP QWORD ADD atomic atomic              { let lno = !lnum in
                                                    parse_add_at lno (Vector qword_size) $1 $5 $6 }
  ...
  | SUB lval atomic atomic                        { let lno = !lnum in
                                                    parse_sub_at lno Scalar $2 $3 $4 }
  | SUB BYTE lval atomic atomic                   { let lno = !lnum in
                                                    parse_sub_at lno (Vector byte_size) $3 $4 $5 }
  | SUB WORD lval atomic atomic                   { let lno = !lnum in
                                                    parse_sub_at lno (Vector word_size) $3 $4 $5 }
  | SUB DWORD lval atomic atomic                  { let lno = !lnum in
                                                    parse_sub_at lno (Vector dword_size) $3 $4 $5 }
  | SUB QWORD lval atomic atomic                  { let lno = !lnum in
                                                    parse_sub_at lno (Vector qword_size) $3 $4 $5 }
  | lhs EQOP SUB atomic atomic                    { let lno = !lnum in
                                                    parse_sub_at lno Scalar $1 $4 $5 }
  | lhs EQOP BYTE SUB atomic atomic               { let lno = !lnum in
                                                    parse_sub_at lno (Vector byte_size) $1 $5 $6 }
  | lhs EQOP WORD SUB atomic atomic               { let lno = !lnum in
                                                    parse_sub_at lno (Vector word_size) $1 $5 $6 }
  | lhs EQOP DWORD SUB atomic atomic              { let lno = !lnum in
                                                    parse_sub_at lno (Vector dword_size) $1 $5 $6 }
  | lhs EQOP QWORD SUB atomic atomic              { let lno = !lnum in
                                                    parse_sub_at lno (Vector qword_size) $1 $5 $6 }
  ...
  | MUL lval atomic atomic                        { let lno = !lnum in
                                                    parse_mul_at lno Scalar $2 $3 $4 }
  | MUL BYTE lval atomic atomic                   { let lno = !lnum in
                                                    parse_mul_at lno (Vector byte_size) $3 $4 $5 }
  | MUL WORD lval atomic atomic                   { let lno = !lnum in
                                                    parse_mul_at lno (Vector word_size) $3 $4 $5 }
  | MUL DWORD lval atomic atomic                  { let lno = !lnum in
                                                    parse_mul_at lno (Vector dword_size) $3 $4 $5 }
  | MUL QWORD lval atomic atomic                  { let lno = !lnum in
                                                    parse_mul_at lno (Vector qword_size) $3 $4 $5 }
  | lhs EQOP MUL atomic atomic                    { let lno = !lnum in
                                                    parse_mul_at lno Scalar $1 $4 $5 }
  | lhs EQOP BYTE MUL atomic atomic               { let lno = !lnum in
                                                    parse_mul_at lno (Vector byte_size) $1 $5 $6 }
  | lhs EQOP WORD MUL atomic atomic               { let lno = !lnum in
                                                    parse_mul_at lno (Vector word_size) $1 $5 $6 }
  | lhs EQOP DWORD MUL atomic atomic              { let lno = !lnum in
                                                    parse_mul_at lno (Vector dword_size) $1 $5 $6 }
  | lhs EQOP QWORD MUL atomic atomic              { let lno = !lnum in
                                                    parse_mul_at lno (Vector qword_size) $1 $5 $6 }
  ...
  | MULL lval lval atomic atomic                  { let lno = !lnum in
                                                    parse_mull_at lno Scalar $2 $3 $4 $5 }
  | MULL BYTE lval lval atomic atomic             { let lno = !lnum in
                                                    parse_mull_at lno (Vector byte_size) $3 $4 $5 $6 }
  | MULL WORD lval lval atomic atomic             { let lno = !lnum in
                                                    parse_mull_at lno (Vector word_size) $3 $4 $5 $6 }
  | MULL DWORD lval lval atomic atomic            { let lno = !lnum in
                                                    parse_mull_at lno (Vector dword_size) $3 $4 $5 $6 }
  | MULL QWORD lval lval atomic atomic            { let lno = !lnum in
                                                    parse_mull_at lno (Vector qword_size) $3 $4 $5 $6 }
  | lhs DOT lhs EQOP MULL atomic atomic           { let lno = !lnum in
                                                    parse_mull_at lno Scalar $1 $3 $6 $7 }
  | lhs DOT lhs EQOP BYTE MULL atomic atomic      { let lno = !lnum in
                                                    parse_mull_at lno (Vector byte_size) $1 $3 $7 $8 }
  | lhs DOT lhs EQOP WORD MULL atomic atomic      { let lno = !lnum in
                                                    parse_mull_at lno (Vector word_size) $1 $3 $7 $8 }
  | lhs DOT lhs EQOP DWORD MULL atomic atomic      { let lno = !lnum in
                                                    parse_mull_at lno (Vector dword_size) $1 $3 $7 $8 }
  | lhs DOT lhs EQOP QWORD MULL atomic atomic      { let lno = !lnum in
                                                    parse_mull_at lno (Vector qword_size) $1 $3 $7 $8 }
  ...
  | SPLIT lval lval atomic const                  { let lno = !lnum in
                                                    parse_split_at lno Scalar $2 $3 $4 $5 }
  | SPLIT BYTE lval lval atomic const             { let lno = !lnum in
                                                    parse_split_at lno (Vector byte_size) $3 $4 $5 $6 }
  | SPLIT WORD lval lval atomic const             { let lno = !lnum in
                                                    parse_split_at lno (Vector word_size) $3 $4 $5 $6 }
  | SPLIT DWORD lval lval atomic const            { let lno = !lnum in
                                                    parse_split_at lno (Vector dword_size) $3 $4 $5 $6 }
  | SPLIT QWORD lval lval atomic const            { let lno = !lnum in
                                                    parse_split_at lno (Vector qword_size) $3 $4 $5 $6 }
  | lhs DOT lhs EQOP SPLIT atomic const           { let lno = !lnum in
                                                    parse_split_at lno Scalar $1 $3 $6 $7 }
  | lhs DOT lhs EQOP BYTE SPLIT atomic const      { let lno = !lnum in
                                                    parse_split_at lno (Vector byte_size) $1 $3 $7 $8 }
  | lhs DOT lhs EQOP WORD SPLIT atomic const      { let lno = !lnum in
                                                    parse_split_at lno (Vector word_size) $1 $3 $7 $8 }
  | lhs DOT lhs EQOP DWORD SPLIT atomic const     { let lno = !lnum in
                                                    parse_split_at lno (Vector dword_size) $1 $3 $7 $8 }
  | lhs DOT lhs EQOP QWORD SPLIT atomic const     { let lno = !lnum in
                                                    parse_split_at lno (Vector qword_size) $1 $3 $7 $8 }
  | UADD lval atomic atomic                       { let lno = !lnum in
                                                    parse_uadd_at lno Scalar $2 $3 $4 }
  | UADD BYTE lval atomic atomic                  { let lno = !lnum in
                                                    parse_uadd_at lno (Vector byte_size) $3 $4 $5 }
  | UADD WORD lval atomic atomic                  { let lno = !lnum in
                                                    parse_uadd_at lno (Vector word_size) $3 $4 $5 }
  | UADD DWORD lval atomic atomic                 { let lno = !lnum in
                                                    parse_uadd_at lno (Vector dword_size) $3 $4 $5 }
  | UADD QWORD lval atomic atomic                 { let lno = !lnum in
                                                    parse_uadd_at lno (Vector qword_size) $3 $4 $5 }
  | lhs EQOP UADD atomic atomic                   { let lno = !lnum in
                                                    parse_uadd_at lno Scalar $1 $4 $5 }
  | lhs EQOP BYTE UADD atomic atomic              { let lno = !lnum in
                                                    parse_uadd_at lno (Vector byte_size) $1 $5 $6 }
  | lhs EQOP WORD UADD atomic atomic              { let lno = !lnum in
                                                    parse_uadd_at lno (Vector word_size) $1 $5 $6 }
  | lhs EQOP DWORD UADD atomic atomic              { let lno = !lnum in
                                                    parse_uadd_at lno (Vector dword_size) $1 $5 $6 }
  | lhs EQOP QWORD UADD atomic atomic              { let lno = !lnum in
                                                    parse_uadd_at lno (Vector qword_size) $1 $5 $6 }
  ...
  | USUB lval atomic atomic                       { let lno = !lnum in
                                                    parse_usub_at lno Scalar $2 $3 $4 }
  | USUB BYTE lval atomic atomic                  { let lno = !lnum in
                                                    parse_usub_at lno (Vector byte_size) $3 $4 $5 }
  | USUB WORD lval atomic atomic                  { let lno = !lnum in
                                                    parse_usub_at lno (Vector word_size) $3 $4 $5 }
  | USUB DWORD lval atomic atomic                 { let lno = !lnum in
                                                    parse_usub_at lno (Vector dword_size) $3 $4 $5 }
  | USUB QWORD lval atomic atomic                 { let lno = !lnum in
                                                    parse_usub_at lno (Vector qword_size) $3 $4 $5 }
  | lhs EQOP USUB atomic atomic                   { let lno = !lnum in
                                                    parse_usub_at lno Scalar $1 $4 $5 }
  | lhs EQOP BYTE USUB atomic atomic              { let lno = !lnum in
                                                    parse_usub_at lno (Vector byte_size) $1 $5 $6 }
  | lhs EQOP WORD USUB atomic atomic              { let lno = !lnum in
                                                    parse_usub_at lno (Vector word_size) $1 $5 $6 }
  | lhs EQOP DWORD USUB atomic atomic             { let lno = !lnum in
                                                    parse_usub_at lno (Vector dword_size) $1 $5 $6 }
  | lhs EQOP QWORD USUB atomic atomic             { let lno = !lnum in
                                                    parse_usub_at lno (Vector qword_size) $1 $5 $6 }
  ...
  | UMUL lval atomic atomic                       { let lno = !lnum in
                                                    parse_umul_at lno Scalar $2 $3 $4 }
  | UMUL BYTE lval atomic atomic                  { let lno = !lnum in
                                                    parse_umul_at lno (Vector byte_size) $3 $4 $5 }
  | UMUL WORD lval atomic atomic                  { let lno = !lnum in
                                                    parse_umul_at lno (Vector word_size) $3 $4 $5 }
  | UMUL DWORD lval atomic atomic                 { let lno = !lnum in
                                                    parse_umul_at lno (Vector dword_size) $3 $4 $5 }
  | UMUL QWORD lval atomic atomic                 { let lno = !lnum in
                                                    parse_umul_at lno (Vector qword_size) $3 $4 $5 }
  | lhs EQOP UMUL atomic atomic                   { let lno = !lnum in
                                                    parse_umul_at lno Scalar $1 $4 $5 }
  | lhs EQOP BYTE UMUL atomic atomic              { let lno = !lnum in
                                                    parse_umul_at lno (Vector byte_size) $1 $5 $6 }
  | lhs EQOP WORD UMUL atomic atomic              { let lno = !lnum in
                                                    parse_umul_at lno (Vector word_size) $1 $5 $6 }
  | lhs EQOP DWORD UMUL atomic atomic             { let lno = !lnum in
                                                    parse_umul_at lno (Vector dword_size) $1 $5 $6 }
  | lhs EQOP QWORD UMUL atomic atomic             { let lno = !lnum in
                                                    parse_umul_at lno (Vector qword_size) $1 $5 $6 }
  ...
  | UMULL lval lval atomic atomic                 { let lno = !lnum in
                                                    parse_umull_at lno Scalar $2 $3 $4 $5 }
  | UMULL BYTE lval lval atomic atomic            { let lno = !lnum in
                                                    parse_umull_at lno (Vector byte_size) $3 $4 $5 $6 }
  | UMULL WORD lval lval atomic atomic            { let lno = !lnum in
                                                    parse_umull_at lno (Vector word_size) $3 $4 $5 $6 }
  | UMULL DWORD lval lval atomic atomic           { let lno = !lnum in
                                                    parse_umull_at lno (Vector dword_size) $3 $4 $5 $6 }
  | UMULL QWORD lval lval atomic atomic           { let lno = !lnum in
                                                    parse_umull_at lno (Vector qword_size) $3 $4 $5 $6 }
  | lhs DOT lhs EQOP UMULL atomic atomic          { let lno = !lnum in
                                                    parse_umull_at lno Scalar $1 $3 $6 $7 }
  | lhs DOT lhs EQOP BYTE UMULL atomic atomic     { let lno = !lnum in
                                                    parse_umull_at lno (Vector byte_size) $1 $3 $7 $8 }
  | lhs DOT lhs EQOP WORD UMULL atomic atomic     { let lno = !lnum in
                                                    parse_umull_at lno (Vector word_size) $1 $3 $7 $8 }
  | lhs DOT lhs EQOP DWORD UMULL atomic atomic    { let lno = !lnum in
                                                    parse_umull_at lno (Vector dword_size) $1 $3 $7 $8 }
  | lhs DOT lhs EQOP QWORD UMULL atomic atomic    { let lno = !lnum in
                                                    parse_umull_at lno (Vector qword_size) $1 $3 $7 $8 }
  ...
  | USPLIT lval lval atomic const                 { let lno = !lnum in
                                                    parse_usplit_at lno Scalar $2 $3 $4 $5 }
  | USPLIT BYTE lval lval atomic const            { let lno = !lnum in
                                                    parse_usplit_at lno (Vector byte_size) $3 $4 $5 $6 }
  | USPLIT WORD lval lval atomic const            { let lno = !lnum in
                                                    parse_usplit_at lno (Vector word_size) $3 $4 $5 $6 }
  | USPLIT DWORD lval lval atomic const           { let lno = !lnum in
                                                    parse_usplit_at lno (Vector dword_size) $3 $4 $5 $6 }
  | USPLIT QWORD lval lval atomic const           { let lno = !lnum in
                                                    parse_usplit_at lno (Vector qword_size) $3 $4 $5 $6 }
  | lhs DOT lhs EQOP USPLIT atomic const          { let lno = !lnum in
                                                    parse_usplit_at lno Scalar $1 $3 $6 $7 }
  | lhs DOT lhs EQOP BYTE USPLIT atomic const     { let lno = !lnum in
                                                    parse_usplit_at lno (Vector byte_size) $1 $3 $7 $8 }
  | lhs DOT lhs EQOP WORD USPLIT atomic const     { let lno = !lnum in
                                                    parse_usplit_at lno (Vector word_size) $1 $3 $7 $8 }
  | lhs DOT lhs EQOP DWORD USPLIT atomic const    { let lno = !lnum in
                                                    parse_usplit_at lno (Vector dword_size) $1 $3 $7 $8 }
  | lhs DOT lhs EQOP QWORD USPLIT atomic const    { let lno = !lnum in
                                                    parse_usplit_at lno (Vector qword_size) $1 $3 $7 $8 }
  | SADD lval atomic atomic                       { let lno = !lnum in
                                                    parse_sadd_at lno Scalar $2 $3 $4 }
  | SADD BYTE lval atomic atomic                  { let lno = !lnum in
                                                    parse_sadd_at lno (Vector byte_size) $3 $4 $5 }
  | SADD WORD lval atomic atomic                  { let lno = !lnum in
                                                    parse_sadd_at lno (Vector word_size) $3 $4 $5 }
  | SADD DWORD lval atomic atomic                  { let lno = !lnum in
                                                    parse_sadd_at lno (Vector dword_size) $3 $4 $5 }
  | SADD QWORD lval atomic atomic                  { let lno = !lnum in
                                                    parse_sadd_at lno (Vector qword_size) $3 $4 $5 }
  | lhs EQOP SADD atomic atomic                   { let lno = !lnum in
                                                    parse_sadd_at lno Scalar $1 $4 $5 }
  | lhs EQOP BYTE SADD atomic atomic              { let lno = !lnum in
                                                    parse_sadd_at lno (Vector byte_size) $1 $5 $6 }
  | lhs EQOP WORD SADD atomic atomic              { let lno = !lnum in
                                                    parse_sadd_at lno (Vector word_size) $1 $5 $6 }
  | lhs EQOP DWORD SADD atomic atomic              { let lno = !lnum in
                                                    parse_sadd_at lno (Vector dword_size) $1 $5 $6 }
  | lhs EQOP QWORD SADD atomic atomic              { let lno = !lnum in
                                                    parse_sadd_at lno (Vector qword_size) $1 $5 $6 }
  ...
  | SSUB lval atomic atomic                       { let lno = !lnum in
                                                    parse_ssub_at lno Scalar $2 $3 $4 }
  | SSUB BYTE lval atomic atomic                  { let lno = !lnum in
                                                    parse_ssub_at lno (Vector byte_size) $3 $4 $5 }
  | SSUB WORD lval atomic atomic                  { let lno = !lnum in
                                                    parse_ssub_at lno (Vector word_size) $3 $4 $5 }
  | SSUB DWORD lval atomic atomic                 { let lno = !lnum in
                                                    parse_ssub_at lno (Vector dword_size) $3 $4 $5 }
  | SSUB QWORD lval atomic atomic                 { let lno = !lnum in
                                                    parse_ssub_at lno (Vector qword_size) $3 $4 $5 }
  | lhs EQOP SSUB atomic atomic                   { let lno = !lnum in
                                                    parse_ssub_at lno Scalar $1 $4 $5 }
  | lhs EQOP BYTE SSUB atomic atomic              { let lno = !lnum in
                                                    parse_ssub_at lno (Vector byte_size) $1 $5 $6 }
  | lhs EQOP WORD SSUB atomic atomic              { let lno = !lnum in
                                                    parse_ssub_at lno (Vector word_size) $1 $5 $6 }
  | lhs EQOP DWORD SSUB atomic atomic              { let lno = !lnum in
                                                    parse_ssub_at lno (Vector dword_size) $1 $5 $6 }
  | lhs EQOP QWORD SSUB atomic atomic              { let lno = !lnum in
                                                    parse_ssub_at lno (Vector qword_size) $1 $5 $6 }
  ...
  | SMUL lval atomic atomic                       { let lno = !lnum in
                                                    parse_smul_at lno Scalar $2 $3 $4 }
  | SMUL BYTE lval atomic atomic                  { let lno = !lnum in
                                                    parse_smul_at lno (Vector byte_size) $3 $4 $5 }
  | SMUL WORD lval atomic atomic                  { let lno = !lnum in
                                                    parse_smul_at lno (Vector word_size) $3 $4 $5 }
  | SMUL DWORD lval atomic atomic                 { let lno = !lnum in
                                                    parse_smul_at lno (Vector dword_size) $3 $4 $5 }
  | SMUL QWORD lval atomic atomic                 { let lno = !lnum in
                                                    parse_smul_at lno (Vector qword_size) $3 $4 $5 }
  | lhs EQOP SMUL atomic atomic                   { let lno = !lnum in
                                                    parse_smul_at lno Scalar $1 $4 $5 }
  | lhs EQOP BYTE SMUL atomic atomic              { let lno = !lnum in
                                                    parse_smul_at lno (Vector byte_size) $1 $5 $6 }
  | lhs EQOP WORD SMUL atomic atomic              { let lno = !lnum in
                                                    parse_smul_at lno (Vector word_size) $1 $5 $6 }
  | lhs EQOP DWORD SMUL atomic atomic             { let lno = !lnum in
                                                    parse_smul_at lno (Vector dword_size) $1 $5 $6 }
  | lhs EQOP QWORD SMUL atomic atomic             { let lno = !lnum in
                                                    parse_smul_at lno (Vector qword_size) $1 $5 $6 }
  ...
  | SMULL lval lval atomic atomic                 { let lno = !lnum in
                                                    parse_smull_at lno Scalar $2 $3 $4 $5 }
  | SMULL BYTE lval lval atomic atomic            { let lno = !lnum in
                                                    parse_smull_at lno (Vector byte_size) $3 $4 $5 $6 }
  | SMULL WORD lval lval atomic atomic            { let lno = !lnum in
                                                    parse_smull_at lno (Vector word_size) $3 $4 $5 $6 }
  | SMULL DWORD lval lval atomic atomic           { let lno = !lnum in
                                                    parse_smull_at lno (Vector dword_size) $3 $4 $5 $6 }
  | SMULL QWORD lval lval atomic atomic           { let lno = !lnum in
                                                    parse_smull_at lno (Vector qword_size) $3 $4 $5 $6 }
  | lhs DOT lhs EQOP SMULL atomic atomic          { let lno = !lnum in
                                                    parse_smull_at lno Scalar $1 $3 $6 $7 }
  | lhs DOT lhs EQOP BYTE SMULL atomic atomic     { let lno = !lnum in
                                                    parse_smull_at lno (Vector byte_size) $1 $3 $7 $8 }
  | lhs DOT lhs EQOP WORD SMULL atomic atomic     { let lno = !lnum in
                                                    parse_smull_at lno (Vector word_size) $1 $3 $7 $8 }
  | lhs DOT lhs EQOP DWORD SMULL atomic atomic     { let lno = !lnum in
                                                    parse_smull_at lno (Vector dword_size) $1 $3 $7 $8 }
  | lhs DOT lhs EQOP QWORD SMULL atomic atomic     { let lno = !lnum in
                                                    parse_smull_at lno (Vector qword_size) $1 $3 $7 $8 }
  ...
  | SSPLIT lval lval atomic const                 { let lno = !lnum in
                                                    parse_ssplit_at lno Scalar $2 $3 $4 $5 }
  | SSPLIT BYTE lval lval atomic const            { let lno = !lnum in
                                                    parse_ssplit_at lno (Vector byte_size) $3 $4 $5 $6 }
  | SSPLIT WORD lval lval atomic const            { let lno = !lnum in
                                                    parse_ssplit_at lno (Vector word_size) $3 $4 $5 $6 }
  | SSPLIT DWORD lval lval atomic const           { let lno = !lnum in
                                                    parse_ssplit_at lno (Vector dword_size) $3 $4 $5 $6 }
  | SSPLIT QWORD lval lval atomic const           { let lno = !lnum in
                                                    parse_ssplit_at lno (Vector qword_size) $3 $4 $5 $6 }
  | lhs DOT lhs EQOP SSPLIT atomic const          { let lno = !lnum in
                                                    parse_ssplit_at lno Scalar $1 $3 $6 $7 }
  | lhs DOT lhs EQOP BYTE SSPLIT atomic const     { let lno = !lnum in
                                                    parse_ssplit_at lno (Vector byte_size) $1 $3 $7 $8 }
  | lhs DOT lhs EQOP WORD SSPLIT atomic const     { let lno = !lnum in
                                                    parse_ssplit_at lno (Vector word_size) $1 $3 $7 $8 }
  | lhs DOT lhs EQOP DWORD SSPLIT atomic const     { let lno = !lnum in
                                                    parse_ssplit_at lno (Vector dword_size) $1 $3 $7 $8 }
  | lhs DOT lhs EQOP QWORD SSPLIT atomic const     { let lno = !lnum in
                                                    parse_ssplit_at lno (Vector qword_size) $1 $3 $7 $8 }
  | AND lval atomic atomic                        { let lno = !lnum in
                                                    parse_and_at lno Scalar $2 $3 $4 }
  | AND BYTE lval atomic atomic                   { let lno = !lnum in
                                                    parse_and_at lno (Vector byte_size) $3 $4 $5 }
  | AND WORD lval atomic atomic                   { let lno = !lnum in
                                                    parse_and_at lno (Vector word_size) $3 $4 $5 }
  | AND DWORD lval atomic atomic                  { let lno = !lnum in
                                                    parse_and_at lno (Vector dword_size) $3 $4 $5 }
  | AND QWORD lval atomic atomic                  { let lno = !lnum in
                                                    parse_and_at lno (Vector qword_size) $3 $4 $5 }
  | lhs EQOP AND atomic atomic                    { let lno = !lnum in
                                                    parse_and_at lno Scalar $1 $4 $5 }
  | lhs EQOP BYTE AND atomic atomic               { let lno = !lnum in
                                                    parse_and_at lno (Vector byte_size) $1 $5 $6 }
  | lhs EQOP WORD AND atomic atomic               { let lno = !lnum in
                                                    parse_and_at lno (Vector word_size) $1 $5 $6 }
  | lhs EQOP DWORD AND atomic atomic              { let lno = !lnum in
                                                    parse_and_at lno (Vector dword_size) $1 $5 $6 }
  | lhs EQOP QWORD AND atomic atomic              { let lno = !lnum in
                                                    parse_and_at lno (Vector qword_size) $1 $5 $6 }
  | OR lval atomic atomic                         { let lno = !lnum in
                                                    parse_or_at lno Scalar $2 $3 $4 }
  | OR BYTE lval atomic atomic                    { let lno = !lnum in
                                                    parse_or_at lno (Vector byte_size) $3 $4 $5 }
  | OR WORD lval atomic atomic                    { let lno = !lnum in
                                                    parse_or_at lno (Vector word_size) $3 $4 $5 }
  | OR DWORD lval atomic atomic                   { let lno = !lnum in
                                                    parse_or_at lno (Vector dword_size) $3 $4 $5 }
  | OR QWORD lval atomic atomic                   { let lno = !lnum in
                                                    parse_or_at lno (Vector qword_size) $3 $4 $5 }
  | lhs EQOP OR atomic atomic                     { let lno = !lnum in
                                                    parse_or_at lno Scalar $1 $4 $5 }
  | lhs EQOP BYTE OR atomic atomic                { let lno = !lnum in
                                                    parse_or_at lno (Vector byte_size) $1 $5 $6 }
  | lhs EQOP WORD OR atomic atomic                { let lno = !lnum in
                                                    parse_or_at lno (Vector word_size) $1 $5 $6 }
  | lhs EQOP DWORD OR atomic atomic                { let lno = !lnum in
                                                    parse_or_at lno (Vector dword_size) $1 $5 $6 }
  | lhs EQOP QWORD OR atomic atomic                { let lno = !lnum in
                                                    parse_or_at lno (Vector qword_size) $1 $5 $6 }
  | XOR lval atomic atomic                        { let lno = !lnum in
                                                    parse_xor_at lno Scalar $2 $3 $4 }
  | XOR BYTE lval atomic atomic                   { let lno = !lnum in
                                                    parse_xor_at lno (Vector byte_size) $3 $4 $5 }
  | XOR WORD lval atomic atomic                   { let lno = !lnum in
                                                    parse_xor_at lno (Vector word_size) $3 $4 $5 }
  | XOR DWORD lval atomic atomic                  { let lno = !lnum in
                                                    parse_xor_at lno (Vector dword_size) $3 $4 $5 }
  | XOR QWORD lval atomic atomic                  { let lno = !lnum in
                                                    parse_xor_at lno (Vector qword_size) $3 $4 $5 }
  | lhs EQOP XOR atomic atomic                    { let lno = !lnum in
                                                    parse_xor_at lno Scalar $1 $4 $5 }
  | lhs EQOP BYTE XOR atomic atomic               { let lno = !lnum in
                                                    parse_xor_at lno (Vector byte_size) $1 $5 $6 }
  | lhs EQOP WORD XOR atomic atomic               { let lno = !lnum in
                                                    parse_xor_at lno (Vector word_size) $1 $5 $6 }
  | lhs EQOP DWORD XOR atomic atomic               { let lno = !lnum in
                                                    parse_xor_at lno (Vector dword_size) $1 $5 $6 }
  | lhs EQOP QWORD XOR atomic atomic               { let lno = !lnum in
                                                    parse_xor_at lno (Vector qword_size) $1 $5 $6 }
  | NOT lval atomic                               { let lno = !lnum in
                                                    parse_not_at lno Scalar $2 $3 }
  | NOT BYTE lval atomic                          { let lno = !lnum in
                                                    parse_not_at lno (Vector byte_size) $3 $4 }
  | NOT WORD lval atomic                          { let lno = !lnum in
                                                    parse_not_at lno (Vector word_size) $3 $4 }
  | NOT DWORD lval atomic                          { let lno = !lnum in
                                                    parse_not_at lno (Vector dword_size) $3 $4 }
  | NOT QWORD lval atomic                          { let lno = !lnum in
                                                    parse_not_at lno (Vector qword_size) $3 $4 }
  | lhs EQOP NOT atomic                           { let lno = !lnum in
                                                    parse_not_at lno Scalar $1 $4 }
  | lhs EQOP BYTE NOT atomic                      { let lno = !lnum in
                                                    parse_not_at lno (Vector byte_size) $1 $5 }
  | lhs EQOP WORD NOT atomic                      { let lno = !lnum in
                                                    parse_not_at lno (Vector word_size) $1 $5 }
  | lhs EQOP DWORD NOT atomic                     { let lno = !lnum in
                                                    parse_not_at lno (Vector dword_size) $1 $5 }
  ...
  | VPC BYTE lval_or_lcarry atomic                { let lno = !lnum in
                                                    parse_vpc_at lno (Vector byte_size) $3 $4 }
  | VPC WORD lval_or_lcarry atomic                { let lno = !lnum in
                                                    parse_vpc_at lno (Vector word_size) $3 $4 }
  | VPC DWORD lval_or_lcarry atomic               { let lno = !lnum in
                                                    parse_vpc_at lno (Vector dword_size) $3 $4 }
  | VPC QWORD lval_or_lcarry atomic               { let lno = !lnum in
                                                    parse_vpc_at lno (Vector qword_size) $3 $4 }
  | lhs EQOP VPC atomic                           { let lno = !lnum in
                                                    parse_vpc_at lno Scalar $1 $4 }
  | lhs EQOP BYTE VPC atomic                      { let lno = !lnum in
                                                    parse_vpc_at lno (Vector byte_size) $1 $5 }
  | lhs EQOP WORD VPC atomic                      { let lno = !lnum in
                                                    parse_vpc_at lno (Vector word_size) $1 $5 }
  | lhs EQOP DWORD VPC atomic                     { let lno = !lnum in
                                                    parse_vpc_at lno (Vector dword_size) $1 $5 }
  | lhs EQOP QWORD VPC atomic                     { let lno = !lnum in
                                                    parse_vpc_at lno (Vector qword_size) $1 $5 }
  | JOIN lval atomic atomic                       { let lno = !lnum in
                                                    parse_join_at lno Scalar $2 $3 $4 }
  | JOIN BYTE lval atomic atomic                  { let lno = !lnum in
                                                    parse_join_at lno (Vector byte_size) $3 $4 $5 }
  | JOIN WORD lval atomic atomic                  { let lno = !lnum in
                                                    parse_join_at lno (Vector word_size) $3 $4 $5 }
  | JOIN DWORD lval atomic atomic                 { let lno = !lnum in
                                                    parse_join_at lno (Vector dword_size) $3 $4 $5 }
  | JOIN QWORD lval atomic atomic                 { let lno = !lnum in
                                                    parse_join_at lno (Vector qword_size) $3 $4 $5 }
  | lhs EQOP JOIN atomic atomic                   { let lno = !lnum in
                                                    parse_join_at lno Scalar $1 $4 $5 }
  | lhs EQOP BYTE JOIN atomic atomic              { let lno = !lnum in
                                                    parse_join_at lno (Vector byte_size) $1 $5 $6 }
  | lhs EQOP WORD JOIN atomic atomic              { let lno = !lnum in
                                                    parse_join_at lno (Vector word_size) $1 $5 $6 }
  | lhs EQOP DWORD JOIN atomic atomic             { let lno = !lnum in
                                                    parse_join_at lno (Vector dword_size) $1 $5 $6 }
  | lhs EQOP QWORD JOIN atomic atomic             { let lno = !lnum in
                                                    parse_join_at lno (Vector qword_size) $1 $5 $6 }
...
atomics:
    atomic                                        { fun cm vm ym gm -> [$1 cm vm ym gm] }
  | atomic COMMA atomics                          { fun cm vm ym gm -> ($1 cm vm ym gm)::($3 cm vm ym gm) }
;
