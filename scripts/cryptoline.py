...
reserved_instrs_lvs = [
  ...
  ("add", 1), ("adds", 2), ("adc", 1), ("adcs", 2),
  ("sub", 1), ("subs", 2), ("subc", 2), ("subb", 2),
  ("sbc", 1), ("sbcs", 2),
  ("sbb", 1), ("sbbs", 2),
  ("mul", 1), ("muls", 2), ("mull", 2), ("mulj", 1),
  ("spl", 2), ("split", 2),
  ("uadd", 1), ("uadds", 2), ("uadc", 1), ("uadcs", 2),
  ("usub", 1), ("usubs", 2), ("usubc", 2), ("usubb", 2),
  ("usbc", 1), ("usbcs", 2),
  ("usbb", 1), ("usbbs", 2),
  ("umul", 1), ("umuls", 2), ("umull", 2), ("umulj", 1),
  ("uspl", 2), ("usplit", 2),
  ("sadd", 1), ("sadds", 2), ("sadc", 1), ("sadcs", 2),
  ("ssub", 1), ("ssubs", 2), ("ssubc", 2), ("ssubb", 2),
  ("ssbc", 1), ("ssbcs", 2),
  ("ssbb", 1), ("ssbbs", 2),
  ("smul", 1), ("smuls", 2), ("smull", 2), ("smulj", 1),
  ("sspl", 2), ("ssplit", 2),
  ("shl", 1), ("shls", 2), ("lsl", 1), ("cshl", 2), ("clsl", 2),
  ("shr", 1), ("shrs", 2), ("sar", 1), ("sars", 2), ("cshr", 2), ("cshrs", 3),
