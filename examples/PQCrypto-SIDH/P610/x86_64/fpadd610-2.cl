(* on frege: -v -isafety -isafety_timeout 14400 -jobs 24 -slicing -no_carry_constraint fpadd610-2.cl
Parsing Cryptoline file:		[OK]		0.004088 seconds
Checking well-formedness:		[OK]		0.000882 seconds
Transforming to SSA form:		[OK]		0.000182 seconds
Normalizing specification:		[OK]		0.000674 seconds
Rewriting assignments:			[OK]		0.000136 seconds
Verifying program safety:
	 Cut 0
	     Round 1 (2 safety conditions, timeout = 14400 seconds)
		 Safety condition #1	[OK]
		 Safety condition #0	[OK]
	 Overall			[OK]		0.245670 seconds
Verifying range assertions:		[OK]		0.589153 seconds
Verifying range specification:		[OK]		0.435407 seconds
Rewriting value-preserved casting:	[OK]		0.000072 seconds
Verifying algebraic assertions:		[OK]		0.000510 seconds
Verifying algebraic specification:	[OK]		0.080162 seconds
Verification result:			[OK]		1.357547 seconds
*)
...
ghost carry_sub@uint1 : carry_sub = carry && carry_sub = carry;
...
assert true && carry = carry_sub;
assume carry = carry_sub && true;
...
assert true && uext carry_sub 63 * L0x55555556d680 = rsi;
assume carry_sub * L0x55555556d680 = rsi && true;
...
assert true && uext carry_sub 63 * L0x55555556d688 = rdi;
assume carry_sub * L0x55555556d688 = rdi && true;
...
ghost carry_add@uint1 : carry_add = carry && carry_add = carry;
...
and rcx@uint64 rcx 0xFFFFFFFFFFFFFF00@uint64;
...
assert true && and [
  uext carry_sub 63 * L0x55555556d6a0 = rdi,
  uext carry_sub 63 * L0x55555556d6a8 = rsi,
  uext carry_sub 63 * L0x55555556d6b0 = r8,
  uext carry_sub 63 * L0x55555556d6b8 = r9,
  uext carry_sub 63 * L0x55555556d6c0 = r10,
  uext carry_sub 63 * L0x55555556d6c8 = r11
];
assume and [
  carry_sub * L0x55555556d6a0 = rdi,
  carry_sub * L0x55555556d6a8 = rsi,
  carry_sub * L0x55555556d6b0 = r8,
  carry_sub * L0x55555556d6b8 = r9,
  carry_sub * L0x55555556d6c0 = r10,
  carry_sub * L0x55555556d6c8 = r11
] && true;
...
assert true && carry_add = carry;
assume carry_add = carry && true;
