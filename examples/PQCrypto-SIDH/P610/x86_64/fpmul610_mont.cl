(* on frege: -v -isafety -isafety_timeout 14400 -jobs 24 -slicing -no_carry_constraint fpmul610_mont.cl
Parsing Cryptoline file:		[OK]		0.009464 seconds
Checking well-formedness:		[OK]		0.001146 seconds
Transforming to SSA form:		[OK]		0.000527 seconds
Normalizing specification:		[OK]		0.000754 seconds
Rewriting assignments:			[OK]		0.000492 seconds
Verifying program safety:
	 Cut 0
	     Round 1 (0 safety conditions, timeout = 14400 seconds)
	 Overall			[OK]		0.000171 seconds
Verifying range assertions:		[OK]		14.303893 seconds
Verifying range specification:		[OK]		13.160434 seconds
Rewriting value-preserved casting:	[OK]		0.000150 seconds
Verifying algebraic assertions:		[OK]		0.000879 seconds
Verifying algebraic specification:	[OK]		0.224540 seconds
Verification result:			[OK]		27.703046 seconds
*)
...
mov L0x7fffffffd880 b0;
mov L0x7fffffffd888 b1;
mov L0x7fffffffd890 b2;
mov L0x7fffffffd898 b3;
mov L0x7fffffffd8a0 b4;
mov L0x7fffffffd8a8 b5;
mov L0x7fffffffd8b0 b6;
mov L0x7fffffffd8b8 b7;
mov L0x7fffffffd8c0 b8;
mov L0x7fffffffd8c8 b9;
...
(* #jmpq   0x5555555643f0 <fpmul610>               #! PC = 0x5555555584a4 *)
#jmpq   0x5555555643f0 <fpmul610>               #! 0x5555555584a4 = 0x5555555584a4;
...
(* mov    (%rsi),%rdx                              #! EA = L0x7fffffffd880; Value = 0xf94ef7265867cd3a; PC = 0x55555556931b *)
mov rdx L0x7fffffffd880;
(* mulx   (%rdi),%r8,%r9                           #! EA = L0x7fffffffd830; Value = 0xfa5fc2abad4a0047; PC = 0x55555556931e *)
...
(* mulx   0x8(%rdi),%r11,%r10                      #! EA = L0x7fffffffd838; Value = 0x3503ad2ac6aa8eab; PC = 0x55555556932b *)
mull r10 r11 L0x7fffffffd838 rdx;
(* adcx   %r11,%r9                                 #! PC = 0x555555569331 *)
adcs carry r9 r9 r11 carry;
(* mulx   0x10(%rdi),%r12,%r11                     #! EA = L0x7fffffffd840; Value = 0xd0f27e80520c7307; PC = 0x555555569337 *)
mull r11 r12 L0x7fffffffd840 rdx;
(* adcx   %r12,%r10                                #! PC = 0x55555556933d *)
adcs carry r10 r10 r12 carry;
(* mulx   0x18(%rdi),%r13,%r12                     #! EA = L0x7fffffffd848; Value = 0x00f1e7d6f9dcf403; PC = 0x555555569343 *)
mull r12 r13 L0x7fffffffd848 rdx;
(* adcx   %r13,%r11                                #! PC = 0x555555569349 *)
adcs carry r11 r11 r13 carry;
(* mulx   0x20(%rdi),%r8,%r13                      #! EA = L0x7fffffffd850; Value = 0xbb7dc30a0930f7cf; PC = 0x55555556934f *)
mull r13 r8 L0x7fffffffd850 rdx;
(* adcx   %r8,%r12                                 #! PC = 0x555555569355 *)
adcs carry r12 r12 r8 carry;
(* mulx   0x28(%rdi),%rax,%r14                     #! EA = L0x7fffffffd858; Value = 0x3150985797f20003; PC = 0x55555556935b *)
mull r14 rax L0x7fffffffd858 rdx;
(* adcx   %rax,%r13                                #! PC = 0x555555569361 *)
adcs carry r13 r13 rax carry;
(* mulx   0x30(%rdi),%rax,%r15                     #! EA = L0x7fffffffd860; Value = 0xb305b4e8debf2411; PC = 0x555555569367 *)
...
(* mulx   0x38(%rdi),%rbx,%r8                      #! EA = L0x7fffffffd868; Value = 0xd781de5ac3b0b774; PC = 0x555555569377 *)
...
(* mulx   0x40(%rdi),%rax,%r9                      #! EA = L0x7fffffffd870; Value = 0x6f4fbcf0ef470319; PC = 0x555555569388 *)
...
(* mulx   0x48(%rdi),%rbx,%r10                     #! EA = L0x7fffffffd878; Value = 0x000000013f0332e7; PC = 0x555555569399 *)
...
(* mov    0x18(%rsp),%rdx                          #! EA = L0x7fffffffd5c0; Value = 0x031c4912098deb16; PC = 0x5555555693a9 *)
...
assert true && and [ overflow = 0@1, carry = 0@1 ];
assume and [ overflow = 0, carry = 0 ] && true;
(* mov    0x8(%rsi),%rdx                           #! EA = L0x7fffffffd888; Value = 0xffdc8d2d1ce9531f; PC = 0x555555569433 *)
mov rdx L0x7fffffffd888;
(* mulx   (%rdi),%rbp,%rbx                         #! EA = L0x7fffffffd830; Value = 0xfa5fc2abad4a0047; PC = 0x555555569437 *)
mull rbx rbp L0x7fffffffd830 rdx;
(* xor    %r11,%r11                                #! PC = 0x55555556943c *)
mov r11 0@uint64;
clear carry;
clear overflow;
(* adox   (%rsp),%rbp                              #! EA = L0x7fffffffd5a8; Value = 0x20e79611f70d0267; PC = 0x55555556943f *)
adcs overflow rbp rbp L0x7fffffffd5a8 overflow;
(* adox   0x8(%rsp),%rbx                           #! EA = L0x7fffffffd5b0; Value = 0xc7aa771919f2d3dc; PC = 0x555555569446 *)
...
(* mulx   0x8(%rdi),%rax,%rbp                      #! EA = L0x7fffffffd838; Value = 0x3503ad2ac6aa8eab; PC = 0x555555569453 *)
mull rbp rax L0x7fffffffd838 rdx;
(* adcx   %rax,%rbx                                #! PC = 0x555555569459 *)
adcs carry rbx rbx rax carry;
(* adox   0x10(%rsp),%rbp                          #! EA = L0x7fffffffd5b8; Value = 0x707996aa5fc6761f; PC = 0x55555556945f *)
adcs overflow rbp rbp L0x7fffffffd5b8 overflow;
(* mov    %rbx,(%rsp)                              #! EA = L0x7fffffffd5a8; PC = 0x555555569467 *)
mov L0x7fffffffd5a8 rbx;
(* mulx   0x10(%rdi),%rax,%rbx                     #! EA = L0x7fffffffd840; Value = 0xd0f27e80520c7307; PC = 0x55555556946b *)
...
(* mulx   0x18(%rdi),%rbp,%rbx                     #! EA = L0x7fffffffd848; Value = 0x00f1e7d6f9dcf403; PC = 0x555555569482 *)
mull rbx rbp L0x7fffffffd848 rdx;
(* adcx   %rbp,%r12                                #! PC = 0x555555569488 *)
adcs carry r12 r12 rbp carry;
(* adox   %rbx,%r13                                #! PC = 0x55555556948e *)
adcs overflow r13 r13 rbx overflow;
(* mulx   0x20(%rdi),%rbp,%rbx                     #! EA = L0x7fffffffd850; Value = 0xbb7dc30a0930f7cf; PC = 0x555555569494 *)
...
adcs overflow r14 r14 rbx overflow;
(* mulx   0x28(%rdi),%rbp,%rbx                     #! EA = L0x7fffffffd858; Value = 0x3150985797f20003; PC = 0x5555555694ab *)
mull rbx rbp L0x7fffffffd858 rdx;
(* adcx   %rbp,%r14                                #! PC = 0x5555555694b1 *)
adcs carry r14 r14 rbp carry;
(* adox   %rbx,%r15                                #! PC = 0x5555555694b7 *)
adcs overflow r15 r15 rbx overflow;
(* mulx   0x30(%rdi),%rbp,%rbx                     #! EA = L0x7fffffffd860; Value = 0xb305b4e8debf2411; PC = 0x5555555694bd *)
mull rbx rbp L0x7fffffffd860 rdx;
(* adcx   %rbp,%r15                                #! PC = 0x5555555694c3 *)
adcs carry r15 r15 rbp carry;
(* adox   %rbx,%r8                                 #! PC = 0x5555555694c9 *)
adcs overflow r8 r8 rbx overflow;
(* mulx   0x38(%rdi),%rbp,%rbx                     #! EA = L0x7fffffffd868; Value = 0xd781de5ac3b0b774; PC = 0x5555555694cf *)
mull rbx rbp L0x7fffffffd868 rdx;
(* adcx   %rbp,%r8                                 #! PC = 0x5555555694d5 *)
adcs carry r8 r8 rbp carry;
(* adox   %rbx,%r9                                 #! PC = 0x5555555694db *)
adcs overflow r9 r9 rbx overflow;
(* mulx   0x40(%rdi),%rbp,%rbx                     #! EA = L0x7fffffffd870; Value = 0x6f4fbcf0ef470319; PC = 0x5555555694e1 *)
mull rbx rbp L0x7fffffffd870 rdx;
(* adcx   %rbp,%r9                                 #! PC = 0x5555555694e7 *)
adcs carry r9 r9 rbp carry;
(* adox   %rbx,%r10                                #! PC = 0x5555555694ed *)
adcs overflow r10 r10 rbx overflow;
(* mulx   0x48(%rdi),%rbp,%rbx                     #! EA = L0x7fffffffd878; Value = 0x000000013f0332e7; PC = 0x5555555694f3 *)
...
assert true && and [ overflow = 0@1, carry = 0@1 ];
assume and [ overflow = 0, carry = 0 ] && true;
(* mov    0x18(%rsp),%rdx                          #! EA = L0x7fffffffd5c0; Value = 0xa1ffc9e7f5b91000; PC = 0x555555569509 *)
mov rdx L0x7fffffffd5c0;
...
assert true && and [ overflow = 0@1, carry = 0@1 ];
assume and [ overflow = 0, carry = 0 ] && true;
(* mov    0x10(%rsi),%rdx                          #! EA = L0x7fffffffd890; Value = 0x9340097c48935635; PC = 0x555555569593 *)
mov rdx L0x7fffffffd890;
(* mulx   (%rdi),%rbp,%rbx                         #! EA = L0x7fffffffd830; Value = 0xfa5fc2abad4a0047; PC = 0x555555569597 *)
mull rbx rbp L0x7fffffffd830 rdx;
(* xor    %r12,%r12                                #! PC = 0x55555556959c *)
mov r12 0@uint64;
clear carry;
clear overflow;
(* adox   (%rsp),%rbp                              #! EA = L0x7fffffffd5a8; Value = 0x74ab20dd2cf89fcd; PC = 0x55555556959f *)
adcs overflow rbp rbp L0x7fffffffd5a8 overflow;
(* adox   0x8(%rsp),%rbx                           #! EA = L0x7fffffffd5b0; Value = 0xd829f5d5989c0019; PC = 0x5555555695a6 *)
adcs overflow rbx rbx L0x7fffffffd5b0 overflow;
(* mov    %rbp,0x18(%rsp)                          #! EA = L0x7fffffffd5c0; PC = 0x5555555695ae *)
mov L0x7fffffffd5c0 rbp;
(* mulx   0x8(%rdi),%rax,%rbp                      #! EA = L0x7fffffffd838; Value = 0x3503ad2ac6aa8eab; PC = 0x5555555695b3 *)
mull rbp rax L0x7fffffffd838 rdx;
(* adcx   %rax,%rbx                                #! PC = 0x5555555695b9 *)
adcs carry rbx rbx rax carry;
(* adox   0x10(%rsp),%rbp                          #! EA = L0x7fffffffd5b8; Value = 0x0b804e5aa8c6a01b; PC = 0x5555555695bf *)
adcs overflow rbp rbp L0x7fffffffd5b8 overflow;
(* mov    %rbx,(%rsp)                              #! EA = L0x7fffffffd5a8; PC = 0x5555555695c7 *)
mov L0x7fffffffd5a8 rbx;
(* mulx   0x10(%rdi),%rax,%rbx                     #! EA = L0x7fffffffd840; Value = 0xd0f27e80520c7307; PC = 0x5555555695cb *)
mull rbx rax L0x7fffffffd840 rdx;
...
mov L0x7fffffffd5b0 rbp;
(* mulx   0x18(%rdi),%rbp,%rbx                     #! EA = L0x7fffffffd848; Value = 0x00f1e7d6f9dcf403; PC = 0x5555555695e2 *)
mull rbx rbp L0x7fffffffd848 rdx;
(* adcx   %rbp,%r13                                #! PC = 0x5555555695e8 *)
adcs carry r13 r13 rbp carry;
(* adox   %rbx,%r14                                #! PC = 0x5555555695ee *)
adcs overflow r14 r14 rbx overflow;
(* mulx   0x20(%rdi),%rbp,%rbx                     #! EA = L0x7fffffffd850; Value = 0xbb7dc30a0930f7cf; PC = 0x5555555695f4 *)
mull rbx rbp L0x7fffffffd850 rdx;
...
adcs overflow r15 r15 rbx overflow;
(* mulx   0x28(%rdi),%rbp,%rbx                     #! EA = L0x7fffffffd858; Value = 0x3150985797f20003; PC = 0x55555556960b *)
mull rbx rbp L0x7fffffffd858 rdx;
(* adcx   %rbp,%r15                                #! PC = 0x555555569611 *)
adcs carry r15 r15 rbp carry;
(* adox   %rbx,%r8                                 #! PC = 0x555555569617 *)
adcs overflow r8 r8 rbx overflow;
(* mulx   0x30(%rdi),%rbp,%rbx                     #! EA = L0x7fffffffd860; Value = 0xb305b4e8debf2411; PC = 0x55555556961d *)
mull rbx rbp L0x7fffffffd860 rdx;
(* adcx   %rbp,%r8                                 #! PC = 0x555555569623 *)
adcs carry r8 r8 rbp carry;
(* adox   %rbx,%r9                                 #! PC = 0x555555569629 *)
adcs overflow r9 r9 rbx overflow;
(* mulx   0x38(%rdi),%rbp,%rbx                     #! EA = L0x7fffffffd868; Value = 0xd781de5ac3b0b774; PC = 0x55555556962f *)
mull rbx rbp L0x7fffffffd868 rdx;
(* adcx   %rbp,%r9                                 #! PC = 0x555555569635 *)
adcs carry r9 r9 rbp carry;
(* adox   %rbx,%r10                                #! PC = 0x55555556963b *)
adcs overflow r10 r10 rbx overflow;
(* mulx   0x40(%rdi),%rbp,%rbx                     #! EA = L0x7fffffffd870; Value = 0x6f4fbcf0ef470319; PC = 0x555555569641 *)
mull rbx rbp L0x7fffffffd870 rdx;
(* adcx   %rbp,%r10                                #! PC = 0x555555569647 *)
adcs carry r10 r10 rbp carry;
(* adox   %rbx,%r11                                #! PC = 0x55555556964d *)
adcs overflow r11 r11 rbx overflow;
(* mulx   0x48(%rdi),%rbp,%rbx                     #! EA = L0x7fffffffd878; Value = 0x000000013f0332e7; PC = 0x555555569653 *)
mull rbx rbp L0x7fffffffd878 rdx;
...
assert true && and [ overflow = 0@1, carry = 0@1 ];
assume and [ overflow = 0, carry = 0 ] && true;
(* mov    0x18(%rsp),%rdx                          #! EA = L0x7fffffffd5c0; Value = 0xe7d00d950a278880; PC = 0x555555569669 *)
mov rdx L0x7fffffffd5c0;
...
assert true && and [ overflow = 0@1, carry = 0@1 ];
assume and [ overflow = 0, carry = 0 ] && true;
(* mov    0x18(%rsi),%rdx                          #! EA = L0x7fffffffd898; Value = 0x9726ac33fcb86565; PC = 0x5555555696f3 *)
mov rdx L0x7fffffffd898;
(* mulx   (%rdi),%rbp,%rbx                         #! EA = L0x7fffffffd830; Value = 0xfa5fc2abad4a0047; PC = 0x5555555696f7 *)
mull rbx rbp L0x7fffffffd830 rdx;
(* xor    %r13,%r13                                #! PC = 0x5555555696fc *)
mov r13 0@uint64;
clear carry;
clear overflow;
(* adox   (%rsp),%rbp                              #! EA = L0x7fffffffd5a8; Value = 0x2aedf65234ac2875; PC = 0x5555555696ff *)
adcs overflow rbp rbp L0x7fffffffd5a8 overflow;
(* adox   0x8(%rsp),%rbx                           #! EA = L0x7fffffffd5b0; Value = 0x92478db191af527e; PC = 0x555555569706 *)
adcs overflow rbx rbx L0x7fffffffd5b0 overflow;
(* mov    %rbp,0x18(%rsp)                          #! EA = L0x7fffffffd5c0; PC = 0x55555556970e *)
mov L0x7fffffffd5c0 rbp;
(* mulx   0x8(%rdi),%rax,%rbp                      #! EA = L0x7fffffffd838; Value = 0x3503ad2ac6aa8eab; PC = 0x555555569713 *)
mull rbp rax L0x7fffffffd838 rdx;
(* adcx   %rax,%rbx                                #! PC = 0x555555569719 *)
adcs carry rbx rbx rax carry;
(* adox   0x10(%rsp),%rbp                          #! EA = L0x7fffffffd5b8; Value = 0x39e597bede25fd47; PC = 0x55555556971f *)
adcs overflow rbp rbp L0x7fffffffd5b8 overflow;
(* mov    %rbx,(%rsp)                              #! EA = L0x7fffffffd5a8; PC = 0x555555569727 *)
mov L0x7fffffffd5a8 rbx;
(* mulx   0x10(%rdi),%rax,%rbx                     #! EA = L0x7fffffffd840; Value = 0xd0f27e80520c7307; PC = 0x55555556972b *)
mull rbx rax L0x7fffffffd840 rdx;
...
mov L0x7fffffffd5b0 rbp;
(* mulx   0x18(%rdi),%rbp,%rbx                     #! EA = L0x7fffffffd848; Value = 0x00f1e7d6f9dcf403; PC = 0x555555569742 *)
mull rbx rbp L0x7fffffffd848 rdx;
(* adcx   %rbp,%r14                                #! PC = 0x555555569748 *)
adcs carry r14 r14 rbp carry;
(* adox   %rbx,%r15                                #! PC = 0x55555556974e *)
adcs overflow r15 r15 rbx overflow;
(* mulx   0x20(%rdi),%rbp,%rbx                     #! EA = L0x7fffffffd850; Value = 0xbb7dc30a0930f7cf; PC = 0x555555569754 *)
mull rbx rbp L0x7fffffffd850 rdx;
...
adcs overflow r8 r8 rbx overflow;
(* mulx   0x28(%rdi),%rbp,%rbx                     #! EA = L0x7fffffffd858; Value = 0x3150985797f20003; PC = 0x55555556976b *)
mull rbx rbp L0x7fffffffd858 rdx;
(* adcx   %rbp,%r8                                 #! PC = 0x555555569771 *)
adcs carry r8 r8 rbp carry;
(* adox   %rbx,%r9                                 #! PC = 0x555555569777 *)
adcs overflow r9 r9 rbx overflow;
(* mulx   0x30(%rdi),%rbp,%rbx                     #! EA = L0x7fffffffd860; Value = 0xb305b4e8debf2411; PC = 0x55555556977d *)
mull rbx rbp L0x7fffffffd860 rdx;
(* adcx   %rbp,%r9                                 #! PC = 0x555555569783 *)
adcs carry r9 r9 rbp carry;
(* adox   %rbx,%r10                                #! PC = 0x555555569789 *)
adcs overflow r10 r10 rbx overflow;
(* mulx   0x38(%rdi),%rbp,%rbx                     #! EA = L0x7fffffffd868; Value = 0xd781de5ac3b0b774; PC = 0x55555556978f *)
mull rbx rbp L0x7fffffffd868 rdx;
(* adcx   %rbp,%r10                                #! PC = 0x555555569795 *)
adcs carry r10 r10 rbp carry;
(* adox   %rbx,%r11                                #! PC = 0x55555556979b *)
adcs overflow r11 r11 rbx overflow;
(* mulx   0x40(%rdi),%rbp,%rbx                     #! EA = L0x7fffffffd870; Value = 0x6f4fbcf0ef470319; PC = 0x5555555697a1 *)
mull rbx rbp L0x7fffffffd870 rdx;
(* adcx   %rbp,%r11                                #! PC = 0x5555555697a7 *)
adcs carry r11 r11 rbp carry;
(* adox   %rbx,%r12                                #! PC = 0x5555555697ad *)
adcs overflow r12 r12 rbx overflow;
(* mulx   0x48(%rdi),%rbp,%rbx                     #! EA = L0x7fffffffd878; Value = 0x000000013f0332e7; PC = 0x5555555697b3 *)
mull rbx rbp L0x7fffffffd878 rdx;
...
assert true && and [ overflow = 0@1, carry = 0@1 ];
assume and [ overflow = 0, carry = 0 ] && true;
(* mov    0x18(%rsp),%rdx                          #! EA = L0x7fffffffd5c0; Value = 0xcdf4a706dc024778; PC = 0x5555555697c9 *)
mov rdx L0x7fffffffd5c0;
...
assert true && and [ overflow = 0@1, carry = 0@1 ];
assume and [ overflow = 0, carry = 0 ] && true;
(* mov    0x20(%rsi),%rdx                          #! EA = L0x7fffffffd8a0; Value = 0x749190d2ef674575; PC = 0x555555569853 *)
mov rdx L0x7fffffffd8a0;
(* mulx   (%rdi),%rbp,%rbx                         #! EA = L0x7fffffffd830; Value = 0xfa5fc2abad4a0047; PC = 0x555555569857 *)
mull rbx rbp L0x7fffffffd830 rdx;
(* xor    %r14,%r14                                #! PC = 0x55555556985c *)
mov r14 0@uint64;
clear carry;
clear overflow;
(* adox   (%rsp),%rbp                              #! EA = L0x7fffffffd5a8; Value = 0x4c670d8073e72e5b; PC = 0x55555556985f *)
adcs overflow rbp rbp L0x7fffffffd5a8 overflow;
(* adox   0x8(%rsp),%rbx                           #! EA = L0x7fffffffd5b0; Value = 0x9b9426a9e36b449d; PC = 0x555555569866 *)
adcs overflow rbx rbx L0x7fffffffd5b0 overflow;
(* mov    %rbp,0x18(%rsp)                          #! EA = L0x7fffffffd5c0; PC = 0x55555556986e *)
mov L0x7fffffffd5c0 rbp;
(* mulx   0x8(%rdi),%rax,%rbp                      #! EA = L0x7fffffffd838; Value = 0x3503ad2ac6aa8eab; PC = 0x555555569873 *)
mull rbp rax L0x7fffffffd838 rdx;
(* adcx   %rax,%rbx                                #! PC = 0x555555569879 *)
adcs carry rbx rbx rax carry;
(* adox   0x10(%rsp),%rbp                          #! EA = L0x7fffffffd5b8; Value = 0x8f1479c14dd27ced; PC = 0x55555556987f *)
adcs overflow rbp rbp L0x7fffffffd5b8 overflow;
(* mov    %rbx,(%rsp)                              #! EA = L0x7fffffffd5a8; PC = 0x555555569887 *)
mov L0x7fffffffd5a8 rbx;
(* mulx   0x10(%rdi),%rax,%rbx                     #! EA = L0x7fffffffd840; Value = 0xd0f27e80520c7307; PC = 0x55555556988b *)
mull rbx rax L0x7fffffffd840 rdx;
...
mov L0x7fffffffd5b0 rbp;
(* mulx   0x18(%rdi),%rbp,%rbx                     #! EA = L0x7fffffffd848; Value = 0x00f1e7d6f9dcf403; PC = 0x5555555698a2 *)
mull rbx rbp L0x7fffffffd848 rdx;
(* adcx   %rbp,%r15                                #! PC = 0x5555555698a8 *)
adcs carry r15 r15 rbp carry;
(* adox   %rbx,%r8                                 #! PC = 0x5555555698ae *)
adcs overflow r8 r8 rbx overflow;
(* mulx   0x20(%rdi),%rbp,%rbx                     #! EA = L0x7fffffffd850; Value = 0xbb7dc30a0930f7cf; PC = 0x5555555698b4 *)
mull rbx rbp L0x7fffffffd850 rdx;
...
adcs overflow r9 r9 rbx overflow;
(* mulx   0x28(%rdi),%rbp,%rbx                     #! EA = L0x7fffffffd858; Value = 0x3150985797f20003; PC = 0x5555555698cb *)
mull rbx rbp L0x7fffffffd858 rdx;
(* adcx   %rbp,%r9                                 #! PC = 0x5555555698d1 *)
adcs carry r9 r9 rbp carry;
(* adox   %rbx,%r10                                #! PC = 0x5555555698d7 *)
adcs overflow r10 r10 rbx overflow;
(* mulx   0x30(%rdi),%rbp,%rbx                     #! EA = L0x7fffffffd860; Value = 0xb305b4e8debf2411; PC = 0x5555555698dd *)
mull rbx rbp L0x7fffffffd860 rdx;
(* adcx   %rbp,%r10                                #! PC = 0x5555555698e3 *)
adcs carry r10 r10 rbp carry;
(* adox   %rbx,%r11                                #! PC = 0x5555555698e9 *)
adcs overflow r11 r11 rbx overflow;
(* mulx   0x38(%rdi),%rbp,%rbx                     #! EA = L0x7fffffffd868; Value = 0xd781de5ac3b0b774; PC = 0x5555555698ef *)
mull rbx rbp L0x7fffffffd868 rdx;
(* adcx   %rbp,%r11                                #! PC = 0x5555555698f5 *)
adcs carry r11 r11 rbp carry;
(* adox   %rbx,%r12                                #! PC = 0x5555555698fb *)
adcs overflow r12 r12 rbx overflow;
(* mulx   0x40(%rdi),%rbp,%rbx                     #! EA = L0x7fffffffd870; Value = 0x6f4fbcf0ef470319; PC = 0x555555569901 *)
mull rbx rbp L0x7fffffffd870 rdx;
(* adcx   %rbp,%r12                                #! PC = 0x555555569907 *)
adcs carry r12 r12 rbp carry;
(* adox   %rbx,%r13                                #! PC = 0x55555556990d *)
adcs overflow r13 r13 rbx overflow;
(* mulx   0x48(%rdi),%rbp,%rbx                     #! EA = L0x7fffffffd878; Value = 0x000000013f0332e7; PC = 0x555555569913 *)
mull rbx rbp L0x7fffffffd878 rdx;
...
assert true && and [ overflow = 0@1, carry = 0@1 ];
assume and [ overflow = 0, carry = 0 ] && true;
(* mov    0x18(%rsp),%rdx                          #! EA = L0x7fffffffd5c0; Value = 0x3e9144f1fe5d71ce; PC = 0x555555569929 *)
mov rdx L0x7fffffffd5c0;
...
assert true && and [ overflow = 0@1, carry = 0@1 ];
assume and [ overflow = 0, carry = 0 ] && true;
(* mov    0x28(%rsi),%rdx                          #! EA = L0x7fffffffd8a8; Value = 0x22b4ee8beb83a00e; PC = 0x5555555699b3 *)
mov rdx L0x7fffffffd8a8;
(* mulx   (%rdi),%rbp,%rbx                         #! EA = L0x7fffffffd830; Value = 0xfa5fc2abad4a0047; PC = 0x5555555699b7 *)
mull rbx rbp L0x7fffffffd830 rdx;
(* xor    %r15,%r15                                #! PC = 0x5555555699bc *)
mov r15 0@uint64;
clear carry;
clear overflow;
(* adox   (%rsp),%rbp                              #! EA = L0x7fffffffd5a8; Value = 0x14a3f6f0eb94e850; PC = 0x5555555699bf *)
adcs overflow rbp rbp L0x7fffffffd5a8 overflow;
(* adox   0x8(%rsp),%rbx                           #! EA = L0x7fffffffd5b0; Value = 0xd6409e323094afc0; PC = 0x5555555699c6 *)
adcs overflow rbx rbx L0x7fffffffd5b0 overflow;
(* mov    %rbp,0x18(%rsp)                          #! EA = L0x7fffffffd5c0; PC = 0x5555555699ce *)
mov L0x7fffffffd5c0 rbp;
(* mulx   0x8(%rdi),%rax,%rbp                      #! EA = L0x7fffffffd838; Value = 0x3503ad2ac6aa8eab; PC = 0x5555555699d3 *)
mull rbp rax L0x7fffffffd838 rdx;
(* adcx   %rax,%rbx                                #! PC = 0x5555555699d9 *)
adcs carry rbx rbx rax carry;
(* adox   0x10(%rsp),%rbp                          #! EA = L0x7fffffffd5b8; Value = 0x875c4ab15bdc021b; PC = 0x5555555699df *)
adcs overflow rbp rbp L0x7fffffffd5b8 overflow;
(* mov    %rbx,(%rsp)                              #! EA = L0x7fffffffd5a8; PC = 0x5555555699e7 *)
mov L0x7fffffffd5a8 rbx;
(* mulx   0x10(%rdi),%rax,%rbx                     #! EA = L0x7fffffffd840; Value = 0xd0f27e80520c7307; PC = 0x5555555699eb *)
mull rbx rax L0x7fffffffd840 rdx;
...
mov L0x7fffffffd5b0 rbp;
(* mulx   0x18(%rdi),%rbp,%rbx                     #! EA = L0x7fffffffd848; Value = 0x00f1e7d6f9dcf403; PC = 0x555555569a02 *)
mull rbx rbp L0x7fffffffd848 rdx;
(* adcx   %rbp,%r8                                 #! PC = 0x555555569a08 *)
adcs carry r8 r8 rbp carry;
(* adox   %rbx,%r9                                 #! PC = 0x555555569a0e *)
adcs overflow r9 r9 rbx overflow;
(* mulx   0x20(%rdi),%rbp,%rbx                     #! EA = L0x7fffffffd850; Value = 0xbb7dc30a0930f7cf; PC = 0x555555569a14 *)
mull rbx rbp L0x7fffffffd850 rdx;
...
adcs overflow r10 r10 rbx overflow;
(* mulx   0x28(%rdi),%rbp,%rbx                     #! EA = L0x7fffffffd858; Value = 0x3150985797f20003; PC = 0x555555569a2b *)
mull rbx rbp L0x7fffffffd858 rdx;
(* adcx   %rbp,%r10                                #! PC = 0x555555569a31 *)
adcs carry r10 r10 rbp carry;
(* adox   %rbx,%r11                                #! PC = 0x555555569a37 *)
adcs overflow r11 r11 rbx overflow;
(* mulx   0x30(%rdi),%rbp,%rbx                     #! EA = L0x7fffffffd860; Value = 0xb305b4e8debf2411; PC = 0x555555569a3d *)
mull rbx rbp L0x7fffffffd860 rdx;
(* adcx   %rbp,%r11                                #! PC = 0x555555569a43 *)
adcs carry r11 r11 rbp carry;
(* adox   %rbx,%r12                                #! PC = 0x555555569a49 *)
adcs overflow r12 r12 rbx overflow;
(* mulx   0x38(%rdi),%rbp,%rbx                     #! EA = L0x7fffffffd868; Value = 0xd781de5ac3b0b774; PC = 0x555555569a4f *)
mull rbx rbp L0x7fffffffd868 rdx;
(* adcx   %rbp,%r12                                #! PC = 0x555555569a55 *)
adcs carry r12 r12 rbp carry;
(* adox   %rbx,%r13                                #! PC = 0x555555569a5b *)
adcs overflow r13 r13 rbx overflow;
(* mulx   0x40(%rdi),%rbp,%rbx                     #! EA = L0x7fffffffd870; Value = 0x6f4fbcf0ef470319; PC = 0x555555569a61 *)
mull rbx rbp L0x7fffffffd870 rdx;
(* adcx   %rbp,%r13                                #! PC = 0x555555569a67 *)
adcs carry r13 r13 rbp carry;
(* adox   %rbx,%r14                                #! PC = 0x555555569a6d *)
adcs overflow r14 r14 rbx overflow;
(* mulx   0x48(%rdi),%rbp,%rbx                     #! EA = L0x7fffffffd878; Value = 0x000000013f0332e7; PC = 0x555555569a73 *)
mull rbx rbp L0x7fffffffd878 rdx;
...
assert true && and [ overflow = 0@1, carry = 0@1 ];
assume and [ overflow = 0, carry = 0 ] && true;
(* mov    0x18(%rsp),%rdx                          #! EA = L0x7fffffffd5c0; Value = 0x58d4ac4ef7224c32; PC = 0x555555569a89 *)
mov rdx L0x7fffffffd5c0;
...
assert true && and [ overflow = 0@1, carry = 0@1 ];
assume and [ overflow = 0, carry = 0 ] && true;
(* mov    0x30(%rsi),%rdx                          #! EA = L0x7fffffffd8b0; Value = 0x80744b00aa5bbf34; PC = 0x555555569b13 *)
mov rdx L0x7fffffffd8b0;
(* mulx   (%rdi),%rbp,%rbx                         #! EA = L0x7fffffffd830; Value = 0xfa5fc2abad4a0047; PC = 0x555555569b17 *)
mull rbx rbp L0x7fffffffd830 rdx;
(* xor    %r8,%r8                                  #! PC = 0x555555569b1c *)
mov r8 0@uint64;
clear carry;
clear overflow;
(* adox   (%rsp),%rbp                              #! EA = L0x7fffffffd5a8; Value = 0x815d2a482e9efabb; PC = 0x555555569b1f *)
adcs overflow rbp rbp L0x7fffffffd5a8 overflow;
(* adox   0x8(%rsp),%rbx                           #! EA = L0x7fffffffd5b0; Value = 0x0079bebcbf3c7046; PC = 0x555555569b26 *)
adcs overflow rbx rbx L0x7fffffffd5b0 overflow;
(* mov    %rbp,0x18(%rsp)                          #! EA = L0x7fffffffd5c0; PC = 0x555555569b2e *)
mov L0x7fffffffd5c0 rbp;
(* mulx   0x8(%rdi),%rax,%rbp                      #! EA = L0x7fffffffd838; Value = 0x3503ad2ac6aa8eab; PC = 0x555555569b33 *)
mull rbp rax L0x7fffffffd838 rdx;
(* adcx   %rax,%rbx                                #! PC = 0x555555569b39 *)
adcs carry rbx rbx rax carry;
(* adox   0x10(%rsp),%rbp                          #! EA = L0x7fffffffd5b8; Value = 0xa914546e7fed606b; PC = 0x555555569b3f *)
adcs overflow rbp rbp L0x7fffffffd5b8 overflow;
(* mov    %rbx,(%rsp)                              #! EA = L0x7fffffffd5a8; PC = 0x555555569b47 *)
mov L0x7fffffffd5a8 rbx;
(* mulx   0x10(%rdi),%rax,%rbx                     #! EA = L0x7fffffffd840; Value = 0xd0f27e80520c7307; PC = 0x555555569b4b *)
mull rbx rax L0x7fffffffd840 rdx;
...
mov L0x7fffffffd5b0 rbp;
(* mulx   0x18(%rdi),%rbp,%rbx                     #! EA = L0x7fffffffd848; Value = 0x00f1e7d6f9dcf403; PC = 0x555555569b62 *)
mull rbx rbp L0x7fffffffd848 rdx;
(* adcx   %rbp,%r9                                 #! PC = 0x555555569b68 *)
adcs carry r9 r9 rbp carry;
(* adox   %rbx,%r10                                #! PC = 0x555555569b6e *)
adcs overflow r10 r10 rbx overflow;
(* mulx   0x20(%rdi),%rbp,%rbx                     #! EA = L0x7fffffffd850; Value = 0xbb7dc30a0930f7cf; PC = 0x555555569b74 *)
mull rbx rbp L0x7fffffffd850 rdx;
...
adcs overflow r11 r11 rbx overflow;
(* mulx   0x28(%rdi),%rbp,%rbx                     #! EA = L0x7fffffffd858; Value = 0x3150985797f20003; PC = 0x555555569b8b *)
mull rbx rbp L0x7fffffffd858 rdx;
(* adcx   %rbp,%r11                                #! PC = 0x555555569b91 *)
adcs carry r11 r11 rbp carry;
(* adox   %rbx,%r12                                #! PC = 0x555555569b97 *)
adcs overflow r12 r12 rbx overflow;
(* mulx   0x30(%rdi),%rbp,%rbx                     #! EA = L0x7fffffffd860; Value = 0xb305b4e8debf2411; PC = 0x555555569b9d *)
mull rbx rbp L0x7fffffffd860 rdx;
(* adcx   %rbp,%r12                                #! PC = 0x555555569ba3 *)
adcs carry r12 r12 rbp carry;
(* adox   %rbx,%r13                                #! PC = 0x555555569ba9 *)
adcs overflow r13 r13 rbx overflow;
(* mulx   0x38(%rdi),%rbp,%rbx                     #! EA = L0x7fffffffd868; Value = 0xd781de5ac3b0b774; PC = 0x555555569baf *)
mull rbx rbp L0x7fffffffd868 rdx;
(* adcx   %rbp,%r13                                #! PC = 0x555555569bb5 *)
adcs carry r13 r13 rbp carry;
(* adox   %rbx,%r14                                #! PC = 0x555555569bbb *)
adcs overflow r14 r14 rbx overflow;
(* mulx   0x40(%rdi),%rbp,%rbx                     #! EA = L0x7fffffffd870; Value = 0x6f4fbcf0ef470319; PC = 0x555555569bc1 *)
mull rbx rbp L0x7fffffffd870 rdx;
(* adcx   %rbp,%r14                                #! PC = 0x555555569bc7 *)
adcs carry r14 r14 rbp carry;
(* adox   %rbx,%r15                                #! PC = 0x555555569bcd *)
adcs overflow r15 r15 rbx overflow;
(* mulx   0x48(%rdi),%rbp,%rbx                     #! EA = L0x7fffffffd878; Value = 0x000000013f0332e7; PC = 0x555555569bd3 *)
mull rbx rbp L0x7fffffffd878 rdx;
...
assert true && and [ overflow = 0@1, carry = 0@1 ];
assume and [ overflow = 0, carry = 0 ] && true;
(* mov    0x18(%rsp),%rdx                          #! EA = L0x7fffffffd5c0; Value = 0x516955eed7190227; PC = 0x555555569be9 *)
mov rdx L0x7fffffffd5c0;
...
assert true && and [ overflow = 0@1, carry = 0@1 ];
assume and [ overflow = 0, carry = 0 ] && true;
(* mov    0x38(%rsi),%rdx                          #! EA = L0x7fffffffd8b8; Value = 0x95294985787e7492; PC = 0x555555569c73 *)
mov rdx L0x7fffffffd8b8;
(* mulx   (%rdi),%rbp,%rbx                         #! EA = L0x7fffffffd830; Value = 0xfa5fc2abad4a0047; PC = 0x555555569c77 *)
mull rbx rbp L0x7fffffffd830 rdx;
(* xor    %r9,%r9                                  #! PC = 0x555555569c7c *)
mov r9 0@uint64;
clear carry;
clear overflow;
(* adox   (%rsp),%rbp                              #! EA = L0x7fffffffd5a8; Value = 0x14776e19603123c3; PC = 0x555555569c7f *)
adcs overflow rbp rbp L0x7fffffffd5a8 overflow;
(* adox   0x8(%rsp),%rbx                           #! EA = L0x7fffffffd5b0; Value = 0x944a2b4e0f7e3c8f; PC = 0x555555569c86 *)
adcs overflow rbx rbx L0x7fffffffd5b0 overflow;
(* mov    %rbp,0x18(%rsp)                          #! EA = L0x7fffffffd5c0; PC = 0x555555569c8e *)
mov L0x7fffffffd5c0 rbp;
(* mulx   0x8(%rdi),%rax,%rbp                      #! EA = L0x7fffffffd838; Value = 0x3503ad2ac6aa8eab; PC = 0x555555569c93 *)
mull rbp rax L0x7fffffffd838 rdx;
(* adcx   %rax,%rbx                                #! PC = 0x555555569c99 *)
adcs carry rbx rbx rax carry;
(* adox   0x10(%rsp),%rbp                          #! EA = L0x7fffffffd5b8; Value = 0x405c29ac5ae00ebb; PC = 0x555555569c9f *)
adcs overflow rbp rbp L0x7fffffffd5b8 overflow;
(* mov    %rbx,(%rsp)                              #! EA = L0x7fffffffd5a8; PC = 0x555555569ca7 *)
mov L0x7fffffffd5a8 rbx;
(* mulx   0x10(%rdi),%rax,%rbx                     #! EA = L0x7fffffffd840; Value = 0xd0f27e80520c7307; PC = 0x555555569cab *)
mull rbx rax L0x7fffffffd840 rdx;
...
mov L0x7fffffffd5b0 rbp;
(* mulx   0x18(%rdi),%rbp,%rbx                     #! EA = L0x7fffffffd848; Value = 0x00f1e7d6f9dcf403; PC = 0x555555569cc2 *)
mull rbx rbp L0x7fffffffd848 rdx;
(* adcx   %rbp,%r10                                #! PC = 0x555555569cc8 *)
adcs carry r10 r10 rbp carry;
(* adox   %rbx,%r11                                #! PC = 0x555555569cce *)
adcs overflow r11 r11 rbx overflow;
(* mulx   0x20(%rdi),%rbp,%rbx                     #! EA = L0x7fffffffd850; Value = 0xbb7dc30a0930f7cf; PC = 0x555555569cd4 *)
mull rbx rbp L0x7fffffffd850 rdx;
...
adcs overflow r12 r12 rbx overflow;
(* mulx   0x28(%rdi),%rbp,%rbx                     #! EA = L0x7fffffffd858; Value = 0x3150985797f20003; PC = 0x555555569ceb *)
mull rbx rbp L0x7fffffffd858 rdx;
(* adcx   %rbp,%r12                                #! PC = 0x555555569cf1 *)
adcs carry r12 r12 rbp carry;
(* adox   %rbx,%r13                                #! PC = 0x555555569cf7 *)
adcs overflow r13 r13 rbx overflow;
(* mulx   0x30(%rdi),%rbp,%rbx                     #! EA = L0x7fffffffd860; Value = 0xb305b4e8debf2411; PC = 0x555555569cfd *)
mull rbx rbp L0x7fffffffd860 rdx;
(* adcx   %rbp,%r13                                #! PC = 0x555555569d03 *)
adcs carry r13 r13 rbp carry;
(* adox   %rbx,%r14                                #! PC = 0x555555569d09 *)
adcs overflow r14 r14 rbx overflow;
(* mulx   0x38(%rdi),%rbp,%rbx                     #! EA = L0x7fffffffd868; Value = 0xd781de5ac3b0b774; PC = 0x555555569d0f *)
mull rbx rbp L0x7fffffffd868 rdx;
(* adcx   %rbp,%r14                                #! PC = 0x555555569d15 *)
adcs carry r14 r14 rbp carry;
(* adox   %rbx,%r15                                #! PC = 0x555555569d1b *)
adcs overflow r15 r15 rbx overflow;
(* mulx   0x40(%rdi),%rbp,%rbx                     #! EA = L0x7fffffffd870; Value = 0x6f4fbcf0ef470319; PC = 0x555555569d21 *)
mull rbx rbp L0x7fffffffd870 rdx;
(* adcx   %rbp,%r15                                #! PC = 0x555555569d27 *)
adcs carry r15 r15 rbp carry;
(* adox   %rbx,%r8                                 #! PC = 0x555555569d2d *)
adcs overflow r8 r8 rbx overflow;
(* mulx   0x48(%rdi),%rbp,%rbx                     #! EA = L0x7fffffffd878; Value = 0x000000013f0332e7; PC = 0x555555569d33 *)
mull rbx rbp L0x7fffffffd878 rdx;
...
assert true && and [ overflow = 0@1, carry = 0@1 ];
assume and [ overflow = 0, carry = 0 ] && true;
(* mov    0x18(%rsp),%rdx                          #! EA = L0x7fffffffd5c0; Value = 0x0ce99cf827777841; PC = 0x555555569d49 *)
mov rdx L0x7fffffffd5c0;
...
assert true && and [ overflow = 0@1, carry = 0@1 ];
assume and [ overflow = 0, carry = 0 ] && true;
(* mov    0x40(%rsi),%rdx                          #! EA = L0x7fffffffd8c0; Value = 0xe7f154fdc4f5be42; PC = 0x555555569dd3 *)
mov rdx L0x7fffffffd8c0;
(* mulx   (%rdi),%rbp,%rbx                         #! EA = L0x7fffffffd830; Value = 0xfa5fc2abad4a0047; PC = 0x555555569dd7 *)
mull rbx rbp L0x7fffffffd830 rdx;
(* xor    %r10,%r10                                #! PC = 0x555555569ddc *)
mov r10 0@uint64;
clear carry;
clear overflow;
(* adox   (%rsp),%rbp                              #! EA = L0x7fffffffd5a8; Value = 0x8e9809edf7099118; PC = 0x555555569ddf *)
adcs overflow rbp rbp L0x7fffffffd5a8 overflow;
(* adox   0x8(%rsp),%rbx                           #! EA = L0x7fffffffd5b0; Value = 0x80e01e520143fe13; PC = 0x555555569de6 *)
adcs overflow rbx rbx L0x7fffffffd5b0 overflow;
(* mov    %rbp,0x18(%rsp)                          #! EA = L0x7fffffffd5c0; PC = 0x555555569dee *)
mov L0x7fffffffd5c0 rbp;
(* mulx   0x8(%rdi),%rax,%rbp                      #! EA = L0x7fffffffd838; Value = 0x3503ad2ac6aa8eab; PC = 0x555555569df3 *)
mull rbp rax L0x7fffffffd838 rdx;
(* adcx   %rax,%rbx                                #! PC = 0x555555569df9 *)
adcs carry rbx rbx rax carry;
(* adox   0x10(%rsp),%rbp                          #! EA = L0x7fffffffd5b8; Value = 0x0ecfee7ff7927653; PC = 0x555555569dff *)
adcs overflow rbp rbp L0x7fffffffd5b8 overflow;
(* mov    %rbx,(%rsp)                              #! EA = L0x7fffffffd5a8; PC = 0x555555569e07 *)
mov L0x7fffffffd5a8 rbx;
(* mulx   0x10(%rdi),%rax,%rbx                     #! EA = L0x7fffffffd840; Value = 0xd0f27e80520c7307; PC = 0x555555569e0b *)
mull rbx rax L0x7fffffffd840 rdx;
...
mov L0x7fffffffd5b0 rbp;
(* mulx   0x18(%rdi),%rbp,%rbx                     #! EA = L0x7fffffffd848; Value = 0x00f1e7d6f9dcf403; PC = 0x555555569e22 *)
mull rbx rbp L0x7fffffffd848 rdx;
(* adcx   %rbp,%r11                                #! PC = 0x555555569e28 *)
adcs carry r11 r11 rbp carry;
(* adox   %rbx,%r12                                #! PC = 0x555555569e2e *)
adcs overflow r12 r12 rbx overflow;
(* mulx   0x20(%rdi),%rbp,%rbx                     #! EA = L0x7fffffffd850; Value = 0xbb7dc30a0930f7cf; PC = 0x555555569e34 *)
mull rbx rbp L0x7fffffffd850 rdx;
...
adcs overflow r13 r13 rbx overflow;
(* mulx   0x28(%rdi),%rbp,%rbx                     #! EA = L0x7fffffffd858; Value = 0x3150985797f20003; PC = 0x555555569e4b *)
mull rbx rbp L0x7fffffffd858 rdx;
(* adcx   %rbp,%r13                                #! PC = 0x555555569e51 *)
adcs carry r13 r13 rbp carry;
(* adox   %rbx,%r14                                #! PC = 0x555555569e57 *)
adcs overflow r14 r14 rbx overflow;
(* mulx   0x30(%rdi),%rbp,%rbx                     #! EA = L0x7fffffffd860; Value = 0xb305b4e8debf2411; PC = 0x555555569e5d *)
mull rbx rbp L0x7fffffffd860 rdx;
(* adcx   %rbp,%r14                                #! PC = 0x555555569e63 *)
adcs carry r14 r14 rbp carry;
(* adox   %rbx,%r15                                #! PC = 0x555555569e69 *)
adcs overflow r15 r15 rbx overflow;
(* mulx   0x38(%rdi),%rbp,%rbx                     #! EA = L0x7fffffffd868; Value = 0xd781de5ac3b0b774; PC = 0x555555569e6f *)
mull rbx rbp L0x7fffffffd868 rdx;
(* adcx   %rbp,%r15                                #! PC = 0x555555569e75 *)
adcs carry r15 r15 rbp carry;
(* adox   %rbx,%r8                                 #! PC = 0x555555569e7b *)
adcs overflow r8 r8 rbx overflow;
(* mulx   0x40(%rdi),%rbp,%rbx                     #! EA = L0x7fffffffd870; Value = 0x6f4fbcf0ef470319; PC = 0x555555569e81 *)
mull rbx rbp L0x7fffffffd870 rdx;
(* adcx   %rbp,%r8                                 #! PC = 0x555555569e87 *)
adcs carry r8 r8 rbp carry;
(* adox   %rbx,%r9                                 #! PC = 0x555555569e8d *)
adcs overflow r9 r9 rbx overflow;
(* mulx   0x48(%rdi),%rbp,%rbx                     #! EA = L0x7fffffffd878; Value = 0x000000013f0332e7; PC = 0x555555569e93 *)
mull rbx rbp L0x7fffffffd878 rdx;
...
assert true && and [ overflow = 0@1, carry = 0@1 ];
assume and [ overflow = 0, carry = 0 ] && true;
(* mov    0x18(%rsp),%rdx                          #! EA = L0x7fffffffd5c0; Value = 0xcacdb70130455566; PC = 0x555555569ea9 *)
mov rdx L0x7fffffffd5c0;
...
assert true && and [ overflow = 0@1, carry = 0@1 ];
assume and [ overflow = 0, carry = 0 ] && true;
(* mov    0x48(%rsi),%rdx                          #! EA = L0x7fffffffd8c8; Value = 0x000000023a3ba144; PC = 0x555555569f33 *)
mov rdx L0x7fffffffd8c8;
(* mulx   (%rdi),%rbp,%rbx                         #! EA = L0x7fffffffd830; Value = 0xfa5fc2abad4a0047; PC = 0x555555569f37 *)
mull rbx rbp L0x7fffffffd830 rdx;
(* xor    %r11,%r11                                #! PC = 0x555555569f3c *)
mov r11 0@uint64;
clear carry;
clear overflow;
(* adox   (%rsp),%rbp                              #! EA = L0x7fffffffd5a8; Value = 0x2c95c42f0ee7fa5e; PC = 0x555555569f3f *)
adcs overflow rbp rbp L0x7fffffffd5a8 overflow;
(* adox   0x8(%rsp),%rbx                           #! EA = L0x7fffffffd5b0; Value = 0x2d831bb22ea11e65; PC = 0x555555569f46 *)
adcs overflow rbx rbx L0x7fffffffd5b0 overflow;
(* mov    %rbp,0x18(%rsp)                          #! EA = L0x7fffffffd5c0; PC = 0x555555569f4e *)
mov L0x7fffffffd5c0 rbp;
(* mulx   0x8(%rdi),%rax,%rbp                      #! EA = L0x7fffffffd838; Value = 0x3503ad2ac6aa8eab; PC = 0x555555569f53 *)
mull rbp rax L0x7fffffffd838 rdx;
(* adcx   %rax,%rbx                                #! PC = 0x555555569f59 *)
adcs carry rbx rbx rax carry;
(* adox   0x10(%rsp),%rbp                          #! EA = L0x7fffffffd5b8; Value = 0x27bbf7ff22a942b9; PC = 0x555555569f5f *)
adcs overflow rbp rbp L0x7fffffffd5b8 overflow;
(* mov    %rbx,(%rcx)                              #! EA = L0x7fffffffd920; PC = 0x555555569f67 *)
mov L0x7fffffffd920 rbx;
(* mulx   0x10(%rdi),%rax,%rbx                     #! EA = L0x7fffffffd840; Value = 0xd0f27e80520c7307; PC = 0x555555569f6a *)
mull rbx rax L0x7fffffffd840 rdx;
(* adcx   %rax,%rbp                                #! PC = 0x555555569f70 *)
adcs carry rbp rbp rax carry;
(* adox   %rbx,%r12                                #! PC = 0x555555569f76 *)
adcs overflow r12 r12 rbx overflow;
(* mov    %rbp,0x8(%rcx)                           #! EA = L0x7fffffffd928; PC = 0x555555569f7c *)
mov L0x7fffffffd928 rbp;
(* mulx   0x18(%rdi),%rbp,%rbx                     #! EA = L0x7fffffffd848; Value = 0x00f1e7d6f9dcf403; PC = 0x555555569f80 *)
mull rbx rbp L0x7fffffffd848 rdx;
(* adcx   %rbp,%r12                                #! PC = 0x555555569f86 *)
adcs carry r12 r12 rbp carry;
(* adox   %rbx,%r13                                #! PC = 0x555555569f8c *)
adcs overflow r13 r13 rbx overflow;
(* mulx   0x20(%rdi),%rbp,%rbx                     #! EA = L0x7fffffffd850; Value = 0xbb7dc30a0930f7cf; PC = 0x555555569f92 *)
mull rbx rbp L0x7fffffffd850 rdx;
(* mov    %r12,0x10(%rcx)                          #! EA = L0x7fffffffd930; PC = 0x555555569f98 *)
mov L0x7fffffffd930 r12;
(* adcx   %rbp,%r13                                #! PC = 0x555555569f9c *)
adcs carry r13 r13 rbp carry;
(* adox   %rbx,%r14                                #! PC = 0x555555569fa2 *)
adcs overflow r14 r14 rbx overflow;
(* mulx   0x28(%rdi),%rbp,%rbx                     #! EA = L0x7fffffffd858; Value = 0x3150985797f20003; PC = 0x555555569fa8 *)
mull rbx rbp L0x7fffffffd858 rdx;
(* adcx   %rbp,%r14                                #! PC = 0x555555569fae *)
adcs carry r14 r14 rbp carry;
(* adox   %rbx,%r15                                #! PC = 0x555555569fb4 *)
adcs overflow r15 r15 rbx overflow;
(* mulx   0x30(%rdi),%rbp,%rbx                     #! EA = L0x7fffffffd860; Value = 0xb305b4e8debf2411; PC = 0x555555569fba *)
mull rbx rbp L0x7fffffffd860 rdx;
(* adcx   %rbp,%r15                                #! PC = 0x555555569fc0 *)
adcs carry r15 r15 rbp carry;
(* adox   %rbx,%r8                                 #! PC = 0x555555569fc6 *)
adcs overflow r8 r8 rbx overflow;
(* mulx   0x38(%rdi),%rbp,%rbx                     #! EA = L0x7fffffffd868; Value = 0xd781de5ac3b0b774; PC = 0x555555569fcc *)
mull rbx rbp L0x7fffffffd868 rdx;
(* adcx   %rbp,%r8                                 #! PC = 0x555555569fd2 *)
adcs carry r8 r8 rbp carry;
(* adox   %rbx,%r9                                 #! PC = 0x555555569fd8 *)
adcs overflow r9 r9 rbx overflow;
(* mulx   0x40(%rdi),%rbp,%rbx                     #! EA = L0x7fffffffd870; Value = 0x6f4fbcf0ef470319; PC = 0x555555569fde *)
mull rbx rbp L0x7fffffffd870 rdx;
(* adcx   %rbp,%r9                                 #! PC = 0x555555569fe4 *)
adcs carry r9 r9 rbp carry;
(* adox   %rbx,%r10                                #! PC = 0x555555569fea *)
adcs overflow r10 r10 rbx overflow;
(* mulx   0x48(%rdi),%rbp,%rbx                     #! EA = L0x7fffffffd878; Value = 0x000000013f0332e7; PC = 0x555555569ff0 *)
mull rbx rbp L0x7fffffffd878 rdx;
...
assert true && and [ overflow = 0@1, carry = 0@1 ];
assume and [ overflow = 0, carry = 0 ] && true;
(* mov    0x18(%rsp),%rdx                          #! EA = L0x7fffffffd5c0; Value = 0x04db2670c719b43a; PC = 0x55555556a006 *)
mov rdx L0x7fffffffd5c0;
...
assert true && and [ overflow = 0@1, carry = 0@1 ];
assume and [ overflow = 0, carry = 0 ] && true;
(* mov    %r13,0x18(%rcx)                          #! EA = L0x7fffffffd938; PC = 0x55555556a090 *)
mov L0x7fffffffd938 r13;
(* mov    %r14,0x20(%rcx)                          #! EA = L0x7fffffffd940; PC = 0x55555556a094 *)
mov L0x7fffffffd940 r14;
(* mov    %r15,0x28(%rcx)                          #! EA = L0x7fffffffd948; PC = 0x55555556a098 *)
mov L0x7fffffffd948 r15;
(* mov    %r8,0x30(%rcx)                           #! EA = L0x7fffffffd950; PC = 0x55555556a09c *)
mov L0x7fffffffd950 r8;
(* mov    %r9,0x38(%rcx)                           #! EA = L0x7fffffffd958; PC = 0x55555556a0a0 *)
mov L0x7fffffffd958 r9;
(* mov    %r10,0x40(%rcx)                          #! EA = L0x7fffffffd960; PC = 0x55555556a0a4 *)
mov L0x7fffffffd960 r10;
(* mov    %r11,0x48(%rcx)                          #! EA = L0x7fffffffd968; PC = 0x55555556a0a8 *)
...
mov c0 L0x7fffffffd920;
mov c1 L0x7fffffffd928;
mov c2 L0x7fffffffd930;
mov c3 L0x7fffffffd938;
mov c4 L0x7fffffffd940;
mov c5 L0x7fffffffd948;
mov c6 L0x7fffffffd950;
mov c7 L0x7fffffffd958;
mov c8 L0x7fffffffd960;
mov c9 L0x7fffffffd968;
