(* quine: -v -isafety -jobs 20 -slicing -no_carry_constraint fpsqr610_mont.cl
Parsing Cryptoline file:                [OK]            0.013561 seconds
Checking well-formedness:               [OK]            0.002497 seconds
Transforming to SSA form:               [OK]            0.001003 seconds
Normalizing specification:              [OK]            0.001781 seconds
Rewriting assignments:                  [OK]            0.001359 seconds
Verifying program safety:               [OK]            15.181305 seconds
Verifying range assertions:             [OK]            0.994961 seconds
Verifying range specification:          [OK]            213.463362 seconds
Rewriting value-preserved casting:      [OK]            0.000383 seconds
Verifying algebraic assertions:         [OK]            0.459628 seconds
Verifying algebraic specification:      [OK]            0.295581 seconds
Verification result:                    [OK]            230.416723 seconds
*)
...
(* stp	x29, x30, [sp, #-208]!                      #! EA = L0xffffffffe560; PC = 0xaaaaaaaae094 *)
mov L0xffffffffe560 x29;
mov L0xffffffffe568 x30;
(* mov	w3, #0xa                   	// #10          #! PC = 0xaaaaaaaae09c *)
mov w3 0xa@uint64;
(* mov	x29, sp                                     #! PC = 0xaaaaaaaae0a0 *)
mov x29 sp;
(* ldr	x4, [x4, #4048]                             #! EA = L0xaaaaaaacbfd0; Value = 0x0000fffff7ffd6b0; PC = 0xaaaaaaaae0a4 *)
mov x4 L0xaaaaaaacbfd0;
(* stp	x19, x20, [sp, #16]                         #! EA = L0xffffffffe570; PC = 0xaaaaaaaae0a8 *)
mov L0xffffffffe570 x19;
mov L0xffffffffe578 x20;
(* add	x20, sp, #0x28                              #! PC = 0xaaaaaaaae0ac *)
adds dontcare x20 sp 0x28@uint64;
(* ldr	x5, [x4]                                    #! EA = L0xfffff7ffd6b0; Value = 0xc4158025f7fbcd00; PC = 0xaaaaaaaae0b0 *)
mov x5 L0xfffff7ffd6b0;
(* str	x5, [sp, #200]                              #! EA = L0xffffffffe628; PC = 0xaaaaaaaae0b4 *)
mov L0xffffffffe628 x5;
(* mov	x5, #0x0                   	// #0           #! PC = 0xaaaaaaaae0b8 *)
mov x5 0x0@uint64;
(* mov	x2, x20                                     #! PC = 0xaaaaaaaae0bc *)
mov x2 x20;
(* mov	x19, x1                                     #! PC = 0xaaaaaaaae0c0 *)
mov x19 x1;
(* mov	x1, x0                                      #! PC = 0xaaaaaaaae0c4 *)
mov x1 x0;
(* stp	xzr, xzr, [sp, #40]                         #! EA = L0xffffffffe588; PC = 0xaaaaaaaae0c8 *)
mov L0xffffffffe588 0@uint64;
mov L0xffffffffe590 0@uint64;
(* stp	xzr, xzr, [sp, #56]                         #! EA = L0xffffffffe598; PC = 0xaaaaaaaae0cc *)
mov L0xffffffffe598 0@uint64;
mov L0xffffffffe5a0 0@uint64;
(* stp	xzr, xzr, [sp, #72]                         #! EA = L0xffffffffe5a8; PC = 0xaaaaaaaae0d0 *)
mov L0xffffffffe5a8 0@uint64;
mov L0xffffffffe5b0 0@uint64;
(* stp	xzr, xzr, [sp, #88]                         #! EA = L0xffffffffe5b8; PC = 0xaaaaaaaae0d4 *)
mov L0xffffffffe5b8 0@uint64;
mov L0xffffffffe5c0 0@uint64;
(* stp	xzr, xzr, [sp, #104]                        #! EA = L0xffffffffe5c8; PC = 0xaaaaaaaae0d8 *)
mov L0xffffffffe5c8 0@uint64;
mov L0xffffffffe5d0 0@uint64;
(* stp	xzr, xzr, [sp, #120]                        #! EA = L0xffffffffe5d8; PC = 0xaaaaaaaae0dc *)
mov L0xffffffffe5d8 0@uint64;
mov L0xffffffffe5e0 0@uint64;
(* stp	xzr, xzr, [sp, #136]                        #! EA = L0xffffffffe5e8; PC = 0xaaaaaaaae0e0 *)
mov L0xffffffffe5e8 0@uint64;
mov L0xffffffffe5f0 0@uint64;
(* stp	xzr, xzr, [sp, #152]                        #! EA = L0xffffffffe5f8; PC = 0xaaaaaaaae0e4 *)
mov L0xffffffffe5f8 0@uint64;
mov L0xffffffffe600 0@uint64;
(* stp	xzr, xzr, [sp, #168]                        #! EA = L0xffffffffe608; PC = 0xaaaaaaaae0e8 *)
mov L0xffffffffe608 0@uint64;
mov L0xffffffffe610 0@uint64;
(* stp	xzr, xzr, [sp, #184]                        #! EA = L0xffffffffe618; PC = 0xaaaaaaaae0ec *)
mov L0xffffffffe618 0@uint64;
mov L0xffffffffe620 0@uint64;
(* #bl	0xaaaaaaab6710 <mp_mul>                     #! PC = 0xaaaaaaaae0f0 *)
#bl	0xaaaaaaab6710 <mp_mul>                     #! 0xaaaaaaaae0f0 = 0xaaaaaaaae0f0;
(* #! -> SP = 0xffffffffe560 *)
...
(* ldp	x3, x4, [x0]                                #! EA = L0xffffffffe898; Value = 0x42cc1347c72a4869; PC = 0xaaaaaaab6b34 *)
mov x3 L0xffffffffe898;
mov x4 L0xffffffffe8a0;
(* ldp	x5, x6, [x0, #16]                           #! EA = L0xffffffffe8a8; Value = 0xa0c10507221b728b; PC = 0xaaaaaaab6b38 *)
mov x5 L0xffffffffe8a8;
mov x6 L0xffffffffe8b0;
(* ldp	x7, x8, [x0, #32]                           #! EA = L0xffffffffe8b8; Value = 0x58936217b931465f; PC = 0xaaaaaaab6b3c *)
mov x7 L0xffffffffe8b8;
mov x8 L0xffffffffe8c0;
(* ldp	x10, x11, [x0, #48]                         #! EA = L0xffffffffe8c8; Value = 0x95e4a9c39e45f93c; PC = 0xaaaaaaab6b40 *)
mov x10 L0xffffffffe8c8;
mov x11 L0xffffffffe8d0;
(* ldp	x12, x13, [x0, #64]                         #! EA = L0xffffffffe8d8; Value = 0xa6ea96f46cb15d67; PC = 0xaaaaaaab6b44 *)
...
(* ldp	x21, x22, [x1]                              #! EA = L0xffffffffe898; Value = 0x42cc1347c72a4869; PC = 0xaaaaaaab6b68 *)
mov x21 L0xffffffffe898;
mov x22 L0xffffffffe8a0;
(* adcs	x29, x6, x12                               #! PC = 0xaaaaaaab6b6c *)
adcs carry x29 x6 x12 carry;
(* ldp	x14, x15, [x1, #48]                         #! EA = L0xffffffffe8c8; Value = 0x95e4a9c39e45f93c; PC = 0xaaaaaaab6b70 *)
mov x14 L0xffffffffe8c8;
mov x15 L0xffffffffe8d0;
(* adcs	x30, x7, x13                               #! PC = 0xaaaaaaab6b74 *)
adcs carry x30 x7 x13 carry;
(* ldp	x23, x24, [x1, #16]                         #! EA = L0xffffffffe8a8; Value = 0xa0c10507221b728b; PC = 0xaaaaaaab6b78 *)
mov x23 L0xffffffffe8a8;
mov x24 L0xffffffffe8b0;
(* adc	x9, xzr, xzr                                #! PC = 0xaaaaaaab6b7c *)
adc x9 0@uint64 0@uint64 carry;
(* ldp	x25, x13, [x1, #32]                         #! EA = L0xffffffffe8b8; Value = 0x58936217b931465f; PC = 0xaaaaaaab6b80 *)
mov x25 L0xffffffffe8b8;
mov x13 L0xffffffffe8c0;
(* adds	x13, x13, x21                              #! PC = 0xaaaaaaab6b84 *)
adds carry x13 x13 x21;
(* ldp	x16, x17, [x1, #64]                         #! EA = L0xffffffffe8d8; Value = 0xa6ea96f46cb15d67; PC = 0xaaaaaaab6b88 *)
mov x16 L0xffffffffe8d8;
mov x17 L0xffffffffe8e0;
...
(* ldp	x29, x30, [x2]                              #! EA = L0xffffffffe588; Value = 0x20ca95b467143462; PC = 0xaaaaaaab6ce0 *)
mov x29 L0xffffffffe588;
mov x30 L0xffffffffe590;
(* adc	x22, x23, x22                               #! PC = 0xaaaaaaab6ce4 *)
adc x22 x23 x22 carry;
(* ldr	x23, [x2, #16]                              #! EA = L0xffffffffe598; Value = 0xcea858a401e1e74f; PC = 0xaaaaaaab6ce8 *)
...
(* ldp	x29, x30, [x2, #24]                         #! EA = L0xffffffffe5a0; Value = 0x1a2070e66ba88971; PC = 0xaaaaaaab6d84 *)
...
(* ldp	x13, x14, [x0]                              #! EA = L0xffffffffe898; Value = 0x42cc1347c72a4869; PC = 0xaaaaaaab6e28 *)
mov x13 L0xffffffffe898;
mov x14 L0xffffffffe8a0;
(* adcs	x11, x11, x22                              #! PC = 0xaaaaaaab6e2c *)
adcs carry x11 x11 x22 carry;
(* ldp	x15, x16, [x0, #16]                         #! EA = L0xffffffffe8a8; Value = 0xa0c10507221b728b; PC = 0xaaaaaaab6e30 *)
mov x15 L0xffffffffe8a8;
mov x16 L0xffffffffe8b0;
(* adc	x12, x12, x23                               #! PC = 0xaaaaaaab6e34 *)
adc x12 x12 x23 carry;
(* ldr	x17, [x0, #32]                              #! EA = L0xffffffffe8b8; Value = 0x58936217b931465f; PC = 0xaaaaaaab6e38 *)
mov x17 L0xffffffffe8b8;
(* ldp	x26, x27, [x1]                              #! EA = L0xffffffffe898; Value = 0x42cc1347c72a4869; PC = 0xaaaaaaab6e3c *)
mov x26 L0xffffffffe898;
mov x27 L0xffffffffe8a0;
(* ldp	x28, x29, [x1, #16]                         #! EA = L0xffffffffe8a8; Value = 0xa0c10507221b728b; PC = 0xaaaaaaab6e40 *)
mov x28 L0xffffffffe8a8;
mov x29 L0xffffffffe8b0;
(* ldr	x30, [x1, #32]                              #! EA = L0xffffffffe8b8; Value = 0x58936217b931465f; PC = 0xaaaaaaab6e44 *)
mov x30 L0xffffffffe8b8;
...
(* ldp	x16, x17, [x0]                              #! EA = L0xffffffffe898; Value = 0x42cc1347c72a4869; PC = 0xaaaaaaab6f34 *)
mov x16 L0xffffffffe898;
mov x17 L0xffffffffe8a0;
(* adc	x22, x23, x22                               #! PC = 0xaaaaaaab6f38 *)
adcs dontcare x22 x23 x22 carry;
(* ldr	x23, [x0, #16]                              #! EA = L0xffffffffe8a8; Value = 0xa0c10507221b728b; PC = 0xaaaaaaab6f3c *)
mov x23 L0xffffffffe8a8;
...
adc x19 x19 x25 carry;
(* ldp	x16, x17, [x0, #24]                         #! EA = L0xffffffffe8b0; Value = 0x7335d9f1fef72c0a; PC = 0xaaaaaaab6fd8 *)
mov x16 L0xffffffffe8b0;
mov x17 L0xffffffffe8b8;
...
(* ldp	x13, x14, [x2]                              #! EA = L0xffffffffe588; Value = 0xcd8d018f1607f584; PC = 0xaaaaaaab7064 *)
mov x13 L0xffffffffe588;
mov x14 L0xffffffffe590;
(* subs	x13, x13, x3                               #! PC = 0xaaaaaaab7068 *)
subc carry x13 x13 x3;
(* ldp	x15, x16, [x2, #16]                         #! EA = L0xffffffffe598; Value = 0x0e5c1db3397b6b36; PC = 0xaaaaaaab706c *)
mov x15 L0xffffffffe598;
mov x16 L0xffffffffe5a0;
(* sbcs	x14, x14, x4                               #! PC = 0xaaaaaaab7070 *)
sbcs carry x14 x14 x4 carry;
(* ldr	x17, [x2, #32]                              #! EA = L0xffffffffe5a8; Value = 0xb6497a39151d248d; PC = 0xaaaaaaab7074 *)
...
(* ldp	x3, x4, [x0, #40]                           #! EA = L0xffffffffe8c0; Value = 0xddfe826c9fe9ebf9; PC = 0xaaaaaaab7094 *)
mov x3 L0xffffffffe8c0;
mov x4 L0xffffffffe8c8;
(* sbcs	x9, x9, x20                                #! PC = 0xaaaaaaab7098 *)
sbcs carry x9 x9 x20 carry;
(* ldp	x5, x6, [x0, #56]                           #! EA = L0xffffffffe8d0; Value = 0x2de7539cdfc674c4; PC = 0xaaaaaaab709c *)
mov x5 L0xffffffffe8d0;
mov x6 L0xffffffffe8d8;
(* ldr	x7, [x0, #72]                               #! EA = L0xffffffffe8e0; Value = 0x00000000c23d1e7b; PC = 0xaaaaaaab70a0 *)
mov x7 L0xffffffffe8e0;
(* sbcs	x10, x10, x21                              #! PC = 0xaaaaaaab70a4 *)
sbcs carry x10 x10 x21 carry;
(* ldp	x26, x27, [x1, #40]                         #! EA = L0xffffffffe8c0; Value = 0xddfe826c9fe9ebf9; PC = 0xaaaaaaab70a8 *)
mov x26 L0xffffffffe8c0;
mov x27 L0xffffffffe8c8;
(* sbcs	x11, x11, x22                              #! PC = 0xaaaaaaab70ac *)
sbcs carry x11 x11 x22 carry;
(* ldp	x28, x29, [x1, #56]                         #! EA = L0xffffffffe8d0; Value = 0x2de7539cdfc674c4; PC = 0xaaaaaaab70b0 *)
mov x28 L0xffffffffe8d0;
mov x29 L0xffffffffe8d8;
(* ldr	x30, [x1, #72]                              #! EA = L0xffffffffe8e0; Value = 0x00000000c23d1e7b; PC = 0xaaaaaaab70b4 *)
mov x30 L0xffffffffe8e0;
...
(* ldp	x6, x7, [x0]                                #! EA = L0xffffffffe8c0; Value = 0xddfe826c9fe9ebf9; PC = 0xaaaaaaab71c0 *)
mov x6 L0xffffffffe8c0;
mov x7 L0xffffffffe8c8;
(* adc	x16, x17, x16                               #! PC = 0xaaaaaaab71c4 *)
adcs dontcare x16 x17 x16 carry;
(* ldr	x17, [x0, #16]                              #! EA = L0xffffffffe8d0; Value = 0x2de7539cdfc674c4; PC = 0xaaaaaaab71c8 *)
...
(* ldp	x6, x7, [x0, #24]                           #! EA = L0xffffffffe8d8; Value = 0xa6ea96f46cb15d67; PC = 0xaaaaaaab7264 *)
mov x6 L0xffffffffe8d8;
mov x7 L0xffffffffe8e0;
...
(* ldp	x7, x26, [x2, #72]                          #! EA = L0xffffffffe5d0; Value = 0x000000008669ac01; PC = 0xaaaaaaab72f0 *)
mov x7 L0xffffffffe5d0;
mov x26 L0xffffffffe5d8;
(* ldp	x27, x28, [x2, #88]                         #! EA = L0xffffffffe5e0; Value = 0xa3649ba82d7f88a9; PC = 0xaaaaaaab72f4 *)
mov x27 L0xffffffffe5e0;
mov x28 L0xffffffffe5e8;
(* subs	x26, x26, x8                               #! PC = 0xaaaaaaab72f8 *)
subc carry x26 x26 x8;
(* ldp	x29, x30, [x2, #104]                        #! EA = L0xffffffffe5f0; Value = 0x2304daa4b277698e; PC = 0xaaaaaaab72fc *)
...
(* ldp	x3, x4, [x2, #40]                           #! EA = L0xffffffffe5b0; Value = 0x2dea2ecf4586a823; PC = 0xaaaaaaab7308 *)
...
(* ldp	x5, x6, [x2, #56]                           #! EA = L0xffffffffe5c0; Value = 0x84727f91678776c8; PC = 0xaaaaaaab7314 *)
...
assert eqmod (limbs 64 [x26, x27, x28, x29, x30, x3, x4, x5, x6, x7])
             (2 * limbs 64 [a0, a1, a2, a3, a4] * limbs 64 [a5, a6, a7, a8, a9])
             (2**640) && true;
assume limbs 64 [x26, x27, x28, x29, x30, x3, x4, x5, x6, x7] =
       2 * limbs 64 [a0, a1, a2, a3, a4] * limbs 64 [a5, a6, a7, a8, a9] && true;
...
(* ldp	x19, x20, [sp]                              #! EA = L0xffffffffe500; Value = 0x0000ffffffffe8e8; PC = 0xaaaaaaab7358 *)
...
cut limbs 64 [L0xffffffffe588, L0xffffffffe590, L0xffffffffe598,
    ...
    limbs 64 [a0, a1, a2, a3, a4, a5, a6, a7, a8, a9]**2
...
(* mov	x1, x19                                     #! PC = 0xaaaaaaaae0f4 *)
mov x1 x19;
(* mov	x0, x20                                     #! PC = 0xaaaaaaaae0f8 *)
mov x0 x20;
(* #bl	0xaaaaaaab6714 <rdc_mont>                   #! PC = 0xaaaaaaaae0fc *)
#bl	0xaaaaaaab6714 <rdc_mont>                   #! 0xaaaaaaaae0fc = 0xaaaaaaaae0fc;
(* #! -> SP = 0xffffffffe560 *)
#! 0xffffffffe560 = 0xffffffffe560;
...
mov L0xffffffffe510 x21;
mov L0xffffffffe518 x22;
(* ldp	x2, x3, [x0]                                #! EA = L0xffffffffe588; Value = 0xe67e83cd14ef3b11; PC = 0xaaaaaaab73b4 *)
...
shl x6 Lx6 48;
(* ldp	x2, x3, [x0, #16]                           #! EA = L0xffffffffe598; Value = 0xbcc84813a259bf2f; PC = 0xaaaaaaab74b8 *)
...
shl x5 Lx5 48;
(* ldp	x11, x12, [x0, #32]                         #! EA = L0xffffffffe5a8; Value = 0xee0782cca72d39bf; PC = 0xaaaaaaab74c4 *)
...
shl x4 Lx4 48;
(* ldp	x13, x14, [x0, #48]                         #! EA = L0xffffffffe5b8; Value = 0xe7f71719be2c08fd; PC = 0xaaaaaaab74d0 *)
...
(* ldp	x15, x16, [x0, #64]                         #! EA = L0xffffffffe5c8; Value = 0x4f52e5772e690083; PC = 0xaaaaaaab74dc *)
...
(* ldp	x17, x24, [x0, #80]                         #! EA = L0xffffffffe5d8; Value = 0xa6894cd1f587ca5a; PC = 0xaaaaaaab74e8 *)
...
(* ldp	x19, x20, [x0, #96]                         #! EA = L0xffffffffe5e8; Value = 0x8ff6c5d74dea838e; PC = 0xaaaaaaab7928 *)
...
(* ldp	x21, x22, [x0, #112]                        #! EA = L0xffffffffe5f8; Value = 0x9ff68b7539efe0e1; PC = 0xaaaaaaab7934 *)
...
(* ldp	x23, x24, [x0, #128]                        #! EA = L0xffffffffe608; Value = 0xb9ab8e3f625ec130; PC = 0xaaaaaaab7940 *)
...
(* ldp	x4, x5, [x0, #144]                          #! EA = L0xffffffffe618; Value = 0x9360b0caf38a4f6f; PC = 0xaaaaaaab794c *)
...
(* ldp	x19, x20, [sp]                              #! EA = L0xffffffffe500; Value = 0x0000ffffffffe8e8; PC = 0xaaaaaaab796c *)
mov x19 L0xffffffffe500;
mov x20 L0xffffffffe508;
...
(* ldr	x0, [x0, #4048]                             #! EA = L0xaaaaaaacbfd0; Value = 0x0000fffff7ffd6b0; PC = 0xaaaaaaaae104 *)
mov x0 L0xaaaaaaacbfd0;
(* ldr	x1, [sp, #200]                              #! EA = L0xffffffffe628; Value = 0xc4158025f7fbcd00; PC = 0xaaaaaaaae108 *)
mov x1 L0xffffffffe628;
(* ldr	x2, [x0]                                    #! EA = L0xfffff7ffd6b0; Value = 0xc4158025f7fbcd00; PC = 0xaaaaaaaae10c *)
mov x2 L0xfffff7ffd6b0;
(* subs	x1, x1, x2                                 #! PC = 0xaaaaaaaae110 *)
subc carry x1 x1 x2;
(* mov	x2, #0x0                   	// #0           #! PC = 0xaaaaaaaae114 *)
mov x2 0x0@uint64;
(* #b.ne	0xaaaaaaaae128 <fpsqr610_mont+148>  // b.any#! PC = 0xaaaaaaaae118 *)
#b.ne	0xaaaaaaaae128 <fpsqr610_mont+148>  // b.any#! 0xaaaaaaaae118 = 0xaaaaaaaae118;
(* ldp	x19, x20, [sp, #16]                         #! EA = L0xffffffffe570; Value = 0x0000ffffffffe7a8; PC = 0xaaaaaaaae11c *)
mov x19 L0xffffffffe570;
mov x20 L0xffffffffe578;
(* ldp	x29, x30, [sp], #208                        #! EA = L0xffffffffe560; Value = 0x0000ffffffffe630; PC = 0xaaaaaaaae120 *)
mov x29 L0xffffffffe560;
mov x30 L0xffffffffe568;
(* #! <- SP = 0xffffffffe630 *)
#! 0xffffffffe630 = 0xffffffffe630;
(* #ret                                            #! PC = 0xaaaaaaaae124 *)
#ret                                            #! 0xaaaaaaaae124 = 0xaaaaaaaae124;

mov c0 L0xffffffffe8e8; mov c1 L0xffffffffe8f0; mov c2 L0xffffffffe8f8;
mov c3 L0xffffffffe900; mov c4 L0xffffffffe908; mov c5 L0xffffffffe910;
mov c6 L0xffffffffe918; mov c7 L0xffffffffe920; mov c8 L0xffffffffe928;
mov c9 L0xffffffffe930;
