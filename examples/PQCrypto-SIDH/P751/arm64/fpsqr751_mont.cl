(* quine: -v -isafety -jobs 20 -slicing -no_carry_constraint fpsqr751_mont.cl
Parsing Cryptoline file:                [OK]            0.015853 seconds
Checking well-formedness:               [OK]            0.002108 seconds
Transforming to SSA form:               [OK]            0.001310 seconds
Normalizing specification:              [OK]            0.002224 seconds
Rewriting assignments:                  [OK]            0.001580 seconds
Verifying program safety:               [OK]            22.220837 seconds
Verifying range assertions:             [OK]            3.655412 seconds
Verifying range specification:          [OK]            7.259572 seconds
Rewriting value-preserved casting:      [OK]            0.000422 seconds
Verifying algebraic assertions:         [OK]            0.001744 seconds
Verifying algebraic specification:      [OK]            0.272387 seconds
Verification result:                    [OK]            33.434839 seconds
*)
...
(* stp	x29, x30, [sp, #-240]!                      #! EA = L0xffffffffe480; PC = 0xaaaaaaaadfb0 *)
mov L0xffffffffe480 x29;
mov L0xffffffffe488 x30;
(* mov	w3, #0xc                   	// #12          #! PC = 0xaaaaaaaadfb8 *)
#mov	w3, #0xc                   	// #12          #! 0xaaaaaaaadfb8 = 0xaaaaaaaadfb8;
(* mov	x29, sp                                     #! PC = 0xaaaaaaaadfbc *)
mov x29 sp;
(* ldr	x4, [x4, #4056]                             #! EA = L0xaaaaaaacdfd8; Value = 0x0000fffff7ffd6b0; PC = 0xaaaaaaaadfc0 *)
mov x4 L0xaaaaaaacdfd8;
(* stp	x19, x20, [sp, #16]                         #! EA = L0xffffffffe490; PC = 0xaaaaaaaadfc4 *)
mov L0xffffffffe490 x19;
mov L0xffffffffe498 x20;
(* add	x20, sp, #0x28                              #! PC = 0xaaaaaaaadfc8 *)
adds dontcare x20 sp 0x28@uint64;
(* ldr	x5, [x4]                                    #! EA = L0xfffff7ffd6b0; Value = 0x27aae41a0c43f000; PC = 0xaaaaaaaadfcc *)
mov x5 L0xfffff7ffd6b0;
(* str	x5, [sp, #232]                              #! EA = L0xffffffffe568; PC = 0xaaaaaaaadfd0 *)
mov L0xffffffffe568 x5;
(* mov	x5, #0x0                   	// #0           #! PC = 0xaaaaaaaadfd4 *)
mov x5 0x0@uint64;
(* mov	x2, x20                                     #! PC = 0xaaaaaaaadfd8 *)
mov x2 x20;
(* mov	x19, x1                                     #! PC = 0xaaaaaaaadfdc *)
mov x19 x1;
(* mov	x1, x0                                      #! PC = 0xaaaaaaaadfe0 *)
mov x1 x0;
(* stp	xzr, xzr, [sp, #40]                         #! EA = L0xffffffffe4a8; PC = 0xaaaaaaaadfe4 *)
mov L0xffffffffe4a8 0@uint64;
mov L0xffffffffe4b0 0@uint64;
(* stp	xzr, xzr, [sp, #56]                         #! EA = L0xffffffffe4b8; PC = 0xaaaaaaaadfe8 *)
mov L0xffffffffe4b8 0@uint64;
mov L0xffffffffe4c0 0@uint64;
(* stp	xzr, xzr, [sp, #72]                         #! EA = L0xffffffffe4c8; PC = 0xaaaaaaaadfec *)
mov L0xffffffffe4c8 0@uint64;
mov L0xffffffffe4d0 0@uint64;
(* stp	xzr, xzr, [sp, #88]                         #! EA = L0xffffffffe4d8; PC = 0xaaaaaaaadff0 *)
mov L0xffffffffe4d8 0@uint64;
mov L0xffffffffe4e0 0@uint64;
(* stp	xzr, xzr, [sp, #104]                        #! EA = L0xffffffffe4e8; PC = 0xaaaaaaaadff4 *)
mov L0xffffffffe4e8 0@uint64;
mov L0xffffffffe4f0 0@uint64;
(* stp	xzr, xzr, [sp, #120]                        #! EA = L0xffffffffe4f8; PC = 0xaaaaaaaadff8 *)
mov L0xffffffffe4f8 0@uint64;
mov L0xffffffffe500 0@uint64;
(* stp	xzr, xzr, [sp, #136]                        #! EA = L0xffffffffe508; PC = 0xaaaaaaaadffc *)
mov L0xffffffffe508 0@uint64;
mov L0xffffffffe510 0@uint64;
(* stp	xzr, xzr, [sp, #152]                        #! EA = L0xffffffffe518; PC = 0xaaaaaaaae000 *)
mov L0xffffffffe518 0@uint64;
mov L0xffffffffe520 0@uint64;
(* stp	xzr, xzr, [sp, #168]                        #! EA = L0xffffffffe528; PC = 0xaaaaaaaae004 *)
mov L0xffffffffe528 0@uint64;
mov L0xffffffffe530 0@uint64;
(* stp	xzr, xzr, [sp, #184]                        #! EA = L0xffffffffe538; PC = 0xaaaaaaaae008 *)
mov L0xffffffffe538 0@uint64;
mov L0xffffffffe540 0@uint64;
(* stp	xzr, xzr, [sp, #200]                        #! EA = L0xffffffffe548; PC = 0xaaaaaaaae00c *)
mov L0xffffffffe548 0@uint64;
mov L0xffffffffe550 0@uint64;
(* stp	xzr, xzr, [sp, #216]                        #! EA = L0xffffffffe558; PC = 0xaaaaaaaae010 *)
mov L0xffffffffe558 0@uint64;
mov L0xffffffffe560 0@uint64;
(* #bl	0xaaaaaaab7540 <mp_mul>                     #! PC = 0xaaaaaaaae014 *)
#bl	0xaaaaaaab7540 <mp_mul>                     #! 0xaaaaaaaae014 = 0xaaaaaaaae014;
(* #! -> SP = 0xffffffffe480 *)
...
(* ldp	x3, x4, [x0]                                #! EA = L0xffffffffe838; Value = 0x7d4ba15bf6d945b7; PC = 0xaaaaaaab7a70 *)
mov x3 L0xffffffffe838;
mov x4 L0xffffffffe840;
(* ldp	x5, x6, [x0, #16]                           #! EA = L0xffffffffe848; Value = 0xfaa6e144b74ddd82; PC = 0xaaaaaaab7a74 *)
mov x5 L0xffffffffe848;
mov x6 L0xffffffffe850;
(* ldp	x7, x8, [x0, #32]                           #! EA = L0xffffffffe858; Value = 0xde9c333d3d501a8f; PC = 0xaaaaaaab7a78 *)
mov x7 L0xffffffffe858;
mov x8 L0xffffffffe860;
(* ldp	x10, x11, [x0, #48]                         #! EA = L0xffffffffe868; Value = 0x68b605a2bb6ccdba; PC = 0xaaaaaaab7a7c *)
mov x10 L0xffffffffe868;
mov x11 L0xffffffffe870;
(* ldp	x12, x13, [x0, #64]                         #! EA = L0xffffffffe878; Value = 0x805cd6da8958a135; PC = 0xaaaaaaab7a80 *)
mov x12 L0xffffffffe878;
mov x13 L0xffffffffe880;
(* ldp	x14, x15, [x0, #80]                         #! EA = L0xffffffffe888; Value = 0x245901bcab088612; PC = 0xaaaaaaab7a84 *)
...
(* ldp	x10, x11, [x1]                              #! EA = L0xffffffffe838; Value = 0x7d4ba15bf6d945b7; PC = 0xaaaaaaab7aa4 *)
mov x10 L0xffffffffe838;
mov x11 L0xffffffffe840;
(* ldp	x12, x13, [x1, #16]                         #! EA = L0xffffffffe848; Value = 0xfaa6e144b74ddd82; PC = 0xaaaaaaab7aa8 *)
mov x12 L0xffffffffe848;
mov x13 L0xffffffffe850;
(* ldp	x14, x15, [x1, #32]                         #! EA = L0xffffffffe858; Value = 0xde9c333d3d501a8f; PC = 0xaaaaaaab7aac *)
mov x14 L0xffffffffe858;
mov x15 L0xffffffffe860;
(* ldp	x17, x19, [x1, #48]                         #! EA = L0xffffffffe868; Value = 0x68b605a2bb6ccdba; PC = 0xaaaaaaab7ab0 *)
mov x17 L0xffffffffe868;
mov x19 L0xffffffffe870;
(* ldp	x20, x21, [x1, #64]                         #! EA = L0xffffffffe878; Value = 0x805cd6da8958a135; PC = 0xaaaaaaab7ab4 *)
mov x20 L0xffffffffe878;
mov x21 L0xffffffffe880;
(* ldp	x22, x23, [x1, #80]                         #! EA = L0xffffffffe888; Value = 0x245901bcab088612; PC = 0xaaaaaaab7ab8 *)
mov x22 L0xffffffffe888;
mov x23 L0xffffffffe890;
...
(* ldp	x3, x4, [x2, #64]                           #! EA = L0xffffffffe4e8; Value = 0xe601a6feb2461371; PC = 0xaaaaaaab7c4c *)
mov x3 L0xffffffffe4e8;
mov x4 L0xffffffffe4f0;
(* str	x5, [x2, #144]                              #! EA = L0xffffffffe538; PC = 0xaaaaaaab7c50 *)
mov L0xffffffffe538 x5;
(* ldr	x5, [x2, #80]                               #! EA = L0xffffffffe4f8; Value = 0x7b03b81f40a67eb8; PC = 0xaaaaaaab7c54 *)
...
(* ldp	x3, x4, [x2, #128]                          #! EA = L0xffffffffe528; Value = 0x23bc241b178f7cc9; PC = 0xaaaaaaab7cf0 *)
mov x3 L0xffffffffe528;
mov x4 L0xffffffffe530;
(* ldr	x5, [x2, #144]                              #! EA = L0xffffffffe538; Value = 0x8986893bc85d9b51; PC = 0xaaaaaaab7cf4 *)
...
(* ldp	x14, x15, [x2, #112]                        #! EA = L0xffffffffe518; Value = 0x02f534f9e858a0a1; PC = 0xaaaaaaab7d20 *)
...
(* ldp	x7, x8, [x2, #96]                           #! EA = L0xffffffffe508; Value = 0x02f534f9e858a0a1; PC = 0xaaaaaaab7d28 *)
...
(* ldp	x7, x8, [x2, #128]                          #! EA = L0xffffffffe528; Value = 0x06bf6748d387cc01; PC = 0xaaaaaaab7dbc *)
mov x7 L0xffffffffe528;
mov x8 L0xffffffffe530;
(* ldp	x14, x15, [x2, #144]                        #! EA = L0xffffffffe538; Value = 0x56d65594d4d853ff; PC = 0xaaaaaaab7dc0 *)
...
adc x9 x9 0@uint64 carry;
(* ldp	x3, x4, [x0]                                #! EA = L0xffffffffe838; Value = 0x7d4ba15bf6d945b7; PC = 0xaaaaaaab7e2c *)
mov x3 L0xffffffffe838;
mov x4 L0xffffffffe840;
(* ldp	x5, x6, [x0, #16]                           #! EA = L0xffffffffe848; Value = 0xfaa6e144b74ddd82; PC = 0xaaaaaaab7e30 *)
mov x5 L0xffffffffe848;
mov x6 L0xffffffffe850;
(* ldp	x7, x8, [x0, #32]                           #! EA = L0xffffffffe858; Value = 0xde9c333d3d501a8f; PC = 0xaaaaaaab7e34 *)
mov x7 L0xffffffffe858;
mov x8 L0xffffffffe860;
(* ldp	x10, x11, [x1]                              #! EA = L0xffffffffe838; Value = 0x7d4ba15bf6d945b7; PC = 0xaaaaaaab7e38 *)
mov x10 L0xffffffffe838;
mov x11 L0xffffffffe840;
(* ldp	x12, x13, [x1, #16]                         #! EA = L0xffffffffe848; Value = 0xfaa6e144b74ddd82; PC = 0xaaaaaaab7e3c *)
mov x12 L0xffffffffe848;
mov x13 L0xffffffffe850;
(* ldp	x14, x15, [x1, #32]                         #! EA = L0xffffffffe858; Value = 0xde9c333d3d501a8f; PC = 0xaaaaaaab7e40 *)
mov x14 L0xffffffffe858;
mov x15 L0xffffffffe860;
...
(* ldp	x3, x4, [x0]                                #! EA = L0xffffffffe838; Value = 0x7d4ba15bf6d945b7; PC = 0xaaaaaaab7f5c *)
mov x3 L0xffffffffe838;
mov x4 L0xffffffffe840;
(* str	x5, [x2, #176]                              #! EA = L0xffffffffe558; PC = 0xaaaaaaab7f60 *)
mov L0xffffffffe558 x5;
(* ldr	x5, [x0, #16]                               #! EA = L0xffffffffe848; Value = 0xfaa6e144b74ddd82; PC = 0xaaaaaaab7f64 *)
mov x5 L0xffffffffe848;
...
adc x15 x15 x30 carry;
(* ldp	x3, x4, [x2, #160]                          #! EA = L0xffffffffe548; Value = 0xe3d7ed3c410f33e9; PC = 0xaaaaaaab8000 *)
mov x3 L0xffffffffe548;
mov x4 L0xffffffffe550;
(* ldr	x5, [x2, #176]                              #! EA = L0xffffffffe558; Value = 0xd8e2bdddd3ae52f5; PC = 0xaaaaaaab8004 *)
...
(* ldp	x14, x15, [x1, #32]                         #! EA = L0xffffffffe858; Value = 0xde9c333d3d501a8f; PC = 0xaaaaaaab8030 *)
mov x14 L0xffffffffe858;
mov x15 L0xffffffffe860;
(* stp	x7, x8, [x2, #160]                          #! EA = L0xffffffffe548; PC = 0xaaaaaaab8034 *)
mov L0xffffffffe548 x7;
mov L0xffffffffe550 x8;
(* ldp	x7, x8, [x0, #32]                           #! EA = L0xffffffffe858; Value = 0xde9c333d3d501a8f; PC = 0xaaaaaaab8038 *)
mov x7 L0xffffffffe858;
mov x8 L0xffffffffe860;
...
adc x28 x28 x30 carry;
(* ldp	x7, x8, [x2, #160]                          #! EA = L0xffffffffe548; Value = 0x0d8eb144f3eaf510; PC = 0xaaaaaaab80cc *)
mov x7 L0xffffffffe548;
mov x8 L0xffffffffe550;
(* ldp	x14, x15, [x2, #176]                        #! EA = L0xffffffffe558; Value = 0xa4276cc13b00e6d0; PC = 0xaaaaaaab80d0 *)
...
(* ldp	x3, x4, [x2]                                #! EA = L0xffffffffe4a8; Value = 0x534ca673c745f7e1; PC = 0xaaaaaaab8114 *)
mov x3 L0xffffffffe4a8;
mov x4 L0xffffffffe4b0;
(* ldp	x5, x6, [x2, #16]                           #! EA = L0xffffffffe4b8; Value = 0x716ba1fe7e51b9b0; PC = 0xaaaaaaab8118 *)
mov x5 L0xffffffffe4b8;
mov x6 L0xffffffffe4c0;
(* ldp	x7, x8, [x2, #32]                           #! EA = L0xffffffffe4c8; Value = 0x6094c91722c691f5; PC = 0xaaaaaaab811c *)
mov x7 L0xffffffffe4c8;
mov x8 L0xffffffffe4d0;
(* ldp	x10, x11, [x2, #48]                         #! EA = L0xffffffffe4d8; Value = 0x78291a7024b36fed; PC = 0xaaaaaaab8120 *)
mov x10 L0xffffffffe4d8;
mov x11 L0xffffffffe4e0;
(* ldp	x12, x13, [x2, #64]                         #! EA = L0xffffffffe4e8; Value = 0x81c70a87ae2817af; PC = 0xaaaaaaab8124 *)
mov x12 L0xffffffffe4e8;
mov x13 L0xffffffffe4f0;
(* ldp	x14, x15, [x2, #80]                         #! EA = L0xffffffffe4f8; Value = 0x976165f063ac2a39; PC = 0xaaaaaaab8128 *)
...
(* ldp	x3, x4, [x0, #48]                           #! EA = L0xffffffffe868; Value = 0x68b605a2bb6ccdba; PC = 0xaaaaaaab81a8 *)
mov x3 L0xffffffffe868;
mov x4 L0xffffffffe870;
(* ldp	x5, x6, [x0, #64]                           #! EA = L0xffffffffe878; Value = 0x805cd6da8958a135; PC = 0xaaaaaaab81ac *)
mov x5 L0xffffffffe878;
mov x6 L0xffffffffe880;
(* ldp	x7, x8, [x0, #80]                           #! EA = L0xffffffffe888; Value = 0x245901bcab088612; PC = 0xaaaaaaab81b0 *)
mov x7 L0xffffffffe888;
mov x8 L0xffffffffe890;
(* ldp	x10, x11, [x1, #48]                         #! EA = L0xffffffffe868; Value = 0x68b605a2bb6ccdba; PC = 0xaaaaaaab81b4 *)
mov x10 L0xffffffffe868;
mov x11 L0xffffffffe870;
(* ldp	x12, x13, [x1, #64]                         #! EA = L0xffffffffe878; Value = 0x805cd6da8958a135; PC = 0xaaaaaaab81b8 *)
mov x12 L0xffffffffe878;
mov x13 L0xffffffffe880;
(* ldp	x14, x15, [x1, #80]                         #! EA = L0xffffffffe888; Value = 0x245901bcab088612; PC = 0xaaaaaaab81bc *)
mov x14 L0xffffffffe888;
mov x15 L0xffffffffe890;
...
mov L0xffffffffe548 x3;
mov L0xffffffffe550 x4;
(* ldp	x3, x4, [x0]                                #! EA = L0xffffffffe868; Value = 0x68b605a2bb6ccdba; PC = 0xaaaaaaab82c8 *)
mov x3 L0xffffffffe868;
mov x4 L0xffffffffe870;
(* str	x5, [x2, #176]                              #! EA = L0xffffffffe558; PC = 0xaaaaaaab82cc *)
mov L0xffffffffe558 x5;
(* ldr	x5, [x0, #16]                               #! EA = L0xffffffffe878; Value = 0x805cd6da8958a135; PC = 0xaaaaaaab82d0 *)
mov x5 L0xffffffffe878;
...
adc x15 x15 x30 carry;
(* ldp	x3, x4, [x2, #160]                          #! EA = L0xffffffffe548; Value = 0x00e3a243ef493c79; PC = 0xaaaaaaab836c *)
mov x3 L0xffffffffe548;
mov x4 L0xffffffffe550;
(* ldr	x5, [x2, #176]                              #! EA = L0xffffffffe558; Value = 0x21e6fdb4749897ab; PC = 0xaaaaaaab8370 *)
mov x5 L0xffffffffe558;
...
mov L0xffffffffe558 x14;
mov L0xffffffffe560 x15;
(* ldp	x14, x15, [x1, #32]                         #! EA = L0xffffffffe888; Value = 0x245901bcab088612; PC = 0xaaaaaaab839c *)
mov x14 L0xffffffffe888;
mov x15 L0xffffffffe890;
(* stp	x7, x8, [x2, #160]                          #! EA = L0xffffffffe548; PC = 0xaaaaaaab83a0 *)
mov L0xffffffffe548 x7;
mov L0xffffffffe550 x8;
(* ldp	x7, x8, [x0, #32]                           #! EA = L0xffffffffe888; Value = 0x245901bcab088612; PC = 0xaaaaaaab83a4 *)
mov x7 L0xffffffffe888;
mov x8 L0xffffffffe890;
...
adc x28 x28 x30 carry;
(* ldp	x7, x8, [x2, #160]                          #! EA = L0xffffffffe548; Value = 0x00004d73069f653d; PC = 0xaaaaaaab8438 *)
mov x7 L0xffffffffe548;
mov x8 L0xffffffffe550;
(* ldp	x14, x15, [x2, #176]                        #! EA = L0xffffffffe558; Value = 0x8760fcb40c87bcb4; PC = 0xaaaaaaab843c *)
mov x14 L0xffffffffe558;
mov x15 L0xffffffffe560;
...
(* ldp	x3, x4, [x2, #48]                           #! EA = L0xffffffffe4d8; Value = 0x3b825791271206ae; PC = 0xaaaaaaab8480 *)
mov x3 L0xffffffffe4d8;
mov x4 L0xffffffffe4e0;
(* ldp	x5, x6, [x2, #64]                           #! EA = L0xffffffffe4e8; Value = 0xcf1009a440904019; PC = 0xaaaaaaab8484 *)
mov x5 L0xffffffffe4e8;
mov x6 L0xffffffffe4f0;
(* ldp	x7, x8, [x2, #80]                           #! EA = L0xffffffffe4f8; Value = 0x3f1302662ea11fe0; PC = 0xaaaaaaab8488 *)
mov x7 L0xffffffffe4f8;
mov x8 L0xffffffffe500;
(* ldp	x10, x11, [x2, #96]                         #! EA = L0xffffffffe508; Value = 0x4a8b60d5cdad384f; PC = 0xaaaaaaab848c *)
mov x10 L0xffffffffe508;
mov x11 L0xffffffffe510;
(* ldp	x12, x13, [x2, #112]                        #! EA = L0xffffffffe518; Value = 0xa7a1eb43dad5e87a; PC = 0xaaaaaaab8490 *)
mov x12 L0xffffffffe518;
mov x13 L0xffffffffe520;
(* ldp	x14, x15, [x2, #128]                        #! EA = L0xffffffffe528; Value = 0x3518db4a43a01e13; PC = 0xaaaaaaab8494 *)
...
(* ldp	x19, x20, [sp]                              #! EA = L0xffffffffe420; Value = 0x0000ffffffffe898; PC = 0xaaaaaaab8528 *)
...
(* mov	x1, x19                                     #! PC = 0xaaaaaaaae018 *)
mov x1 x19;
(* mov	x0, x20                                     #! PC = 0xaaaaaaaae01c *)
mov x0 x20;
(* #bl	0xaaaaaaab7544 <rdc_mont>                   #! PC = 0xaaaaaaaae020 *)
#bl	0xaaaaaaab7544 <rdc_mont>                   #! 0xaaaaaaaae020 = 0xaaaaaaaae020;
(* #! -> SP = 0xffffffffe480 *)
#! 0xffffffffe480 = 0xffffffffe480;
...
mov L0xffffffffe470 x29;
mov L0xffffffffe478 x30;
(* ldp	x2, x3, [x0]                                #! EA = L0xffffffffe4a8; Value = 0x4568087cf73a28d1; PC = 0xaaaaaaab8564 *)
mov x2 L0xffffffffe4a8;
mov x3 L0xffffffffe4b0;
(* ldp	x4, x5, [x0, #16]                           #! EA = L0xffffffffe4b8; Value = 0x7c80b79e1113a8cb; PC = 0xaaaaaaab8568 *)
...
adc x15 x15 x30 carry;
(* ldp	x2, x3, [x0, #32]                           #! EA = L0xffffffffe4c8; Value = 0x83ca515714317e3a; PC = 0xaaaaaaab8748 *)
mov x2 L0xffffffffe4c8;
mov x3 L0xffffffffe4d0;
(* ldp	x4, x5, [x0, #48]                           #! EA = L0xffffffffe4d8; Value = 0x9814915d30ce9b8a; PC = 0xaaaaaaab874c *)
mov x4 L0xffffffffe4d8;
mov x5 L0xffffffffe4e0;
(* ldp	x16, x17, [x0, #64]                         #! EA = L0xffffffffe4e8; Value = 0xf36a5228fce06e6e; PC = 0xaaaaaaab8750 *)
...
(* ldp	x6, x7, [x0, #80]                           #! EA = L0xffffffffe4f8; Value = 0xadc8be2d48c4c7d7; PC = 0xaaaaaaab87ac *)
...
(* ldp	x8, x9, [x0, #96]                           #! EA = L0xffffffffe508; Value = 0x4c9b4d282322c988; PC = 0xaaaaaaab87b8 *)
...
(* ldp	x6, x7, [x0, #112]                          #! EA = L0xffffffffe518; Value = 0x7388d31c94c7d40b; PC = 0xaaaaaaab87c8 *)
...
shl x6 Lx6 47;
(* ldp	x2, x3, [x0]                                #! EA = L0xffffffffe4a8; Value = 0x0d8a88dbc33c93e8; PC = 0xaaaaaaab89fc *)
mov x2 L0xffffffffe4a8;
mov x3 L0xffffffffe4b0;
(* ldp	x4, x5, [x0, #128]                          #! EA = L0xffffffffe528; Value = 0xb91d26a4cb37d549; PC = 0xaaaaaaab8a00 *)
...
(* ldp	x6, x7, [x0, #144]                          #! EA = L0xffffffffe538; Value = 0xa15dd9e1a0cdd9eb; PC = 0xaaaaaaab8a14 *)
...
shl x6 Lx6 47;
(* ldp	x16, x17, [x0]                              #! EA = L0xffffffffe4a8; Value = 0xe01a3e846b0858fa; PC = 0xaaaaaaab8c54 *)
...
adcs carry x16 x16 x9 carry;
(* ldp	x6, x7, [x0, #160]                          #! EA = L0xffffffffe548; Value = 0x0fbecfa289bde619; PC = 0xaaaaaaab8c68 *)
mov x6 L0xffffffffe548;
mov x7 L0xffffffffe550;
(* ldp	x8, x9, [x0, #176]                          #! EA = L0xffffffffe558; Value = 0x0d45f8de5e44a0d2; PC = 0xaaaaaaab8c6c *)
...
(* ldp	x19, x20, [sp]                              #! EA = L0xffffffffe420; Value = 0x0000ffffffffe898; PC = 0xaaaaaaab8ccc *)
mov x19 L0xffffffffe420;
mov x20 L0xffffffffe428;
...
(* ldr	x0, [x0, #4056]                             #! EA = L0xaaaaaaacdfd8; Value = 0x0000fffff7ffd6b0; PC = 0xaaaaaaaae028 *)
mov x0 L0xaaaaaaacdfd8;
(* ldr	x1, [sp, #232]                              #! EA = L0xffffffffe568; Value = 0x27aae41a0c43f000; PC = 0xaaaaaaaae02c *)
mov x1 L0xffffffffe568;
(* ldr	x2, [x0]                                    #! EA = L0xfffff7ffd6b0; Value = 0x27aae41a0c43f000; PC = 0xaaaaaaaae030 *)
mov x2 L0xfffff7ffd6b0;
(* subs	x1, x1, x2                                 #! PC = 0xaaaaaaaae034 *)
subc carry x1 x1 x2;
(* mov	x2, #0x0                   	// #0           #! PC = 0xaaaaaaaae038 *)
mov x2 0x0@uint64;
(* #b.ne	0xaaaaaaaae04c <fpsqr751_mont+156>  // b.any#! PC = 0xaaaaaaaae03c *)
#b.ne	0xaaaaaaaae04c <fpsqr751_mont+156>  // b.any#! 0xaaaaaaaae03c = 0xaaaaaaaae03c;
(* ldp	x19, x20, [sp, #16]                         #! EA = L0xffffffffe490; Value = 0x0000ffffffffe718; PC = 0xaaaaaaaae040 *)
mov x19 L0xffffffffe490;
mov x20 L0xffffffffe498;
(* ldp	x29, x30, [sp], #240                        #! EA = L0xffffffffe480; Value = 0x0000ffffffffe570; PC = 0xaaaaaaaae044 *)
mov x29 L0xffffffffe480;
mov x30 L0xffffffffe488;
(* #! <- SP = 0xffffffffe570 *)
#! 0xffffffffe570 = 0xffffffffe570;
(* #ret                                            #! PC = 0xaaaaaaaae048 *)
#ret                                            #! 0xaaaaaaaae048 = 0xaaaaaaaae048;

mov c0 L0xffffffffe898; mov c1 L0xffffffffe8a0; mov c2 L0xffffffffe8a8; 
mov c3 L0xffffffffe8b0; mov c4 L0xffffffffe8b8; mov c5 L0xffffffffe8c0; 
mov c6 L0xffffffffe8c8; mov c7 L0xffffffffe8d0; mov c8 L0xffffffffe8d8; 
