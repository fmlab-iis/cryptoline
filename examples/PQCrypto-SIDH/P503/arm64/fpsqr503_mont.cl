...
(* stp	x29, x30, [sp, #-176]!                      #! EA = L0xffffffffe640; PC = 0xaaaaaaaadf20 *)
mov L0xffffffffe640 x29;
mov L0xffffffffe648 x30;
(* mov	w3, #0x8                   	// #8           #! PC = 0xaaaaaaaadf28 *)
mov w3 0x8@uint64;
(* mov	x29, sp                                     #! PC = 0xaaaaaaaadf2c *)
mov x29 sp;
(* ldr	x4, [x4, #4056]                             #! EA = L0xaaaaaaacafd8; Value = 0x0000fffff7ffd6b0; PC = 0xaaaaaaaadf30 *)
mov x4 L0xaaaaaaacafd8;
(* stp	x19, x20, [sp, #16]                         #! EA = L0xffffffffe650; PC = 0xaaaaaaaadf34 *)
mov L0xffffffffe650 x19;
mov L0xffffffffe658 x20;
(* add	x20, sp, #0x28                              #! PC = 0xaaaaaaaadf38 *)
adds dontcare x20 sp 0x28@uint64;
(* ldr	x5, [x4]                                    #! EA = L0xfffff7ffd6b0; Value = 0xf9b963213cfe6c00; PC = 0xaaaaaaaadf3c *)
mov x5 L0xfffff7ffd6b0;
(* str	x5, [sp, #168]                              #! EA = L0xffffffffe6e8; PC = 0xaaaaaaaadf40 *)
mov L0xffffffffe6e8 x5;
(* mov	x5, #0x0                   	// #0           #! PC = 0xaaaaaaaadf44 *)
mov x5 0x0@uint64;
(* mov	x2, x20                                     #! PC = 0xaaaaaaaadf48 *)
mov x2 x20;
(* mov	x19, x1                                     #! PC = 0xaaaaaaaadf4c *)
mov x19 x1;
(* mov	x1, x0                                      #! PC = 0xaaaaaaaadf50 *)
mov x1 x0;
(* stp	xzr, xzr, [sp, #40]                         #! EA = L0xffffffffe668; PC = 0xaaaaaaaadf54 *)
mov L0xffffffffe668 0@uint64;
mov L0xffffffffe670 0@uint64;
(* stp	xzr, xzr, [sp, #56]                         #! EA = L0xffffffffe678; PC = 0xaaaaaaaadf58 *)
mov L0xffffffffe678 0@uint64;
mov L0xffffffffe680 0@uint64;
(* stp	xzr, xzr, [sp, #72]                         #! EA = L0xffffffffe688; PC = 0xaaaaaaaadf5c *)
mov L0xffffffffe688 0@uint64;
mov L0xffffffffe690 0@uint64;
(* stp	xzr, xzr, [sp, #88]                         #! EA = L0xffffffffe698; PC = 0xaaaaaaaadf60 *)
mov L0xffffffffe698 0@uint64;
mov L0xffffffffe6a0 0@uint64;
(* stp	xzr, xzr, [sp, #104]                        #! EA = L0xffffffffe6a8; PC = 0xaaaaaaaadf64 *)
mov L0xffffffffe6a8 0@uint64;
mov L0xffffffffe6b0 0@uint64;
(* stp	xzr, xzr, [sp, #120]                        #! EA = L0xffffffffe6b8; PC = 0xaaaaaaaadf68 *)
mov L0xffffffffe6b8 0@uint64;
mov L0xffffffffe6c0 0@uint64;
(* stp	xzr, xzr, [sp, #136]                        #! EA = L0xffffffffe6c8; PC = 0xaaaaaaaadf6c *)
mov L0xffffffffe6c8 0@uint64;
mov L0xffffffffe6d0 0@uint64;
(* stp	xzr, xzr, [sp, #152]                        #! EA = L0xffffffffe6d8; PC = 0xaaaaaaaadf70 *)
mov L0xffffffffe6d8 0@uint64;
mov L0xffffffffe6e0 0@uint64;
(* #bl	0xaaaaaaab5ba0 <mp_mul>                     #! PC = 0xaaaaaaaadf74 *)
#bl	0xaaaaaaab5ba0 <mp_mul>                     #! 0xaaaaaaaadf74 = 0xaaaaaaaadf74;
(* #! -> SP = 0xffffffffe640 *)
...
(* ldp	x3, x4, [x0]                                #! EA = L0xffffffffe8f8; Value = 0x75eb12877eec537b; PC = 0xaaaaaaab5f0c *)
mov x3 L0xffffffffe8f8;
mov x4 L0xffffffffe900;
(* ldp	x5, x6, [x0, #16]                           #! EA = L0xffffffffe908; Value = 0xc083d2c69a3e0ca3; PC = 0xaaaaaaab5f10 *)
mov x5 L0xffffffffe908;
mov x6 L0xffffffffe910;
(* ldp	x7, x8, [x0, #32]                           #! EA = L0xffffffffe918; Value = 0x287f88f8ee966e6d; PC = 0xaaaaaaab5f14 *)
mov x7 L0xffffffffe918;
mov x8 L0xffffffffe920;
(* ldp	x9, x10, [x0, #48]                          #! EA = L0xffffffffe928; Value = 0xac24d6102ba2b7d9; PC = 0xaaaaaaab5f18 *)
...
(* ldp	x11, x12, [x1]                              #! EA = L0xffffffffe8f8; Value = 0x75eb12877eec537b; PC = 0xaaaaaaab5f2c *)
mov x11 L0xffffffffe8f8;
mov x12 L0xffffffffe900;
(* adcs	x27, x4, x8                                #! PC = 0xaaaaaaab5f30 *)
adcs carry x27 x4 x8 carry;
(* ldp	x13, x14, [x1, #16]                         #! EA = L0xffffffffe908; Value = 0xc083d2c69a3e0ca3; PC = 0xaaaaaaab5f34 *)
mov x13 L0xffffffffe908;
mov x14 L0xffffffffe910;
(* adcs	x28, x5, x9                                #! PC = 0xaaaaaaab5f38 *)
adcs carry x28 x5 x9 carry;
(* ldp	x15, x16, [x1, #32]                         #! EA = L0xffffffffe918; Value = 0x287f88f8ee966e6d; PC = 0xaaaaaaab5f3c *)
mov x15 L0xffffffffe918;
mov x16 L0xffffffffe920;
(* adcs	x29, x6, x10                               #! PC = 0xaaaaaaab5f40 *)
adcs carry x29 x6 x10 carry;
(* ldp	x17, x18, [x1, #48]                         #! EA = L0xffffffffe928; Value = 0xac24d6102ba2b7d9; PC = 0xaaaaaaab5f44 *)
mov x17 L0xffffffffe928;
mov x18 L0xffffffffe930;
...
(* ldp	x26, x27, [x2]                              #! EA = L0xffffffffe668; Value = 0x9e6a9b806d82c1e8; PC = 0xaaaaaaab6024 *)
...
(* ldp	x11, x12, [x1]                              #! EA = L0xffffffffe8f8; Value = 0x75eb12877eec537b; PC = 0xaaaaaaab60f0 *)
mov x11 L0xffffffffe8f8;
mov x12 L0xffffffffe900;
...
(* ldp	x13, x14, [x1, #16]                         #! EA = L0xffffffffe908; Value = 0xc083d2c69a3e0ca3; PC = 0xaaaaaaab60fc *)
mov x13 L0xffffffffe908;
mov x14 L0xffffffffe910;
...
assert eqmod limbs 64 [x8, x9, x10, x19, x15, x16, x17, x18]
             (limbs 64 [a0, a1, a2, a3] + limbs 64 [a4, a5, a6, a7])**2
             2**512 && true;
...
(* ldp	x3, x4, [x0]                                #! EA = L0xffffffffe8f8; Value = 0x75eb12877eec537b; PC = 0xaaaaaaab6180 *)
mov x3 L0xffffffffe8f8;
mov x4 L0xffffffffe900;
...
(* ldp	x3, x4, [x0, #32]                           #! EA = L0xffffffffe918; Value = 0x287f88f8ee966e6d; PC = 0xaaaaaaab624c *)
mov x3 L0xffffffffe918;
mov x4 L0xffffffffe920;
(* sbcs	x9, x9, x21                                #! PC = 0xaaaaaaab6250 *)
sbcs carry x9 x9 x21 carry;
(* ldp	x5, x6, [x0, #48]                           #! EA = L0xffffffffe928; Value = 0xac24d6102ba2b7d9; PC = 0xaaaaaaab6254 *)
mov x5 L0xffffffffe928;
mov x6 L0xffffffffe930;
(* sbcs	x10, x10, x22                              #! PC = 0xaaaaaaab6258 *)
sbcs carry x10 x10 x22 carry;
(* ldp	x11, x12, [x1, #32]                         #! EA = L0xffffffffe918; Value = 0x287f88f8ee966e6d; PC = 0xaaaaaaab625c *)
mov x11 L0xffffffffe918;
mov x12 L0xffffffffe920;
(* sbcs	x19, x19, x23                              #! PC = 0xaaaaaaab6260 *)
sbcs carry x19 x19 x23 carry;
(* ldp	x13, x14, [x1, #48]                         #! EA = L0xffffffffe928; Value = 0xac24d6102ba2b7d9; PC = 0xaaaaaaab6264 *)
mov x13 L0xffffffffe928;
mov x14 L0xffffffffe930;
...
adc x25 x25 x29 carry;
(* ldp	x3, x4, [x0]                                #! EA = L0xffffffffe918; Value = 0x287f88f8ee966e6d; PC = 0xaaaaaaab6304 *)
mov x3 L0xffffffffe918;
mov x4 L0xffffffffe920;
...
sbcs carry x9 x9 x21 carry;
(* ldp	x3, x4, [x2, #32]                           #! EA = L0xffffffffe688; Value = 0x4c52aac33d7c3690; PC = 0xaaaaaaab63d4 *)
...
(* ldp	x19, x20, [sp]                              #! EA = L0xffffffffe5e0; Value = 0x0000ffffffffe938; PC = 0xaaaaaaab6410 *)
...
cut and [m0=0xFFFFFFFFFFFFFFFF, m1=0xFFFFFFFFFFFFFFFF,
         ...
         limbs 64 [L0xffffffffe668, L0xffffffffe670, L0xffffffffe678,
                   ...
                   L0xffffffffe6e0] =
         limbs 64 [a0, a1, a2, a3, a4, a5, a6, a7]**2]
...
(* mov	x1, x19                                     #! PC = 0xaaaaaaaadf78 *)
mov x1 x19;
(* mov	x0, x20                                     #! PC = 0xaaaaaaaadf7c *)
mov x0 x20;
(* #bl	0xaaaaaaab5ba4 <rdc_mont>                   #! PC = 0xaaaaaaaadf80 *)
#bl	0xaaaaaaab5ba4 <rdc_mont>                   #! 0xaaaaaaaadf80 = 0xaaaaaaaadf80;
(* #! -> SP = 0xffffffffe640 *)
#! 0xffffffffe640 = 0xffffffffe640;
...
mov L0xffffffffe610 x25;
mov L0xffffffffe618 x26;
(* ldp	x2, x3, [x0]                                #! EA = L0xffffffffe668; Value = 0x09bcd4111a00fd19; PC = 0xaaaaaaab6464 *)
...
(* ldp	x16, x17, [x0, #64]                         #! EA = L0xffffffffe6a8; Value = 0xdd0b7af29bcc649a; PC = 0xaaaaaaab6558 *)
...
(* ldp	x18, x19, [x0, #80]                         #! EA = L0xffffffffe6b8; Value = 0xdbfed1890e801dba; PC = 0xaaaaaaab6564 *)
...
(* ldp	x20, x21, [x0, #96]                         #! EA = L0xffffffffe6c8; Value = 0x203d696d66b8a683; PC = 0xaaaaaaab657c *)
...
(* ldp	x22, x23, [x0, #112]                        #! EA = L0xffffffffe6d8; Value = 0x7617fd9f877d7d72; PC = 0xaaaaaaab6588 *)
...
(* ldp	x19, x20, [sp]                              #! EA = L0xffffffffe5e0; Value = 0x0000ffffffffe938; PC = 0xaaaaaaab6844 *)
mov x19 L0xffffffffe5e0;
mov x20 L0xffffffffe5e8;
...
(* ldr	x0, [x0, #4056]                             #! EA = L0xaaaaaaacafd8; Value = 0x0000fffff7ffd6b0; PC = 0xaaaaaaaadf88 *)
mov x0 L0xaaaaaaacafd8;
(* ldr	x1, [sp, #168]                              #! EA = L0xffffffffe6e8; Value = 0xf9b963213cfe6c00; PC = 0xaaaaaaaadf8c *)
mov x1 L0xffffffffe6e8;
(* ldr	x2, [x0]                                    #! EA = L0xfffff7ffd6b0; Value = 0xf9b963213cfe6c00; PC = 0xaaaaaaaadf90 *)
mov x2 L0xfffff7ffd6b0;
(* subs	x1, x1, x2                                 #! PC = 0xaaaaaaaadf94 *)
subc carry x1 x1 x2;
(* mov	x2, #0x0                   	// #0           #! PC = 0xaaaaaaaadf98 *)
mov x2 0x0@uint64;
(* #b.ne	0xaaaaaaaadfac <fpsqr503_mont+140>  // b.any#! PC = 0xaaaaaaaadf9c *)
#b.ne	0xaaaaaaaadfac <fpsqr503_mont+140>  // b.any#! 0xaaaaaaaadf9c = 0xaaaaaaaadf9c;
(* ldp	x19, x20, [sp, #16]                         #! EA = L0xffffffffe650; Value = 0x0000ffffffffe838; PC = 0xaaaaaaaadfa0 *)
mov x19 L0xffffffffe650;
mov x20 L0xffffffffe658;
(* ldp	x29, x30, [sp], #176                        #! EA = L0xffffffffe640; Value = 0x0000ffffffffe6f0; PC = 0xaaaaaaaadfa4 *)
mov x29 L0xffffffffe640;
mov x30 L0xffffffffe648;
(* #! <- SP = 0xffffffffe6f0 *)
#! 0xffffffffe6f0 = 0xffffffffe6f0;
(* #ret                                            #! PC = 0xaaaaaaaadfa8 *)
#ret                                            #! 0xaaaaaaaadfa8 = 0xaaaaaaaadfa8;

mov c0 L0xffffffffe938;
mov c1 L0xffffffffe940;
mov c2 L0xffffffffe948;
mov c3 L0xffffffffe950;
mov c4 L0xffffffffe958;
mov c5 L0xffffffffe960;
mov c6 L0xffffffffe968;
mov c7 L0xffffffffe970;
