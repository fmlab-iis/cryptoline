(* on frege: -v -isafety -isafety_timeout 14400 -jobs 24 -slicing -no_carry_constraint fpsqr503_mont.cl
Parsing Cryptoline file:		[OK]		0.009842 seconds
Checking well-formedness:		[OK]		0.000985 seconds
Transforming to SSA form:		[OK]		0.000266 seconds
Normalizing specification:		[OK]		0.000437 seconds
Rewriting assignments:			[OK]		0.000443 seconds
Verifying program safety:
	 Cut 0
	     Round 1 (0 safety conditions, timeout = 14400 seconds)
	 Overall			[OK]		0.000110 seconds
Verifying range assertions:		[OK]		5.791827 seconds
Verifying range specification:		[OK]		4.850621 seconds
Rewriting value-preserved casting:	[OK]		0.000118 seconds
Verifying algebraic assertions:		[OK]		0.000939 seconds
Verifying algebraic specification:	[OK]		0.137577 seconds
Verification result:			[OK]		10.793883 seconds
*)
...
(* mov    %rsi,%rdx                                #! PC = 0x5555555582f4 *)
mov rdx rsi;
(* mov    %rdi,%rsi                                #! PC = 0x5555555582f7 *)
mov rsi rdi;
(* #jmpq   0x555555562570 <fpmul503>               #! PC = 0x5555555582fa *)
#jmpq   0x555555562570 <fpmul503>               #! 0x5555555582fa = 0x5555555582fa;
...
mov rcx rdx;
(* mov    (%rsi),%rdx                              #! EA = L0x7fffffffde20; Value = 0x75eb12877eec537b; PC = 0x5555555655ca *)
mov rdx L0x7fffffffde20;
(* mulx   (%rdi),%r8,%r9                           #! EA = L0x7fffffffde20; Value = 0x75eb12877eec537b; PC = 0x5555555655cd *)
mull r9 r8 L0x7fffffffde20 rdx;
(* xor    %rax,%rax                                #! PC = 0x5555555655d4 *)
mov rax 0@uint64;
clear carry;
clear overflow;
(* mulx   0x8(%rdi),%r11,%r10                      #! EA = L0x7fffffffde28; Value = 0x8ba3742688c9971c; PC = 0x5555555655d7 *)
mull r10 r11 L0x7fffffffde28 rdx;
(* adox   %r11,%r9                                 #! PC = 0x5555555655df *)
adcs overflow r9 r9 r11 overflow;
(* mulx   0x10(%rdi),%r12,%r11                     #! EA = L0x7fffffffde30; Value = 0xc083d2c69a3e0ca3; PC = 0x5555555655e5 *)
mull r11 r12 L0x7fffffffde30 rdx;
(* adox   %r12,%r10                                #! PC = 0x5555555655ed *)
adcs overflow r10 r10 r12 overflow;
(* mulx   0x18(%rdi),%r13,%r12                     #! EA = L0x7fffffffde38; Value = 0xf2c7776a18f3f36c; PC = 0x5555555655f3 *)
mull r12 r13 L0x7fffffffde38 rdx;
(* adox   %r13,%r11                                #! PC = 0x5555555655fb *)
adcs overflow r11 r11 r13 overflow;
(* mulx   0x20(%rdi),%r14,%r13                     #! EA = L0x7fffffffde40; Value = 0x287f88f8ee966e6d; PC = 0x555555565601 *)
mull r13 r14 L0x7fffffffde40 rdx;
(* adox   %r14,%r12                                #! PC = 0x555555565608 *)
adcs overflow r12 r12 r14 overflow;
(* mulx   0x28(%rdi),%r15,%r14                     #! EA = L0x7fffffffde48; Value = 0x8f4685cc9fafa48f; PC = 0x55555556560e *)
mull r14 r15 L0x7fffffffde48 rdx;
(* adox   %r15,%r13                                #! PC = 0x555555565615 *)
adcs overflow r13 r13 r15 overflow;
(* mulx   0x30(%rdi),%rbx,%r15                     #! EA = L0x7fffffffde50; Value = 0xac24d6102ba2b7d9; PC = 0x55555556561b *)
mull r15 rbx L0x7fffffffde50 rdx;
(* adox   %rbx,%r14                                #! PC = 0x555555565621 *)
adcs overflow r14 r14 rbx overflow;
(* mulx   0x38(%rdi),%rbp,%rbx                     #! EA = L0x7fffffffde58; Value = 0x00287952d1930b4b; PC = 0x555555565627 *)
...
(* mov    0x8(%rsi),%rdx                           #! EA = L0x7fffffffde28; Value = 0x8ba3742688c9971c; PC = 0x5555555656ac *)
mov rdx L0x7fffffffde28;
(* xor    %r8,%r8                                  #! PC = 0x5555555656b0 *)
mov r8 0@uint64;
clear carry;
clear overflow;
(* mulx   (%rdi),%rbp,%rbx                         #! EA = L0x7fffffffde20; Value = 0x75eb12877eec537b; PC = 0x5555555656b3 *)
...
(* mulx   0x8(%rdi),%rbp,%rbx                      #! EA = L0x7fffffffde28; Value = 0x8ba3742688c9971c; PC = 0x5555555656c4 *)
...
(* mulx   0x10(%rdi),%rbp,%rbx                     #! EA = L0x7fffffffde30; Value = 0xc083d2c69a3e0ca3; PC = 0x5555555656d6 *)
mull rbx rbp L0x7fffffffde30 rdx;
(* adcx   %rbp,%r11                                #! PC = 0x5555555656dc *)
adcs carry r11 r11 rbp carry;
(* adox   %rbx,%r12                                #! PC = 0x5555555656e2 *)
adcs overflow r12 r12 rbx overflow;
(* mulx   0x18(%rdi),%rbp,%rbx                     #! EA = L0x7fffffffde38; Value = 0xf2c7776a18f3f36c; PC = 0x5555555656e8 *)
mull rbx rbp L0x7fffffffde38 rdx;
(* adcx   %rbp,%r12                                #! PC = 0x5555555656ee *)
adcs carry r12 r12 rbp carry;
(* adox   %rbx,%r13                                #! PC = 0x5555555656f4 *)
adcs overflow r13 r13 rbx overflow;
(* mulx   0x20(%rdi),%rbp,%rbx                     #! EA = L0x7fffffffde40; Value = 0x287f88f8ee966e6d; PC = 0x5555555656fa *)
mull rbx rbp L0x7fffffffde40 rdx;
(* adcx   %rbp,%r13                                #! PC = 0x555555565700 *)
adcs carry r13 r13 rbp carry;
(* adox   %rbx,%r14                                #! PC = 0x555555565706 *)
adcs overflow r14 r14 rbx overflow;
(* mulx   0x28(%rdi),%rbp,%rbx                     #! EA = L0x7fffffffde48; Value = 0x8f4685cc9fafa48f; PC = 0x55555556570c *)
mull rbx rbp L0x7fffffffde48 rdx;
(* adcx   %rbp,%r14                                #! PC = 0x555555565712 *)
adcs carry r14 r14 rbp carry;
(* adox   %rbx,%r15                                #! PC = 0x555555565718 *)
adcs overflow r15 r15 rbx overflow;
(* mulx   0x30(%rdi),%rbp,%rbx                     #! EA = L0x7fffffffde50; Value = 0xac24d6102ba2b7d9; PC = 0x55555556571e *)
mull rbx rbp L0x7fffffffde50 rdx;
(* adcx   %rbp,%r15                                #! PC = 0x555555565724 *)
adcs carry r15 r15 rbp carry;
(* adox   %rbx,%rax                                #! PC = 0x55555556572a *)
adcs overflow rax rax rbx overflow;
(* mulx   0x38(%rdi),%rbp,%rbx                     #! EA = L0x7fffffffde58; Value = 0x00287952d1930b4b; PC = 0x555555565730 *)
mull rbx rbp L0x7fffffffde58 rdx;
...
assert true && and [ overflow = 0@1, carry = 0@1 ];
assume and [ overflow = 0, carry = 0 ] && true;
(* mov    0x10(%rsi),%rdx                          #! EA = L0x7fffffffde30; Value = 0xc083d2c69a3e0ca3; PC = 0x5555555657b9 *)
mov rdx L0x7fffffffde30;
(* xor    %r9,%r9                                  #! PC = 0x5555555657bd *)
mov r9 0@uint64;
clear carry;
clear overflow;
(* mulx   (%rdi),%rbp,%rbx                         #! EA = L0x7fffffffde20; Value = 0x75eb12877eec537b; PC = 0x5555555657c0 *)
mull rbx rbp L0x7fffffffde20 rdx;
(* adox   %rbp,%r10                                #! PC = 0x5555555657c5 *)
adcs overflow r10 r10 rbp overflow;
(* adox   %rbx,%r11                                #! PC = 0x5555555657cb *)
adcs overflow r11 r11 rbx overflow;
(* mulx   0x8(%rdi),%rbp,%rbx                      #! EA = L0x7fffffffde28; Value = 0x8ba3742688c9971c; PC = 0x5555555657d1 *)
mull rbx rbp L0x7fffffffde28 rdx;
(* adcx   %rbp,%r11                                #! PC = 0x5555555657d7 *)
adcs carry r11 r11 rbp carry;
(* adox   %rbx,%r12                                #! PC = 0x5555555657dd *)
adcs overflow r12 r12 rbx overflow;
(* mulx   0x10(%rdi),%rbp,%rbx                     #! EA = L0x7fffffffde30; Value = 0xc083d2c69a3e0ca3; PC = 0x5555555657e3 *)
mull rbx rbp L0x7fffffffde30 rdx;
(* adcx   %rbp,%r12                                #! PC = 0x5555555657e9 *)
adcs carry r12 r12 rbp carry;
(* adox   %rbx,%r13                                #! PC = 0x5555555657ef *)
adcs overflow r13 r13 rbx overflow;
(* mulx   0x18(%rdi),%rbp,%rbx                     #! EA = L0x7fffffffde38; Value = 0xf2c7776a18f3f36c; PC = 0x5555555657f5 *)
mull rbx rbp L0x7fffffffde38 rdx;
(* adcx   %rbp,%r13                                #! PC = 0x5555555657fb *)
adcs carry r13 r13 rbp carry;
(* adox   %rbx,%r14                                #! PC = 0x555555565801 *)
adcs overflow r14 r14 rbx overflow;
(* mulx   0x20(%rdi),%rbp,%rbx                     #! EA = L0x7fffffffde40; Value = 0x287f88f8ee966e6d; PC = 0x555555565807 *)
mull rbx rbp L0x7fffffffde40 rdx;
(* adcx   %rbp,%r14                                #! PC = 0x55555556580d *)
adcs carry r14 r14 rbp carry;
(* adox   %rbx,%r15                                #! PC = 0x555555565813 *)
adcs overflow r15 r15 rbx overflow;
(* mulx   0x28(%rdi),%rbp,%rbx                     #! EA = L0x7fffffffde48; Value = 0x8f4685cc9fafa48f; PC = 0x555555565819 *)
mull rbx rbp L0x7fffffffde48 rdx;
(* adcx   %rbp,%r15                                #! PC = 0x55555556581f *)
adcs carry r15 r15 rbp carry;
(* adox   %rbx,%rax                                #! PC = 0x555555565825 *)
adcs overflow rax rax rbx overflow;
(* mulx   0x30(%rdi),%rbp,%rbx                     #! EA = L0x7fffffffde50; Value = 0xac24d6102ba2b7d9; PC = 0x55555556582b *)
mull rbx rbp L0x7fffffffde50 rdx;
(* adcx   %rbp,%rax                                #! PC = 0x555555565831 *)
adcs carry rax rax rbp carry;
(* adox   %rbx,%r8                                 #! PC = 0x555555565837 *)
adcs overflow r8 r8 rbx overflow;
(* mulx   0x38(%rdi),%rbp,%rbx                     #! EA = L0x7fffffffde58; Value = 0x00287952d1930b4b; PC = 0x55555556583d *)
mull rbx rbp L0x7fffffffde58 rdx;
...
assert true && and [ overflow = 0@1, carry = 0@1 ];
assume and [ overflow = 0, carry = 0 ] && true;
(* mov    0x18(%rsi),%rdx                          #! EA = L0x7fffffffde38; Value = 0xf2c7776a18f3f36c; PC = 0x5555555658c6 *)
mov rdx L0x7fffffffde38;
(* xor    %r10,%r10                                #! PC = 0x5555555658ca *)
mov r10 0@uint64;
clear carry;
clear overflow;
(* mulx   (%rdi),%rbp,%rbx                         #! EA = L0x7fffffffde20; Value = 0x75eb12877eec537b; PC = 0x5555555658cd *)
mull rbx rbp L0x7fffffffde20 rdx;
(* adox   %rbp,%r11                                #! PC = 0x5555555658d2 *)
adcs overflow r11 r11 rbp overflow;
(* adox   %rbx,%r12                                #! PC = 0x5555555658d8 *)
adcs overflow r12 r12 rbx overflow;
(* mulx   0x8(%rdi),%rbp,%rbx                      #! EA = L0x7fffffffde28; Value = 0x8ba3742688c9971c; PC = 0x5555555658de *)
mull rbx rbp L0x7fffffffde28 rdx;
(* adcx   %rbp,%r12                                #! PC = 0x5555555658e4 *)
adcs carry r12 r12 rbp carry;
(* adox   %rbx,%r13                                #! PC = 0x5555555658ea *)
adcs overflow r13 r13 rbx overflow;
(* mulx   0x10(%rdi),%rbp,%rbx                     #! EA = L0x7fffffffde30; Value = 0xc083d2c69a3e0ca3; PC = 0x5555555658f0 *)
mull rbx rbp L0x7fffffffde30 rdx;
(* adcx   %rbp,%r13                                #! PC = 0x5555555658f6 *)
adcs carry r13 r13 rbp carry;
(* adox   %rbx,%r14                                #! PC = 0x5555555658fc *)
adcs overflow r14 r14 rbx overflow;
(* mulx   0x18(%rdi),%rbp,%rbx                     #! EA = L0x7fffffffde38; Value = 0xf2c7776a18f3f36c; PC = 0x555555565902 *)
mull rbx rbp L0x7fffffffde38 rdx;
(* adcx   %rbp,%r14                                #! PC = 0x555555565908 *)
adcs carry r14 r14 rbp carry;
(* adox   %rbx,%r15                                #! PC = 0x55555556590e *)
adcs overflow r15 r15 rbx overflow;
(* mulx   0x20(%rdi),%rbp,%rbx                     #! EA = L0x7fffffffde40; Value = 0x287f88f8ee966e6d; PC = 0x555555565914 *)
mull rbx rbp L0x7fffffffde40 rdx;
(* adcx   %rbp,%r15                                #! PC = 0x55555556591a *)
adcs carry r15 r15 rbp carry;
(* adox   %rbx,%rax                                #! PC = 0x555555565920 *)
adcs overflow rax rax rbx overflow;
(* mulx   0x28(%rdi),%rbp,%rbx                     #! EA = L0x7fffffffde48; Value = 0x8f4685cc9fafa48f; PC = 0x555555565926 *)
mull rbx rbp L0x7fffffffde48 rdx;
(* adcx   %rbp,%rax                                #! PC = 0x55555556592c *)
adcs carry rax rax rbp carry;
(* adox   %rbx,%r8                                 #! PC = 0x555555565932 *)
adcs overflow r8 r8 rbx overflow;
(* mulx   0x30(%rdi),%rbp,%rbx                     #! EA = L0x7fffffffde50; Value = 0xac24d6102ba2b7d9; PC = 0x555555565938 *)
mull rbx rbp L0x7fffffffde50 rdx;
(* adcx   %rbp,%r8                                 #! PC = 0x55555556593e *)
adcs carry r8 r8 rbp carry;
(* adox   %rbx,%r9                                 #! PC = 0x555555565944 *)
adcs overflow r9 r9 rbx overflow;
(* mulx   0x38(%rdi),%rbp,%rbx                     #! EA = L0x7fffffffde58; Value = 0x00287952d1930b4b; PC = 0x55555556594a *)
mull rbx rbp L0x7fffffffde58 rdx;
...
assert true && and [ overflow = 0@1, carry = 0@1 ];
assume and [ overflow = 0, carry = 0 ] && true;
(* mov    0x20(%rsi),%rdx                          #! EA = L0x7fffffffde40; Value = 0x287f88f8ee966e6d; PC = 0x5555555659d3 *)
mov rdx L0x7fffffffde40;
(* xor    %r11,%r11                                #! PC = 0x5555555659d7 *)
mov r11 0@uint64;
clear carry;
clear overflow;
(* mulx   (%rdi),%rbp,%rbx                         #! EA = L0x7fffffffde20; Value = 0x75eb12877eec537b; PC = 0x5555555659da *)
mull rbx rbp L0x7fffffffde20 rdx;
(* adox   %rbp,%r12                                #! PC = 0x5555555659df *)
adcs overflow r12 r12 rbp overflow;
(* adox   %rbx,%r13                                #! PC = 0x5555555659e5 *)
adcs overflow r13 r13 rbx overflow;
(* mulx   0x8(%rdi),%rbp,%rbx                      #! EA = L0x7fffffffde28; Value = 0x8ba3742688c9971c; PC = 0x5555555659eb *)
mull rbx rbp L0x7fffffffde28 rdx;
(* adcx   %rbp,%r13                                #! PC = 0x5555555659f1 *)
adcs carry r13 r13 rbp carry;
(* adox   %rbx,%r14                                #! PC = 0x5555555659f7 *)
adcs overflow r14 r14 rbx overflow;
(* mulx   0x10(%rdi),%rbp,%rbx                     #! EA = L0x7fffffffde30; Value = 0xc083d2c69a3e0ca3; PC = 0x5555555659fd *)
mull rbx rbp L0x7fffffffde30 rdx;
(* adcx   %rbp,%r14                                #! PC = 0x555555565a03 *)
adcs carry r14 r14 rbp carry;
(* adox   %rbx,%r15                                #! PC = 0x555555565a09 *)
adcs overflow r15 r15 rbx overflow;
(* mulx   0x18(%rdi),%rbp,%rbx                     #! EA = L0x7fffffffde38; Value = 0xf2c7776a18f3f36c; PC = 0x555555565a0f *)
mull rbx rbp L0x7fffffffde38 rdx;
(* adcx   %rbp,%r15                                #! PC = 0x555555565a15 *)
adcs carry r15 r15 rbp carry;
(* adox   %rbx,%rax                                #! PC = 0x555555565a1b *)
adcs overflow rax rax rbx overflow;
(* mulx   0x20(%rdi),%rbp,%rbx                     #! EA = L0x7fffffffde40; Value = 0x287f88f8ee966e6d; PC = 0x555555565a21 *)
mull rbx rbp L0x7fffffffde40 rdx;
(* adcx   %rbp,%rax                                #! PC = 0x555555565a27 *)
adcs carry rax rax rbp carry;
(* adox   %rbx,%r8                                 #! PC = 0x555555565a2d *)
adcs overflow r8 r8 rbx overflow;
(* mulx   0x28(%rdi),%rbp,%rbx                     #! EA = L0x7fffffffde48; Value = 0x8f4685cc9fafa48f; PC = 0x555555565a33 *)
mull rbx rbp L0x7fffffffde48 rdx;
(* adcx   %rbp,%r8                                 #! PC = 0x555555565a39 *)
adcs carry r8 r8 rbp carry;
(* adox   %rbx,%r9                                 #! PC = 0x555555565a3f *)
adcs overflow r9 r9 rbx overflow;
(* mulx   0x30(%rdi),%rbp,%rbx                     #! EA = L0x7fffffffde50; Value = 0xac24d6102ba2b7d9; PC = 0x555555565a45 *)
mull rbx rbp L0x7fffffffde50 rdx;
(* adcx   %rbp,%r9                                 #! PC = 0x555555565a4b *)
adcs carry r9 r9 rbp carry;
(* adox   %rbx,%r10                                #! PC = 0x555555565a51 *)
adcs overflow r10 r10 rbx overflow;
(* mulx   0x38(%rdi),%rbp,%rbx                     #! EA = L0x7fffffffde58; Value = 0x00287952d1930b4b; PC = 0x555555565a57 *)
mull rbx rbp L0x7fffffffde58 rdx;
...
assert true && and [ overflow = 0@1, carry = 0@1 ];
assume and [ overflow = 0, carry = 0 ] && true;
(* mov    0x28(%rsi),%rdx                          #! EA = L0x7fffffffde48; Value = 0x8f4685cc9fafa48f; PC = 0x555555565ae0 *)
mov rdx L0x7fffffffde48;
(* xor    %r12,%r12                                #! PC = 0x555555565ae4 *)
mov r12 0@uint64;
clear carry;
clear overflow;
(* mulx   (%rdi),%rbp,%rbx                         #! EA = L0x7fffffffde20; Value = 0x75eb12877eec537b; PC = 0x555555565ae7 *)
mull rbx rbp L0x7fffffffde20 rdx;
(* adox   %rbp,%r13                                #! PC = 0x555555565aec *)
adcs overflow r13 r13 rbp overflow;
(* adox   %rbx,%r14                                #! PC = 0x555555565af2 *)
adcs overflow r14 r14 rbx overflow;
(* mulx   0x8(%rdi),%rbp,%rbx                      #! EA = L0x7fffffffde28; Value = 0x8ba3742688c9971c; PC = 0x555555565af8 *)
mull rbx rbp L0x7fffffffde28 rdx;
(* adcx   %rbp,%r14                                #! PC = 0x555555565afe *)
adcs carry r14 r14 rbp carry;
(* adox   %rbx,%r15                                #! PC = 0x555555565b04 *)
adcs overflow r15 r15 rbx overflow;
(* mulx   0x10(%rdi),%rbp,%rbx                     #! EA = L0x7fffffffde30; Value = 0xc083d2c69a3e0ca3; PC = 0x555555565b0a *)
mull rbx rbp L0x7fffffffde30 rdx;
(* adcx   %rbp,%r15                                #! PC = 0x555555565b10 *)
adcs carry r15 r15 rbp carry;
(* adox   %rbx,%rax                                #! PC = 0x555555565b16 *)
adcs overflow rax rax rbx overflow;
(* mulx   0x18(%rdi),%rbp,%rbx                     #! EA = L0x7fffffffde38; Value = 0xf2c7776a18f3f36c; PC = 0x555555565b1c *)
mull rbx rbp L0x7fffffffde38 rdx;
(* adcx   %rbp,%rax                                #! PC = 0x555555565b22 *)
adcs carry rax rax rbp carry;
(* adox   %rbx,%r8                                 #! PC = 0x555555565b28 *)
adcs overflow r8 r8 rbx overflow;
(* mulx   0x20(%rdi),%rbp,%rbx                     #! EA = L0x7fffffffde40; Value = 0x287f88f8ee966e6d; PC = 0x555555565b2e *)
mull rbx rbp L0x7fffffffde40 rdx;
(* adcx   %rbp,%r8                                 #! PC = 0x555555565b34 *)
adcs carry r8 r8 rbp carry;
(* adox   %rbx,%r9                                 #! PC = 0x555555565b3a *)
adcs overflow r9 r9 rbx overflow;
(* mulx   0x28(%rdi),%rbp,%rbx                     #! EA = L0x7fffffffde48; Value = 0x8f4685cc9fafa48f; PC = 0x555555565b40 *)
mull rbx rbp L0x7fffffffde48 rdx;
(* adcx   %rbp,%r9                                 #! PC = 0x555555565b46 *)
adcs carry r9 r9 rbp carry;
(* adox   %rbx,%r10                                #! PC = 0x555555565b4c *)
adcs overflow r10 r10 rbx overflow;
(* mulx   0x30(%rdi),%rbp,%rbx                     #! EA = L0x7fffffffde50; Value = 0xac24d6102ba2b7d9; PC = 0x555555565b52 *)
mull rbx rbp L0x7fffffffde50 rdx;
(* adcx   %rbp,%r10                                #! PC = 0x555555565b58 *)
adcs carry r10 r10 rbp carry;
(* adox   %rbx,%r11                                #! PC = 0x555555565b5e *)
adcs overflow r11 r11 rbx overflow;
(* mulx   0x38(%rdi),%rbp,%rbx                     #! EA = L0x7fffffffde58; Value = 0x00287952d1930b4b; PC = 0x555555565b64 *)
mull rbx rbp L0x7fffffffde58 rdx;
...
assert true && and [ overflow = 0@1, carry = 0@1 ];
assume and [ overflow = 0, carry = 0 ] && true;
(* mov    0x30(%rsi),%rdx                          #! EA = L0x7fffffffde50; Value = 0xac24d6102ba2b7d9; PC = 0x555555565bed *)
mov rdx L0x7fffffffde50;
(* xor    %r13,%r13                                #! PC = 0x555555565bf1 *)
mov r13 0@uint64;
clear carry;
clear overflow;
(* mulx   (%rdi),%rbp,%rbx                         #! EA = L0x7fffffffde20; Value = 0x75eb12877eec537b; PC = 0x555555565bf4 *)
mull rbx rbp L0x7fffffffde20 rdx;
(* adox   %rbp,%r14                                #! PC = 0x555555565bf9 *)
adcs overflow r14 r14 rbp overflow;
(* adox   %rbx,%r15                                #! PC = 0x555555565bff *)
adcs overflow r15 r15 rbx overflow;
(* mulx   0x8(%rdi),%rbp,%rbx                      #! EA = L0x7fffffffde28; Value = 0x8ba3742688c9971c; PC = 0x555555565c05 *)
mull rbx rbp L0x7fffffffde28 rdx;
(* adcx   %rbp,%r15                                #! PC = 0x555555565c0b *)
adcs carry r15 r15 rbp carry;
(* adox   %rbx,%rax                                #! PC = 0x555555565c11 *)
adcs overflow rax rax rbx overflow;
(* mulx   0x10(%rdi),%rbp,%rbx                     #! EA = L0x7fffffffde30; Value = 0xc083d2c69a3e0ca3; PC = 0x555555565c17 *)
mull rbx rbp L0x7fffffffde30 rdx;
(* adcx   %rbp,%rax                                #! PC = 0x555555565c1d *)
adcs carry rax rax rbp carry;
(* adox   %rbx,%r8                                 #! PC = 0x555555565c23 *)
adcs overflow r8 r8 rbx overflow;
(* mulx   0x18(%rdi),%rbp,%rbx                     #! EA = L0x7fffffffde38; Value = 0xf2c7776a18f3f36c; PC = 0x555555565c29 *)
mull rbx rbp L0x7fffffffde38 rdx;
(* adcx   %rbp,%r8                                 #! PC = 0x555555565c2f *)
adcs carry r8 r8 rbp carry;
(* adox   %rbx,%r9                                 #! PC = 0x555555565c35 *)
adcs overflow r9 r9 rbx overflow;
(* mulx   0x20(%rdi),%rbp,%rbx                     #! EA = L0x7fffffffde40; Value = 0x287f88f8ee966e6d; PC = 0x555555565c3b *)
mull rbx rbp L0x7fffffffde40 rdx;
(* adcx   %rbp,%r9                                 #! PC = 0x555555565c41 *)
adcs carry r9 r9 rbp carry;
(* adox   %rbx,%r10                                #! PC = 0x555555565c47 *)
adcs overflow r10 r10 rbx overflow;
(* mulx   0x28(%rdi),%rbp,%rbx                     #! EA = L0x7fffffffde48; Value = 0x8f4685cc9fafa48f; PC = 0x555555565c4d *)
mull rbx rbp L0x7fffffffde48 rdx;
(* adcx   %rbp,%r10                                #! PC = 0x555555565c53 *)
adcs carry r10 r10 rbp carry;
(* adox   %rbx,%r11                                #! PC = 0x555555565c59 *)
adcs overflow r11 r11 rbx overflow;
(* mulx   0x30(%rdi),%rbp,%rbx                     #! EA = L0x7fffffffde50; Value = 0xac24d6102ba2b7d9; PC = 0x555555565c5f *)
mull rbx rbp L0x7fffffffde50 rdx;
(* adcx   %rbp,%r11                                #! PC = 0x555555565c65 *)
adcs carry r11 r11 rbp carry;
(* adox   %rbx,%r12                                #! PC = 0x555555565c6b *)
adcs overflow r12 r12 rbx overflow;
(* mulx   0x38(%rdi),%rbp,%rbx                     #! EA = L0x7fffffffde58; Value = 0x00287952d1930b4b; PC = 0x555555565c71 *)
mull rbx rbp L0x7fffffffde58 rdx;
...
assert true && and [ overflow = 0@1, carry = 0@1 ];
assume and [ overflow = 0, carry = 0 ] && true;
(* mov    0x38(%rsi),%rdx                          #! EA = L0x7fffffffde58; Value = 0x00287952d1930b4b; PC = 0x555555565cfa *)
mov rdx L0x7fffffffde58;
(* xor    %r14,%r14                                #! PC = 0x555555565cfe *)
mov r14 0@uint64;
clear carry;
clear overflow;
(* mulx   (%rdi),%rbp,%rbx                         #! EA = L0x7fffffffde20; Value = 0x75eb12877eec537b; PC = 0x555555565d01 *)
mull rbx rbp L0x7fffffffde20 rdx;
(* adox   %rbp,%r15                                #! PC = 0x555555565d06 *)
adcs overflow r15 r15 rbp overflow;
(* adox   %rbx,%rax                                #! PC = 0x555555565d0c *)
adcs overflow rax rax rbx overflow;
(* mulx   0x8(%rdi),%rbp,%rbx                      #! EA = L0x7fffffffde28; Value = 0x8ba3742688c9971c; PC = 0x555555565d12 *)
mull rbx rbp L0x7fffffffde28 rdx;
(* adcx   %rbp,%rax                                #! PC = 0x555555565d18 *)
adcs carry rax rax rbp carry;
(* adox   %rbx,%r8                                 #! PC = 0x555555565d1e *)
adcs overflow r8 r8 rbx overflow;
(* mulx   0x10(%rdi),%rbp,%rbx                     #! EA = L0x7fffffffde30; Value = 0xc083d2c69a3e0ca3; PC = 0x555555565d24 *)
mull rbx rbp L0x7fffffffde30 rdx;
(* adcx   %rbp,%r8                                 #! PC = 0x555555565d2a *)
adcs carry r8 r8 rbp carry;
(* adox   %rbx,%r9                                 #! PC = 0x555555565d30 *)
adcs overflow r9 r9 rbx overflow;
(* mulx   0x18(%rdi),%rbp,%rbx                     #! EA = L0x7fffffffde38; Value = 0xf2c7776a18f3f36c; PC = 0x555555565d36 *)
mull rbx rbp L0x7fffffffde38 rdx;
(* adcx   %rbp,%r9                                 #! PC = 0x555555565d3c *)
adcs carry r9 r9 rbp carry;
(* adox   %rbx,%r10                                #! PC = 0x555555565d42 *)
adcs overflow r10 r10 rbx overflow;
(* mulx   0x20(%rdi),%rbp,%rbx                     #! EA = L0x7fffffffde40; Value = 0x287f88f8ee966e6d; PC = 0x555555565d48 *)
mull rbx rbp L0x7fffffffde40 rdx;
(* adcx   %rbp,%r10                                #! PC = 0x555555565d4e *)
adcs carry r10 r10 rbp carry;
(* adox   %rbx,%r11                                #! PC = 0x555555565d54 *)
adcs overflow r11 r11 rbx overflow;
(* mulx   0x28(%rdi),%rbp,%rbx                     #! EA = L0x7fffffffde48; Value = 0x8f4685cc9fafa48f; PC = 0x555555565d5a *)
mull rbx rbp L0x7fffffffde48 rdx;
(* adcx   %rbp,%r11                                #! PC = 0x555555565d60 *)
adcs carry r11 r11 rbp carry;
(* adox   %rbx,%r12                                #! PC = 0x555555565d66 *)
adcs overflow r12 r12 rbx overflow;
(* mulx   0x30(%rdi),%rbp,%rbx                     #! EA = L0x7fffffffde50; Value = 0xac24d6102ba2b7d9; PC = 0x555555565d6c *)
mull rbx rbp L0x7fffffffde50 rdx;
(* adcx   %rbp,%r12                                #! PC = 0x555555565d72 *)
adcs carry r12 r12 rbp carry;
(* adox   %rbx,%r13                                #! PC = 0x555555565d78 *)
adcs overflow r13 r13 rbx overflow;
(* mulx   0x38(%rdi),%rbp,%rbx                     #! EA = L0x7fffffffde58; Value = 0x00287952d1930b4b; PC = 0x555555565d7e *)
mull rbx rbp L0x7fffffffde58 rdx;
...
assert true && and [ overflow = 0@1, carry = 0@1 ];
assume and [ overflow = 0, carry = 0 ] && true;
(* mov    %rax,(%rcx)                              #! EA = L0x7fffffffde60; PC = 0x555555565e07 *)
mov L0x7fffffffde60 rax;
(* mov    %r8,0x8(%rcx)                            #! EA = L0x7fffffffde68; PC = 0x555555565e0a *)
mov L0x7fffffffde68 r8;
(* mov    %r9,0x10(%rcx)                           #! EA = L0x7fffffffde70; PC = 0x555555565e0e *)
mov L0x7fffffffde70 r9;
(* mov    %r10,0x18(%rcx)                          #! EA = L0x7fffffffde78; PC = 0x555555565e12 *)
mov L0x7fffffffde78 r10;
(* mov    %r11,0x20(%rcx)                          #! EA = L0x7fffffffde80; PC = 0x555555565e16 *)
mov L0x7fffffffde80 r11;
(* mov    %r12,0x28(%rcx)                          #! EA = L0x7fffffffde88; PC = 0x555555565e1a *)
mov L0x7fffffffde88 r12;
(* mov    %r13,0x30(%rcx)                          #! EA = L0x7fffffffde90; PC = 0x555555565e1e *)
mov L0x7fffffffde90 r13;
(* mov    %r14,0x38(%rcx)                          #! EA = L0x7fffffffde98; PC = 0x555555565e22 *)
...
mov c0 L0x7fffffffde60;
mov c1 L0x7fffffffde68;
mov c2 L0x7fffffffde70;
mov c3 L0x7fffffffde78;
mov c4 L0x7fffffffde80;
mov c5 L0x7fffffffde88;
mov c6 L0x7fffffffde90;
mov c7 L0x7fffffffde98;
