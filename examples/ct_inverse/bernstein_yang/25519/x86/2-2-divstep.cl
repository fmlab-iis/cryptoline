(* Disable safety since singular is unused in the code *)
(* quine:  -v -disable_safety -vo rev_lex 2-2-divstep.cl
Parsing Cryptoline file:                [OK]            0.001457 seconds
Checking well-formedness:               [OK]            0.000500 seconds
Transforming to SSA form:               [OK]            0.000165 seconds
Normalizing specification:              [OK]            0.000137 seconds
Rewriting assignments:                  [OK]            0.000135 seconds
Verifying range assertions:             [OK]            1.243783 seconds
Verifying range specification:          [OK]            0.003678 seconds
Rewriting value-preserved casting:      [OK]            0.000055 seconds
Verifying algebraic assertions:         [OK]            0.000690 seconds
Verifying algebraic specification:      [OK]            29108.062725 seconds
Verification result:                    [OK]            29009.364745 seconds
*)
...
smull dontcare rcx r8 rcx;
cast rcx@sint64 rcx;
(* imul   %r8,%r10                                 #! PC = 0x4015b9 *)
smull dontcare r10 r8 r10;
cast r10@sint64 r10;
(* imul   %rax,%r8                                 #! PC = 0x4015bd *)
smull dontcare r8 rax r8;
cast r8@sint64 r8;
