...
assert true && carryo * zero = 0@1;
assume carryo * zero = 0 && true;

assert true && (1@1 - carryo) * (1@1 - zero) = 0@1;
assume (1 - carryo) * (1 - zero) = 0 && true;

assert true && (1@1 - carry) * (1@1 - zero) = 0@1;
assume (1 - carry) * (1 - zero) = 0 && true;
