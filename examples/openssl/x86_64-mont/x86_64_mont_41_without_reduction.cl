...
Parsing Cryptoline file:                [OK]            0.002543 seconds
Checking well-formedness:               [OK]            0.000804 seconds
Transforming to SSA form:               [OK]            0.001613 seconds
Verifying program safety:               [OK]            7.629967 seconds
Verifying assertions:                   [OK]            41.671976 seconds
Verifying range specification:          [OK]            2.034553 seconds
Verifying algebraic specification:      [OK]            0.182520 seconds
Verification result:                    [OK]            51.524228 seconds
*)

proc main (uint64 x0, uint64 x1, uint64 x2, uint64 x3, uint64 y0, uint64 y1, uint64 y2, uint64 y3, uint64 z0, uint64 z1, uint64 z2, uint64 z3, uint64 z4,
           uint64 n, uint64 m0, uint64 m1, uint64 m2, uint64 m3) =
{
  and
    [
      eqmod m0 1 2,
