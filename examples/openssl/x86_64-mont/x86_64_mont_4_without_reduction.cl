(* quine: (lp)
Verifying program safety:               [OK]            53.440586 seconds
Verifying assertions:                   [OK]            0.531493 seconds
Verifying range specification:          [OK]            7.609895 seconds
Verifying algebraic specification:      [OK]            157154.673425 seconds
Verification result:                    [OK]            157216.266638 seconds
*)
...
proc main (uint64 x0, uint64 x1, uint64 x2, uint64 x3, uint64 y0, uint64 y1, uint64 y2, uint64 y3, uint64 n, uint64 m0, uint64 m1, uint64 m2, uint64 m3) =
{
     and
       [
         ...
         (* This condition is placed here as the second algebraic condition
            for a better variable ordering *)
         eqmod m0 1 2
      ]
  &&
    true
