...
def print_inputs (base):
    for i in range (64):
        print ('uint8 A{0:02}'.format (i),
               end = '\n' if i == 63 else
                     ',\n' if i % 5 == 4 else ', ')
    print ('\n')
    for i in range (64):
        print ('mov L0x{0:x} A{1:02};'.format (base+i, i),
               end = '\n' if i % 3 == 2 else ' ')

def print_nondet ():
    regs = [ 'rsp', 'eax', 'edx', 'edi', 'esi' ]
...
def print_output (base):
    for i in range (8):
        print ('mov a{0} L0x{1:x};'.
               format (i, base + 4*i),
               end = '\n' if i % 2 == 1 else ' ')

print_inputs (0x555555559088)
print ('\n')
print_nondet ()
print ('\n')
print_init (0x555555559060)
print ('\n')
print_k256 (0x555555557020)
print ('\n')
print_output (0x555555559060)
