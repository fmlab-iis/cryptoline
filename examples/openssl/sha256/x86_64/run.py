...
def print_init (base, name):
    for i in range (8):
        print ('mov L0x{0:x} {2}{1};'.
               format (base + 4*i, i, name),
               end = '\n' if i % 2 == 1 else ' ')
...
print ('\n(* hash values *)\n')
print_init (0x55555555d040, 'A')

print ('\n(* nondets *)\n')
print_nondet ([], [0x55555555d0e4, 0x55555555d0e8, 0x55555555d0ec])
...
print ('\n(* outputs *)\n')
print_outputs (0x55555555d040, 'a')
