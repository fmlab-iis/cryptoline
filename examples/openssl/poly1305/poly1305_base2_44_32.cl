(* quine: e -v -btor -qfbv_args '-SE minisat' -isafety
Parsing Cryptoline file:                [OK]            0.002301 seconds
Checking well-formedness:               [OK]            0.001390 seconds
Transforming to SSA form:               [OK]            0.000164 seconds
Rewriting assignments:                  [OK]            0.000681 seconds
Verifying program safety:               [OK]            3.030959 seconds
Verifying range assertions:             [OK]            0.962437 seconds
Verifying range specification:          [OK]            2.262715 seconds
Rewriting value-preserved casting:      [OK]            0.000018 seconds
Verifying algebraic assertions:         [OK]            0.012569 seconds
Verifying algebraic specification:      [OK]            0.048673 seconds
Verification result:                    [OK]            6.322369 seconds
*)

proc main (uint64 inp0, uint64 inp1, uint64 inp2, uint64 inp3,
           uint64 r0, uint64 r1,
...
(* #mov    %r10,(%rdx)                              #! EA = L0x7ffd2bac2688; PC = 0x4204749 *)
#mov    %%r10,%%L0x7ffd2bac2688                              #! L0x7ffd2bac2688 = L0x7ffd2bac2688; 0x4204749 = 0x4204749;
(* #mov    %r11,0x8(%rdx)                           #! EA = L0x7ffd2bac2690; PC = 0x4204752 *)
#mov    %%r11,%%L0x7ffd2bac2690                           #! L0x7ffd2bac2690 = L0x7ffd2bac2690; 0x4204752 = 0x4204752;
...
(* NOTE: set padbit *)
mov rcx padbit;
(* #mov    $0x20,%edx                               #! PC = 0x4196051 *)
#mov    $0x20,%edx                               #! 0x4196051 = 0x4196051;
...
uadd rdx r12 rdx;
(* #cmp    (%rsp),%rsi                              #! EA = L0x7ffd2bac2550; Value = 0x0000000000605080; PC = 0x4205038 *)
#cmp    (%rsp),%rsi                              #! L0x7ffd2bac2550 = L0x7ffd2bac2550; 0x0000000000605080 = 0x0000000000605080; 0x4205038 = 0x4205038;
(* #jb     0x402920 <poly1305_blocks_base2_44+64>  #! PC = 0x4205042 *)
#jb     0x402920 <poly1305_blocks_base2_44+64>  #! 0x4205042 = 0x4205042;
(* mov    (%rsi),%r11                              #! EA = L0x605070; Value = 0x8978675645342312; PC = 0x4204832 *)
mov r11 L0x605070;
(* mov    0x8(%rsi),%r12                           #! EA = L0x605078; Value = 0x8798a9bacbdcedfe; PC = 0x4204835 *)
mov r12 L0x605078;
(* #lea    0x10(%rsi),%rsi                          #! PC = 0x4204839 *)
#lea    %%EA,%rsi                          #! 0x4204839 = 0x4204839;
(* andn   %r11,%rax,%r10                           #! PC = 0x4204843 *)
...
mov L0x6050d0 r9;
(* #mov    0x8(%rsp),%r15                           #! EA = L0x7ffd2bac2558; Value = 0x0000000000000000; PC = 0x4205059 *)
#mov    0x8(%rsp),%%r15                           #! L0x7ffd2bac2558 = L0x7ffd2bac2558; 0x0000000000000000 = 0x0000000000000000; 0x4205059 = 0x4205059;
(* #mov    0x10(%rsp),%r14                          #! EA = L0x7ffd2bac2560; Value = 0x0000000000000000; PC = 0x4205064 *)
#mov    0x10(%rsp),%%r14                          #! L0x7ffd2bac2560 = L0x7ffd2bac2560; 0x0000000000000000 = 0x0000000000000000; 0x4205064 = 0x4205064;
(* #mov    0x18(%rsp),%r13                          #! EA = L0x7ffd2bac2568; Value = 0x00007ffd2bac2670; PC = 0x4205069 *)
#mov    0x18(%rsp),%%r13                          #! L0x7ffd2bac2568 = L0x7ffd2bac2568; 0x00007ffd2bac2670 = 0x00007ffd2bac2670; 0x4205069 = 0x4205069;
(* #mov    0x20(%rsp),%r12                          #! EA = L0x7ffd2bac2570; Value = 0x00000000004005c0; PC = 0x4205074 *)
#mov    0x20(%rsp),%%r12                          #! L0x7ffd2bac2570 = L0x7ffd2bac2570; 0x00000000004005c0 = 0x00000000004005c0; 0x4205074 = 0x4205074;
(* #mov    0x28(%rsp),%rbp                          #! EA = L0x7ffd2bac2578; Value = 0x00007ffd2bac2590; PC = 0x4205079 *)
#mov    0x28(%rsp),%%rbp                          #! L0x7ffd2bac2578 = L0x7ffd2bac2578; 0x00007ffd2bac2590 = 0x00007ffd2bac2590; 0x4205079 = 0x4205079;
(* #mov    0x30(%rsp),%rbx                          #! EA = L0x7ffd2bac2580; Value = 0x0000000000000000; PC = 0x4205084 *)
#mov    0x30(%rsp),%%rbx                          #! L0x7ffd2bac2580 = L0x7ffd2bac2580; 0x0000000000000000 = 0x0000000000000000; 0x4205084 = 0x4205084;
...

{
  eqmod (limbs 44 [H0, H1, H2])
        (((((limbs 44 [h0, h1, h2]) + (limbs 64 [inp0, inp1, padbit]))
           *
           (limbs 64 [r0, r1])) + (limbs 64 [inp2, inp3, 1]))
         *
         (limbs 64 [r0, r1]))
        (2**130-5)
&&
