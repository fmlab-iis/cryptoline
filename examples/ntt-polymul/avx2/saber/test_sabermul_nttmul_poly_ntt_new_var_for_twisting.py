...
def print_instr(instr):
    global level, off, ecut_id, rcut_id, level6_ecut_ids, level7_ecut_ids, level7_rcut_ids
    ...
    # ==================== Level 2 ====================
        ...
        print(str_ghost(
            ...
            ["zeta_0_{0} = {1}".format(i+off*4, LEVEL3_TWIST_BASE[i+off*4]) for i in range(4)],
            []))
        print(str_twist1(
            "inp_poly",
            [(LEVEL3_TWIST_BASE[i+off*4], "zeta_0_{}".format(i+off*4), "y_0_{}".format(i+off*4), make_ymms([[4, 6, 8, 3], [7, 10, 5, 11]][i%2], (i//2)*8, 8)) for i in range(4)],
            32))
        ecut_id = ecut_id + 1
        print()
    ...
    # ==================== Level 5 ====================
        ...
        print(str_ghost(
            ...
            ["zeta_1_{0} = {1}".format(i+off*32, LEVEL7_TWIST_BASE[i%8]) for i in range(32)],
            []))
        print(str_twist2(
            "inp_poly",
            [(LEVEL7_TWIST_BASE[i%8], "zeta_0_{0}".format(i//8+off*4), "y_0_{0}".format(i//8+off*4), "zeta_1_{0}".format(i+off*32), "y_1_{}".format(i+off*32),
    ...
    # ==================== Level 7 ====================
        ...
        for i in range(128):
            print(str_level6to7_algebra(
                ...
                expn=1), end='')
            if more_cuts_and_prove_with:
                print("\nprove with [all ghosts, cuts [{0}]]".format(level6_ecut_ids[off][i//2]), end='')
            if i < 127: print(",")
            else: print("")
        print("&& and [")
        print(str_range_condition(
