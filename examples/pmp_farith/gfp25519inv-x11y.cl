...
# Parsing Cryptoline file:		[OK]		0.003484 seconds
# Checking well-formedness:		[OK]		0.000337 seconds
# Transforming to SSA form:		[OK]		0.000212 seconds
# Rewriting assignments:			[OK]		0.000274 seconds
# Verifying program safety:		
# 	 Cut 0
# 	     Round 1 (49 safety conditions, timeout = 300 seconds)
...
# 	 Cut 1
# 	     Round 1 (13 safety conditions, timeout = 300 seconds)
# 		 Safety condition #9	[OK]
# 		 Safety condition #0	[OK]
# 		 Safety condition #12	[OK]
# 		 Safety condition #11	[OK]
...
# 		 Safety condition #5	[OK]
# 		 Safety condition #1	[OK]
# 	 Overall			[OK]		4.681930 seconds
# Verifying range specification:		[OK]		0.474206 seconds
# Rewriting value-preserved casting:	[OK]		0.000097 seconds
# Verifying algebraic specification:	[OK]		96.063981 seconds
# Verification result:			[OK]		101.224731 seconds
...
assert 
    and [
    	eqmod
      ((limbs 64 [vars x|0..3]) ** 9)
      (limbs 64 [vars z9|0..3]) 
      (((2**255 )- 19)),
       	eqmod
      ((limbs 64 [vars x|0..3]) ** 2)
