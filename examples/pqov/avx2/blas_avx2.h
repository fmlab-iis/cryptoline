...
void linearmap_8x8_accu_ymm( uint8_t * accu_c , const uint8_t * a ,  __m256i ml , __m256i mh , __m256i mask , unsigned _num_byte ) {
	...
	if( rem ) linearmap_8x8_accu_sse( accu_c , a , _mm256_castsi256_si128(ml) , _mm256_castsi256_si128(mh) , _mm256_castsi256_si128(mask) , rem );
}
...
static inline
void gf16v_generate_multabs_avx2( uint8_t * multabs, const uint8_t * v , unsigned n_ele ) { _gf16v_generate_multabs_avx2((__m256i*)multabs,v,n_ele); }
